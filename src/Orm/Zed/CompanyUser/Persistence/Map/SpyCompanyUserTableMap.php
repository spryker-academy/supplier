...
class SpyCompanyUserTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'src.Orm.Zed.CompanyUser.Persistence.Map.SpyCompanyUserTableMap';
     ...
     */
    public const TABLE_NAME = 'spy_company_user';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'SpyCompanyUser';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\Orm\\Zed\\CompanyUser\\Persistence\\SpyCompanyUser';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'src.Orm.Zed.CompanyUser.Persistence.SpyCompanyUser';
     ...
     */
    public const COL_ID_COMPANY_USER = 'spy_company_user.id_company_user';

    /**
     * the column name for the fk_company field
     */
    public const COL_FK_COMPANY = 'spy_company_user.fk_company';

    /**
     * the column name for the fk_company_business_unit field
     */
    public const COL_FK_COMPANY_BUSINESS_UNIT = 'spy_company_user.fk_company_business_unit';

    /**
     * the column name for the fk_customer field
     */
    public const COL_FK_CUSTOMER = 'spy_company_user.fk_customer';

    /**
     * the column name for the is_active field
     */
    public const COL_IS_ACTIVE = 'spy_company_user.is_active';

    /**
     * the column name for the is_default field
     */
    public const COL_IS_DEFAULT = 'spy_company_user.is_default';

    /**
     * the column name for the key field
     */
    public const COL_KEY = 'spy_company_user.key';

    /**
     * the column name for the uuid field
     */
    public const COL_UUID = 'spy_company_user.uuid';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdCompanyUser', 'FkCompany', 'FkCompanyBusinessUnit', 'FkCustomer', 'IsActive', 'IsDefault', 'Key', 'Uuid', ],
        self::TYPE_CAMELNAME     => ['idCompanyUser', 'fkCompany', 'fkCompanyBusinessUnit', 'fkCustomer', 'isActive', 'isDefault', 'key', 'uuid', ],
        self::TYPE_COLNAME       => [SpyCompanyUserTableMap::COL_ID_COMPANY_USER, SpyCompanyUserTableMap::COL_FK_COMPANY, SpyCompanyUserTableMap::COL_FK_COMPANY_BUSINESS_UNIT, SpyCompanyUserTableMap::COL_FK_CUSTOMER, SpyCompanyUserTableMap::COL_IS_ACTIVE, SpyCompanyUserTableMap::COL_IS_DEFAULT, SpyCompanyUserTableMap::COL_KEY, SpyCompanyUserTableMap::COL_UUID, ],
        self::TYPE_FIELDNAME     => ['id_company_user', 'fk_company', 'fk_company_business_unit', 'fk_customer', 'is_active', 'is_default', 'key', 'uuid', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdCompanyUser' => 0, 'FkCompany' => 1, 'FkCompanyBusinessUnit' => 2, 'FkCustomer' => 3, 'IsActive' => 4, 'IsDefault' => 5, 'Key' => 6, 'Uuid' => 7, ],
        self::TYPE_CAMELNAME     => ['idCompanyUser' => 0, 'fkCompany' => 1, 'fkCompanyBusinessUnit' => 2, 'fkCustomer' => 3, 'isActive' => 4, 'isDefault' => 5, 'key' => 6, 'uuid' => 7, ],
        ...
        self::TYPE_FIELDNAME     => ['id_company_user' => 0, 'fk_company' => 1, 'fk_company_business_unit' => 2, 'fk_customer' => 3, 'is_active' => 4, 'is_default' => 5, 'key' => 6, 'uuid' => 7, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, 5, 6, 7, ]
    ];
...
), null, null, 'SpyCompanyUserFiles', false);
