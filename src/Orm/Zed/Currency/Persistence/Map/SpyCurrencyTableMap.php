...
class SpyCurrencyTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'src.Orm.Zed.Currency.Persistence.Map.SpyCurrencyTableMap';
     ...
     */
    public const TABLE_PHP_NAME = 'SpyCurrency';
     ...
     */
    public const CLASS_DEFAULT = 'src.Orm.Zed.Currency.Persistence.SpyCurrency';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdCurrency', 'Code', 'Name', 'Symbol', ],
        self::TYPE_CAMELNAME     => ['idCurrency', 'code', 'name', 'symbol', ],
        self::TYPE_COLNAME       => [SpyCurrencyTableMap::COL_ID_CURRENCY, SpyCurrencyTableMap::COL_CODE, SpyCurrencyTableMap::COL_NAME, SpyCurrencyTableMap::COL_SYMBOL, ],
        self::TYPE_FIELDNAME     => ['id_currency', 'code', 'name', 'symbol', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdCurrency' => 0, 'Code' => 1, 'Name' => 2, 'Symbol' => 3, ],
        self::TYPE_CAMELNAME     => ['idCurrency' => 0, 'code' => 1, 'name' => 2, 'symbol' => 3, ],
        self::TYPE_COLNAME       => [SpyCurrencyTableMap::COL_ID_CURRENCY => 0, SpyCurrencyTableMap::COL_CODE => 1, SpyCurrencyTableMap::COL_NAME => 2, SpyCurrencyTableMap::COL_SYMBOL => 3, ],
        self::TYPE_FIELDNAME     => ['id_currency' => 0, 'code' => 1, 'name' => 2, 'symbol' => 3, ],
        self::TYPE_NUM           => [0, 1, 2, 3, ]
    ];
