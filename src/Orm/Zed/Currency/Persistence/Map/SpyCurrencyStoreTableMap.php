...
class SpyCurrencyStoreTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'src.Orm.Zed.Currency.Persistence.Map.SpyCurrencyStoreTableMap';
     ...
     */
    public const CLASS_DEFAULT = 'src.Orm.Zed.Currency.Persistence.SpyCurrencyStore';
  ...
  array (
    ...
    {
        return [
            'event' => ['spy_currency_store_all' => ['column' => '*']],
