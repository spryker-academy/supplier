...
class SpyAclUserHasGroupTableMap extends TableMap
{
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['FkAclGroup', 'FkUser', ],
        self::TYPE_CAMELNAME     => ['fkAclGroup', 'fkUser', ],
        self::TYPE_COLNAME       => [SpyAclUserHasGroupTableMap::COL_FK_ACL_GROUP, SpyAclUserHasGroupTableMap::COL_FK_USER, ],
        self::TYPE_FIELDNAME     => ['fk_acl_group', 'fk_user', ],
        self::TYPE_NUM           => [0, 1, ]
    ];
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['FkAclGroup' => 0, 'FkUser' => 1, ],
        self::TYPE_CAMELNAME     => ['fkAclGroup' => 0, 'fkUser' => 1, ],
        self::TYPE_COLNAME       => [SpyAclUserHasGroupTableMap::COL_FK_ACL_GROUP => 0, SpyAclUserHasGroupTableMap::COL_FK_USER => 1, ],
        self::TYPE_FIELDNAME     => ['fk_acl_group' => 0, 'fk_user' => 1, ],
        self::TYPE_NUM           => [0, 1, ]
    ];
  ...
  array (
    ...
    public static function addInstanceToPool(SpyAclUserHasGroup $obj, ?string $key = null): void
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (null === $key) {
                $key = serialize([(null === $obj->getFkAclGroup() || is_scalar($obj->getFkAclGroup()) || is_callable([$obj->getFkAclGroup(), '__toString']) ? (string) $obj->getFkAclGroup() : $obj->getFkAclGroup()), (null === $obj->getFkUser() || is_scalar($obj->getFkUser()) || is_callable([$obj->getFkUser(), '__toString']) ? (string) $obj->getFkUser() : $obj->getFkUser())]);
            } // if key === null
    ...
    public static function removeInstanceFromPool($value): void
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \Orm\Zed\Acl\Persistence\SpyAclUserHasGroup) {
                $key = serialize([(null === $value->getFkAclGroup() || is_scalar($value->getFkAclGroup()) || is_callable([$value->getFkAclGroup(), '__toString']) ? (string) $value->getFkAclGroup() : $value->getFkAclGroup()), (null === $value->getFkUser() || is_scalar($value->getFkUser()) || is_callable([$value->getFkUser(), '__toString']) ? (string) $value->getFkUser() : $value->getFkUser())]);
    ...
    public static function getPrimaryKeyHashFromRow(array $row, int $offset = 0, string $indexType = TableMap::TYPE_NUM): ?string
    {
        ...
        if ($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('FkAclGroup', TableMap::TYPE_PHPNAME, $indexType)] === null && $row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('FkUser', TableMap::TYPE_PHPNAME, $indexType)] === null) {
            return null;
        }

        return serialize([(null === $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('FkAclGroup', TableMap::TYPE_PHPNAME, $indexType)] || is_scalar($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('FkAclGroup', TableMap::TYPE_PHPNAME, $indexType)]) || is_callable([$row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('FkAclGroup', TableMap::TYPE_PHPNAME, $indexType)], '__toString']) ? (string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('FkAclGroup', TableMap::TYPE_PHPNAME, $indexType)] : $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('FkAclGroup', TableMap::TYPE_PHPNAME, $indexType)]), (null === $row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('FkUser', TableMap::TYPE_PHPNAME, $indexType)] || is_scalar($row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('FkUser', TableMap::TYPE_PHPNAME, $indexType)]) || is_callable([$row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('FkUser', TableMap::TYPE_PHPNAME, $indexType)], '__toString']) ? (string) $row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('FkUser', TableMap::TYPE_PHPNAME, $indexType)] : $row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('FkUser', TableMap::TYPE_PHPNAME, $indexType)])]);
    }
     ...
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(SpyAclUserHasGroupTableMap::COL_FK_ACL_GROUP, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(SpyAclUserHasGroupTableMap::COL_FK_USER, $value[1]));
