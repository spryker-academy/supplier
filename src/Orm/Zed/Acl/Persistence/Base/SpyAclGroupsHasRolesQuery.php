 ...
 *
 * @method     ChildSpyAclGroupsHasRoles[]|Collection find(?ConnectionInterface $con = null) Return ChildSpyAclGroupsHasRoles objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpyAclGroupsHasRoles> find(?ConnectionInterface $con = null) Return ChildSpyAclGroupsHasRoles objects based on current ModelCriteria
 *
 * @method     ChildSpyAclGroupsHasRoles[]|Collection findByFkAclGroup(int|array<int> $fk_acl_group) Return ChildSpyAclGroupsHasRoles objects filtered by the fk_acl_group column
 * @psalm-method Collection&\Traversable<ChildSpyAclGroupsHasRoles> findByFkAclGroup(int|array<int> $fk_acl_group) Return ChildSpyAclGroupsHasRoles objects filtered by the fk_acl_group column
 * @method     ChildSpyAclGroupsHasRoles[]|Collection findByFkAclRole(int|array<int> $fk_acl_role) Return ChildSpyAclGroupsHasRoles objects filtered by the fk_acl_role column
 * @psalm-method Collection&\Traversable<ChildSpyAclGroupsHasRoles> findByFkAclRole(int|array<int> $fk_acl_role) Return ChildSpyAclGroupsHasRoles objects filtered by the fk_acl_role column
 *
...
abstract class SpyAclGroupsHasRolesQuery extends ModelCriteria
{
     ...
     * </code>
     *
     * @param array[$fk_acl_group, $fk_acl_role] $key Primary key to use for the query
    ...
    {
        $sql = 'SELECT fk_acl_group, fk_acl_role FROM spy_acl_groups_has_roles WHERE fk_acl_group = :p0 AND fk_acl_role = :p1';
        try {
    ...
    {
        $this->addUsingAlias(SpyAclGroupsHasRolesTableMap::COL_FK_ACL_GROUP, $key[0], Criteria::EQUAL);
        $this->addUsingAlias(SpyAclGroupsHasRolesTableMap::COL_FK_ACL_ROLE, $key[1], Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        foreach ($keys as $key) {
            $cton0 = $this->getNewCriterion(SpyAclGroupsHasRolesTableMap::COL_FK_ACL_GROUP, $key[0], Criteria::EQUAL);
            $cton1 = $this->getNewCriterion(SpyAclGroupsHasRolesTableMap::COL_FK_ACL_ROLE, $key[1], Criteria::EQUAL);
            $cton0->addAnd($cton1);
            $this->addOr($cton0);
        }
    ...
    public function prune($spyAclGroupsHasRoles = null)
    {
        if ($spyAclGroupsHasRoles) {
            $this->addCond('pruneCond0', $this->getAliasedColName(SpyAclGroupsHasRolesTableMap::COL_FK_ACL_GROUP), $spyAclGroupsHasRoles->getFkAclGroup(), Criteria::NOT_EQUAL);
            $this->addCond('pruneCond1', $this->getAliasedColName(SpyAclGroupsHasRolesTableMap::COL_FK_ACL_ROLE), $spyAclGroupsHasRoles->getFkAclRole(), Criteria::NOT_EQUAL);
