 ...
 * @method     ChildSpyAclGroupArchiveQuery orderByReference($order = Criteria::ASC) Order by the reference column
 ...
 * @method     ChildSpyAclGroupArchiveQuery groupByReference() Group by the reference column
 ...
 * @method     ChildSpyAclGroupArchive|null findOneByReference(string $reference) Return the first ChildSpyAclGroupArchive filtered by the reference column
 ...
 * @method     ChildSpyAclGroupArchive requireOneByReference(string $reference) Return the first ChildSpyAclGroupArchive filtered by the reference column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 *
 * @method     ChildSpyAclGroupArchive[]|Collection find(?ConnectionInterface $con = null) Return ChildSpyAclGroupArchive objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpyAclGroupArchive> find(?ConnectionInterface $con = null) Return ChildSpyAclGroupArchive objects based on current ModelCriteria
 *
 * @method     ChildSpyAclGroupArchive[]|Collection findByIdAclGroup(int|array<int> $id_acl_group) Return ChildSpyAclGroupArchive objects filtered by the id_acl_group column
 * @psalm-method Collection&\Traversable<ChildSpyAclGroupArchive> findByIdAclGroup(int|array<int> $id_acl_group) Return ChildSpyAclGroupArchive objects filtered by the id_acl_group column
 * @method     ChildSpyAclGroupArchive[]|Collection findByName(string|array<string> $name) Return ChildSpyAclGroupArchive objects filtered by the name column
 * @psalm-method Collection&\Traversable<ChildSpyAclGroupArchive> findByName(string|array<string> $name) Return ChildSpyAclGroupArchive objects filtered by the name column
 * @method     ChildSpyAclGroupArchive[]|Collection findByReference(string|array<string> $reference) Return ChildSpyAclGroupArchive objects filtered by the reference column
 * @psalm-method Collection&\Traversable<ChildSpyAclGroupArchive> findByReference(string|array<string> $reference) Return ChildSpyAclGroupArchive objects filtered by the reference column
 * @method     ChildSpyAclGroupArchive[]|Collection findByCreatedAt(string|array<string> $created_at) Return ChildSpyAclGroupArchive objects filtered by the created_at column
 * @psalm-method Collection&\Traversable<ChildSpyAclGroupArchive> findByCreatedAt(string|array<string> $created_at) Return ChildSpyAclGroupArchive objects filtered by the created_at column
 * @method     ChildSpyAclGroupArchive[]|Collection findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyAclGroupArchive objects filtered by the updated_at column
 * @psalm-method Collection&\Traversable<ChildSpyAclGroupArchive> findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyAclGroupArchive objects filtered by the updated_at column
 * @method     ChildSpyAclGroupArchive[]|Collection findByArchivedAt(string|array<string> $archived_at) Return ChildSpyAclGroupArchive objects filtered by the archived_at column
 * @psalm-method Collection&\Traversable<ChildSpyAclGroupArchive> findByArchivedAt(string|array<string> $archived_at) Return ChildSpyAclGroupArchive objects filtered by the archived_at column
 *
...
abstract class SpyAclGroupArchiveQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id_acl_group, name, reference, created_at, updated_at, archived_at FROM spy_acl_group_archive WHERE id_acl_group = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SpyAclGroupArchiveTableMap::COL_ID_ACL_GROUP, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SpyAclGroupArchiveTableMap::COL_ID_ACL_GROUP, $keys, Criteria::IN);
    ...
    public function filterByReference($reference = null, $comparison = Criteria::EQUAL)
    {
        ...
        $query = $this->addUsingAlias(SpyAclGroupArchiveTableMap::COL_REFERENCE, $reference, $comparison);
