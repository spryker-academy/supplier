 ...
 * @method     ChildSpyAclRoleArchiveQuery orderByReference($order = Criteria::ASC) Order by the reference column
 ...
 * @method     ChildSpyAclRoleArchiveQuery groupByReference() Group by the reference column
 ...
 * @method     ChildSpyAclRoleArchive|null findOneByReference(string $reference) Return the first ChildSpyAclRoleArchive filtered by the reference column
 ...
 * @method     ChildSpyAclRoleArchive requireOneByReference(string $reference) Return the first ChildSpyAclRoleArchive filtered by the reference column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 *
 * @method     ChildSpyAclRoleArchive[]|Collection find(?ConnectionInterface $con = null) Return ChildSpyAclRoleArchive objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpyAclRoleArchive> find(?ConnectionInterface $con = null) Return ChildSpyAclRoleArchive objects based on current ModelCriteria
 *
 * @method     ChildSpyAclRoleArchive[]|Collection findByIdAclRole(int|array<int> $id_acl_role) Return ChildSpyAclRoleArchive objects filtered by the id_acl_role column
 * @psalm-method Collection&\Traversable<ChildSpyAclRoleArchive> findByIdAclRole(int|array<int> $id_acl_role) Return ChildSpyAclRoleArchive objects filtered by the id_acl_role column
 * @method     ChildSpyAclRoleArchive[]|Collection findByName(string|array<string> $name) Return ChildSpyAclRoleArchive objects filtered by the name column
 * @psalm-method Collection&\Traversable<ChildSpyAclRoleArchive> findByName(string|array<string> $name) Return ChildSpyAclRoleArchive objects filtered by the name column
 * @method     ChildSpyAclRoleArchive[]|Collection findByReference(string|array<string> $reference) Return ChildSpyAclRoleArchive objects filtered by the reference column
 * @psalm-method Collection&\Traversable<ChildSpyAclRoleArchive> findByReference(string|array<string> $reference) Return ChildSpyAclRoleArchive objects filtered by the reference column
 * @method     ChildSpyAclRoleArchive[]|Collection findByCreatedAt(string|array<string> $created_at) Return ChildSpyAclRoleArchive objects filtered by the created_at column
 * @psalm-method Collection&\Traversable<ChildSpyAclRoleArchive> findByCreatedAt(string|array<string> $created_at) Return ChildSpyAclRoleArchive objects filtered by the created_at column
 * @method     ChildSpyAclRoleArchive[]|Collection findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyAclRoleArchive objects filtered by the updated_at column
 * @psalm-method Collection&\Traversable<ChildSpyAclRoleArchive> findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyAclRoleArchive objects filtered by the updated_at column
 * @method     ChildSpyAclRoleArchive[]|Collection findByArchivedAt(string|array<string> $archived_at) Return ChildSpyAclRoleArchive objects filtered by the archived_at column
 * @psalm-method Collection&\Traversable<ChildSpyAclRoleArchive> findByArchivedAt(string|array<string> $archived_at) Return ChildSpyAclRoleArchive objects filtered by the archived_at column
 *
...
abstract class SpyAclRoleArchiveQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id_acl_role, name, reference, created_at, updated_at, archived_at FROM spy_acl_role_archive WHERE id_acl_role = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SpyAclRoleArchiveTableMap::COL_ID_ACL_ROLE, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SpyAclRoleArchiveTableMap::COL_ID_ACL_ROLE, $keys, Criteria::IN);
    ...
    public function filterByReference($reference = null, $comparison = Criteria::EQUAL)
    {
        ...
        $query = $this->addUsingAlias(SpyAclRoleArchiveTableMap::COL_REFERENCE, $reference, $comparison);
