...
abstract class SpyAclUserHasGroup implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Orm\\Zed\\Acl\\Persistence\\Map\\SpyAclUserHasGroupTableMap';
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SpyAclUserHasGroupTableMap::translateFieldName('FkAclGroup', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fk_acl_group = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SpyAclUserHasGroupTableMap::translateFieldName('FkUser', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    {
        return (null === $this->getFkAclGroup()) && (null === $this->getFkUser());
    }
