 ...
 * @method     ChildSpyAclRoleQuery orderByReference($order = Criteria::ASC) Order by the reference column
 ...
 * @method     ChildSpyAclRoleQuery groupByReference() Group by the reference column
 ...
 *
 * @method     ChildSpyAclRoleQuery leftJoinSpyAclEntityRule($relationAlias = null) Adds a LEFT JOIN clause to the query using the SpyAclEntityRule relation
 * @method     ChildSpyAclRoleQuery rightJoinSpyAclEntityRule($relationAlias = null) Adds a RIGHT JOIN clause to the query using the SpyAclEntityRule relation
 * @method     ChildSpyAclRoleQuery innerJoinSpyAclEntityRule($relationAlias = null) Adds a INNER JOIN clause to the query using the SpyAclEntityRule relation
 *
 * @method     ChildSpyAclRoleQuery joinWithSpyAclEntityRule($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the SpyAclEntityRule relation
 *
 * @method     ChildSpyAclRoleQuery leftJoinWithSpyAclEntityRule() Adds a LEFT JOIN clause and with to the query using the SpyAclEntityRule relation
 * @method     ChildSpyAclRoleQuery rightJoinWithSpyAclEntityRule() Adds a RIGHT JOIN clause and with to the query using the SpyAclEntityRule relation
 * @method     ChildSpyAclRoleQuery innerJoinWithSpyAclEntityRule() Adds a INNER JOIN clause and with to the query using the SpyAclEntityRule relation
 *
 * @method     \Orm\Zed\Acl\Persistence\SpyAclRuleQuery|\Orm\Zed\Acl\Persistence\SpyAclGroupsHasRolesQuery|\Orm\Zed\AclEntity\Persistence\SpyAclEntityRuleQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildSpyAclRole|null findOneByReference(string $reference) Return the first ChildSpyAclRole filtered by the reference column
 ...
 * @method     ChildSpyAclRole requireOneByReference(string $reference) Return the first ChildSpyAclRole filtered by the reference column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 *
 * @method     ChildSpyAclRole[]|Collection find(?ConnectionInterface $con = null) Return ChildSpyAclRole objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpyAclRole> find(?ConnectionInterface $con = null) Return ChildSpyAclRole objects based on current ModelCriteria
 *
 * @method     ChildSpyAclRole[]|Collection findByIdAclRole(int|array<int> $id_acl_role) Return ChildSpyAclRole objects filtered by the id_acl_role column
 * @psalm-method Collection&\Traversable<ChildSpyAclRole> findByIdAclRole(int|array<int> $id_acl_role) Return ChildSpyAclRole objects filtered by the id_acl_role column
 * @method     ChildSpyAclRole[]|Collection findByName(string|array<string> $name) Return ChildSpyAclRole objects filtered by the name column
 * @psalm-method Collection&\Traversable<ChildSpyAclRole> findByName(string|array<string> $name) Return ChildSpyAclRole objects filtered by the name column
 * @method     ChildSpyAclRole[]|Collection findByReference(string|array<string> $reference) Return ChildSpyAclRole objects filtered by the reference column
 * @psalm-method Collection&\Traversable<ChildSpyAclRole> findByReference(string|array<string> $reference) Return ChildSpyAclRole objects filtered by the reference column
 * @method     ChildSpyAclRole[]|Collection findByCreatedAt(string|array<string> $created_at) Return ChildSpyAclRole objects filtered by the created_at column
 * @psalm-method Collection&\Traversable<ChildSpyAclRole> findByCreatedAt(string|array<string> $created_at) Return ChildSpyAclRole objects filtered by the created_at column
 * @method     ChildSpyAclRole[]|Collection findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyAclRole objects filtered by the updated_at column
 * @psalm-method Collection&\Traversable<ChildSpyAclRole> findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyAclRole objects filtered by the updated_at column
 *
...
abstract class SpyAclRoleQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id_acl_role, name, reference, created_at, updated_at FROM spy_acl_role WHERE id_acl_role = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SpyAclRoleTableMap::COL_ID_ACL_ROLE, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SpyAclRoleTableMap::COL_ID_ACL_ROLE, $keys, Criteria::IN);
    ...
    public function filterByReference($reference = null, $comparison = Criteria::EQUAL)
    {
        ...
        $query = $this->addUsingAlias(SpyAclRoleTableMap::COL_REFERENCE, $reference, $comparison);
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterByAclRule($spyAclRule, ?string $comparison = null)
    {
     ...
     * @return $this The current query, for fluid interface
     */
    public function joinAclRule(?string $relationAlias = null, ?string $joinType = Criteria::INNER_JOIN)
    {
    ...
    {
        /** @var $q \Orm\Zed\Acl\Persistence\SpyAclRuleQuery */
        $q = $this->useExistsQuery('AclRule', $modelAlias, $queryClass, $typeOfExists);
        return $q;
    }
    ...
    {
        /** @var $q \Orm\Zed\Acl\Persistence\SpyAclRuleQuery */
        $q = $this->useExistsQuery('AclRule', $modelAlias, $queryClass, 'NOT EXISTS');
        return $q;
    }

    /**
     * Use the AclRule relation to the SpyAclRule table for an IN query.
     *
     ...
     *
     * @return \Orm\Zed\Acl\Persistence\SpyAclRuleQuery The inner query object of the IN statement
     */
    public function useInAclRuleQuery($modelAlias = null, $queryClass = null, $typeOfIn = 'IN')
    {
        /** @var $q \Orm\Zed\Acl\Persistence\SpyAclRuleQuery */
        $q = $this->useInQuery('AclRule', $modelAlias, $queryClass, $typeOfIn);
        return $q;
    }

    /**
     * Use the AclRule relation to the SpyAclRule table for a NOT IN query.
     *
     * @see useAclRuleInQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     * @param string|null $queryClass Allows to use a custom query class for the NOT IN query, like ExtendedBookQuery::class
     *
     * @return \Orm\Zed\Acl\Persistence\SpyAclRuleQuery The inner query object of the NOT IN statement
     */
    public function useNotInAclRuleQuery($modelAlias = null, $queryClass = null)
    {
        /** @var $q \Orm\Zed\Acl\Persistence\SpyAclRuleQuery */
        $q = $this->useInQuery('AclRule', $modelAlias, $queryClass, 'NOT IN');
        return $q;
    }
    ...
    public function filterBySpyAclEntityRule($spyAclEntityRule, ?string $comparison = null)
    {
        if ($spyAclEntityRule instanceof \Orm\Zed\AclEntity\Persistence\SpyAclEntityRule) {
            $this
                ->addUsingAlias(SpyAclRoleTableMap::COL_ID_ACL_ROLE, $spyAclEntityRule->getFkAclRole(), $comparison);
     ...
     * @return $this The current query, for fluid interface
     */
    public function joinSpyAclEntityRule(?string $relationAlias = null, ?string $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
     ...
     */
    public function useSpyAclEntityRuleQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
    ...
    {
        $this->addUsingAlias(SpyAclRoleTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addDescendingOrderByColumn(SpyAclRoleTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addAscendingOrderByColumn(SpyAclRoleTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addDescendingOrderByColumn(SpyAclRoleTableMap::COL_CREATED_AT);
    ...
    {
        $this->addUsingAlias(SpyAclRoleTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addAscendingOrderByColumn(SpyAclRoleTableMap::COL_CREATED_AT);
