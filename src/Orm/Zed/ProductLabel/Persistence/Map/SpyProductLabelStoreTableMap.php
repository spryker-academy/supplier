...
class SpyProductLabelStoreTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'src.Orm.Zed.ProductLabel.Persistence.Map.SpyProductLabelStoreTableMap';
     ...
     */
    public const TABLE_NAME = 'spy_product_label_store';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'SpyProductLabelStore';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\Orm\\Zed\\ProductLabel\\Persistence\\SpyProductLabelStore';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'src.Orm.Zed.ProductLabel.Persistence.SpyProductLabelStore';
     ...
     */
    public const COL_ID_PRODUCT_LABEL_STORE = 'spy_product_label_store.id_product_label_store';

    /**
     * the column name for the fk_product_label field
     */
    public const COL_FK_PRODUCT_LABEL = 'spy_product_label_store.fk_product_label';

    /**
     * the column name for the fk_store field
     */
    public const COL_FK_STORE = 'spy_product_label_store.fk_store';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdProductLabelStore', 'FkProductLabel', 'FkStore', ],
        self::TYPE_CAMELNAME     => ['idProductLabelStore', 'fkProductLabel', 'fkStore', ],
        self::TYPE_COLNAME       => [SpyProductLabelStoreTableMap::COL_ID_PRODUCT_LABEL_STORE, SpyProductLabelStoreTableMap::COL_FK_PRODUCT_LABEL, SpyProductLabelStoreTableMap::COL_FK_STORE, ],
        self::TYPE_FIELDNAME     => ['id_product_label_store', 'fk_product_label', 'fk_store', ],
        self::TYPE_NUM           => [0, 1, 2, ]
    ];
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdProductLabelStore' => 0, 'FkProductLabel' => 1, 'FkStore' => 2, ],
        self::TYPE_CAMELNAME     => ['idProductLabelStore' => 0, 'fkProductLabel' => 1, 'fkStore' => 2, ],
        self::TYPE_COLNAME       => [SpyProductLabelStoreTableMap::COL_ID_PRODUCT_LABEL_STORE => 0, SpyProductLabelStoreTableMap::COL_FK_PRODUCT_LABEL => 1, SpyProductLabelStoreTableMap::COL_FK_STORE => 2, ],
        self::TYPE_FIELDNAME     => ['id_product_label_store' => 0, 'fk_product_label' => 1, 'fk_store' => 2, ],
        self::TYPE_NUM           => [0, 1, 2, ]
    ];
