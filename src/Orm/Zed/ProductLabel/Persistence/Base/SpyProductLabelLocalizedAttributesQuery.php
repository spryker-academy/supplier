 ...
 *
 * @method     ChildSpyProductLabelLocalizedAttributes[]|Collection find(?ConnectionInterface $con = null) Return ChildSpyProductLabelLocalizedAttributes objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpyProductLabelLocalizedAttributes> find(?ConnectionInterface $con = null) Return ChildSpyProductLabelLocalizedAttributes objects based on current ModelCriteria
 *
 * @method     ChildSpyProductLabelLocalizedAttributes[]|Collection findByIdProductLabelLocalizedAttributes(int|array<int> $id_product_label_localized_attributes) Return ChildSpyProductLabelLocalizedAttributes objects filtered by the id_product_label_localized_attributes column
 * @psalm-method Collection&\Traversable<ChildSpyProductLabelLocalizedAttributes> findByIdProductLabelLocalizedAttributes(int|array<int> $id_product_label_localized_attributes) Return ChildSpyProductLabelLocalizedAttributes objects filtered by the id_product_label_localized_attributes column
 * @method     ChildSpyProductLabelLocalizedAttributes[]|Collection findByFkLocale(int|array<int> $fk_locale) Return ChildSpyProductLabelLocalizedAttributes objects filtered by the fk_locale column
 * @psalm-method Collection&\Traversable<ChildSpyProductLabelLocalizedAttributes> findByFkLocale(int|array<int> $fk_locale) Return ChildSpyProductLabelLocalizedAttributes objects filtered by the fk_locale column
 * @method     ChildSpyProductLabelLocalizedAttributes[]|Collection findByFkProductLabel(int|array<int> $fk_product_label) Return ChildSpyProductLabelLocalizedAttributes objects filtered by the fk_product_label column
 * @psalm-method Collection&\Traversable<ChildSpyProductLabelLocalizedAttributes> findByFkProductLabel(int|array<int> $fk_product_label) Return ChildSpyProductLabelLocalizedAttributes objects filtered by the fk_product_label column
 * @method     ChildSpyProductLabelLocalizedAttributes[]|Collection findByName(string|array<string> $name) Return ChildSpyProductLabelLocalizedAttributes objects filtered by the name column
 * @psalm-method Collection&\Traversable<ChildSpyProductLabelLocalizedAttributes> findByName(string|array<string> $name) Return ChildSpyProductLabelLocalizedAttributes objects filtered by the name column
 *
...
abstract class SpyProductLabelLocalizedAttributesQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SpyProductLabelLocalizedAttributesTableMap::COL_ID_PRODUCT_LABEL_LOCALIZED_ATTRIBUTES, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SpyProductLabelLocalizedAttributesTableMap::COL_ID_PRODUCT_LABEL_LOCALIZED_ATTRIBUTES, $keys, Criteria::IN);
