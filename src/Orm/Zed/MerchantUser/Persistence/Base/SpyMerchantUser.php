...
/**
 * Base class that represents a row from the 'spy_merchant_user' table.
 *
 *
 *
 * @package    propel.generator.src.Orm.Zed.MerchantUser.Persistence.Base
 */
abstract class SpyMerchantUser implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\Orm\\Zed\\MerchantUser\\Persistence\\Map\\SpyMerchantUserTableMap';
    ...
    /**
     * The value for the id_merchant_user field.
     *
     * @var        int
     */
    protected $id_merchant_user;
    ...
    /**
     * @var        ObjectCollection|ChildSpyAclEntitySegmentMerchantUser[] Collection to store aggregation of ChildSpyAclEntitySegmentMerchantUser objects.
     * @phpstan-var ObjectCollection&\Traversable<ChildSpyAclEntitySegmentMerchantUser> Collection to store aggregation of ChildSpyAclEntitySegmentMerchantUser objects.
     */
     ...
     * @var ObjectCollection|ChildSpyAclEntitySegmentMerchantUser[]
     * @phpstan-var ObjectCollection&\Traversable<ChildSpyAclEntitySegmentMerchantUser>
     */
    protected $spyAclEntitySegmentMerchantUsersScheduledForDeletion = null;

    /**
     * Initializes internal state of Orm\Zed\MerchantUser\Persistence\Base\SpyMerchantUser object.
     */
    ...
    /**
     * Compares this with another <code>SpyMerchantUser</code> instance.  If
     * <code>obj</code> is an instance of <code>SpyMerchantUser</code>, delegates to
     * <code>equals(SpyMerchantUser)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    /**
     * Get the [id_merchant_user] column value.
     *
     * @return int
     */
    public function getIdMerchantUser()
    {
        return $this->id_merchant_user;
    }
    ...
    /**
     * Set the value of [id_merchant_user] column.
     *
     * @param int $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setIdMerchantUser($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->id_merchant_user !== $v) {
            $this->id_merchant_user = $v;
            $this->modifiedColumns[SpyMerchantUserTableMap::COL_ID_MERCHANT_USER] = true;
        }
    ...
    public function setFkMerchant($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->fk_merchant !== $v) {
            $this->fk_merchant = $v;
            $this->modifiedColumns[SpyMerchantUserTableMap::COL_FK_MERCHANT] = true;
        }
    ...
    public function setFkUser($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->fk_user !== $v) {
            $this->fk_user = $v;
            $this->modifiedColumns[SpyMerchantUserTableMap::COL_FK_USER] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SpyMerchantUserTableMap::translateFieldName('IdMerchantUser', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_merchant_user = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SpyMerchantUserTableMap::translateFieldName('FkMerchant', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fk_merchant = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SpyMerchantUserTableMap::translateFieldName('FkUser', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = SpyMerchantUserTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Orm\\Zed\\MerchantUser\\Persistence\\SpyMerchantUser'), 0, $e);
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        if ($con === null) {
            $con = Propel::getServiceContainer()->getReadConnection(SpyMerchantUserTableMap::DATABASE_NAME);
        }

        // We don't need to alter the object instance pool; we're just modifying this instance
        // already in the pool.

        $dataFetcher = ChildSpyMerchantUserQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws \Propel\Runtime\Exception\PropelException
     * @see SpyMerchantUser::setDeleted()
     * @see SpyMerchantUser::isDeleted()
     */
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildSpyMerchantUserQuery::create()
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SpyMerchantUserTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        $this->modifiedColumns[SpyMerchantUserTableMap::COL_ID_MERCHANT_USER] = true;
        if (null !== $this->id_merchant_user) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . SpyMerchantUserTableMap::COL_ID_MERCHANT_USER . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(SpyMerchantUserTableMap::COL_ID_MERCHANT_USER)) {
            $modifiedColumns[':p' . $index++]  = 'id_merchant_user';
        }
        if ($this->isColumnModified(SpyMerchantUserTableMap::COL_FK_MERCHANT)) {
            $modifiedColumns[':p' . $index++]  = 'fk_merchant';
        }
        if ($this->isColumnModified(SpyMerchantUserTableMap::COL_FK_USER)) {
            $modifiedColumns[':p' . $index++]  = 'fk_user';
        }

        $sql = sprintf(
            'INSERT INTO spy_merchant_user (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id_merchant_user':
                        $stmt->bindValue($identifier, $this->id_merchant_user, PDO::PARAM_INT);
        ...
        try {
            $pk = $con->lastInsertId('spy_merchant_user_pk_seq');
        } catch (Exception $e) {
            throw new PropelException('Unable to get autoincrement id.', 0, $e);
        }
        $this->setIdMerchantUser($pk);
    ...
    {
        $pos = SpyMerchantUserTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['SpyMerchantUser'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['SpyMerchantUser'][$this->hashCode()] = true;
        $keys = SpyMerchantUserTableMap::getFieldNames($keyType);
        $result = [
            $keys[0] => $this->getIdMerchantUser(),
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setIdMerchantUser($arr[$keys[0]]);
        }
    ...
    {
        $criteria = new Criteria(SpyMerchantUserTableMap::DATABASE_NAME);

        if ($this->isColumnModified(SpyMerchantUserTableMap::COL_ID_MERCHANT_USER)) {
            $criteria->add(SpyMerchantUserTableMap::COL_ID_MERCHANT_USER, $this->id_merchant_user);
        }
        if ($this->isColumnModified(SpyMerchantUserTableMap::COL_FK_MERCHANT)) {
            $criteria->add(SpyMerchantUserTableMap::COL_FK_MERCHANT, $this->fk_merchant);
        }
        if ($this->isColumnModified(SpyMerchantUserTableMap::COL_FK_USER)) {
            $criteria->add(SpyMerchantUserTableMap::COL_FK_USER, $this->fk_user);
        }
    ...
    {
        $criteria = ChildSpyMerchantUserQuery::create();
        $criteria->add(SpyMerchantUserTableMap::COL_ID_MERCHANT_USER, $this->id_merchant_user);
    ...
    {
        $validPk = null !== $this->getIdMerchantUser();
    ...
    /**
     * Generic method to set the primary key (id_merchant_user column).
     *
    ...
    {
        return null === $this->getIdMerchantUser();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of \Orm\Zed\MerchantUser\Persistence\SpyMerchantUser (or compatible) type.
    ...
    public function copyInto(object $copyObj, bool $deepCopy = false, bool $makeNew = true): void
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdMerchantUser(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Orm\Zed\MerchantUser\Persistence\SpyMerchantUser Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    public function getSpyUser(?ConnectionInterface $con = null)
    {
        if ($this->aSpyUser === null && ($this->fk_user != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aSpyUser->addSpyMerchantUsers($this);
             */
        }
    ...
    public function getSpyMerchant(?ConnectionInterface $con = null)
    {
        if ($this->aSpyMerchant === null && ($this->fk_merchant != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSpyMerchant->addSpyMerchantUsers($this);
             */
        }
    ...
    /**
     * Gets an array of ChildSpyAclEntitySegmentMerchantUser objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     * If this ChildSpyMerchantUser is new, it will return
     * an empty collection or the current collection; the criteria is ignored on a new object.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param ConnectionInterface $con optional connection object
     * @return ObjectCollection|ChildSpyAclEntitySegmentMerchantUser[] List of ChildSpyAclEntitySegmentMerchantUser objects
     * @phpstan-return ObjectCollection&\Traversable<ChildSpyAclEntitySegmentMerchantUser> List of ChildSpyAclEntitySegmentMerchantUser objects
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function getSpyAclEntitySegmentMerchantUsers(?Criteria $criteria = null, ?ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collSpyAclEntitySegmentMerchantUsers || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                $collSpyAclEntitySegmentMerchantUsers = ChildSpyAclEntitySegmentMerchantUserQuery::create(null, $criteria)
                    ->filterBySpyMerchantUser($this)
                    ->find($con);
    ...
    /**
     * Sets a collection of ChildSpyAclEntitySegmentMerchantUser objects related by a one-to-many relationship
    ...
    {
        /** @var ChildSpyAclEntitySegmentMerchantUser[] $spyAclEntitySegmentMerchantUsersToDelete */
        ...
        foreach ($spyAclEntitySegmentMerchantUsersToDelete as $spyAclEntitySegmentMerchantUserRemoved) {
            $spyAclEntitySegmentMerchantUserRemoved->setSpyMerchantUser(null);
        }
    ...
    /**
     * Returns the number of related SpyAclEntitySegmentMerchantUser objects.
     *
     * @param Criteria $criteria
     * @param bool $distinct
     * @param ConnectionInterface $con
     * @return int Count of related SpyAclEntitySegmentMerchantUser objects.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function countSpyAclEntitySegmentMerchantUsers(?Criteria $criteria = null, bool $distinct = false, ?ConnectionInterface $con = null): int
    {
        ...
        if (null === $this->collSpyAclEntitySegmentMerchantUsers || null !== $criteria || $partial) {
            ...
            $query = ChildSpyAclEntitySegmentMerchantUserQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
    ...
    /**
     * Method called to associate a ChildSpyAclEntitySegmentMerchantUser object to this object
     * through the ChildSpyAclEntitySegmentMerchantUser foreign key attribute.
     *
     * @param ChildSpyAclEntitySegmentMerchantUser $l ChildSpyAclEntitySegmentMerchantUser
     * @return $this The current object (for fluent API support)
     */
    public function addSpyAclEntitySegmentMerchantUser(ChildSpyAclEntitySegmentMerchantUser $l)
    {
        if ($this->collSpyAclEntitySegmentMerchantUsers === null) {
            $this->initSpyAclEntitySegmentMerchantUsers();
            $this->collSpyAclEntitySegmentMerchantUsersPartial = true;
    ...
    /**
     * @param ChildSpyAclEntitySegmentMerchantUser $spyAclEntitySegmentMerchantUser The ChildSpyAclEntitySegmentMerchantUser object to add.
     */
    protected function doAddSpyAclEntitySegmentMerchantUser(ChildSpyAclEntitySegmentMerchantUser $spyAclEntitySegmentMerchantUser): void
    {
        $this->collSpyAclEntitySegmentMerchantUsers[]= $spyAclEntitySegmentMerchantUser;
        $spyAclEntitySegmentMerchantUser->setSpyMerchantUser($this);
    }

    /**
     * @param ChildSpyAclEntitySegmentMerchantUser $spyAclEntitySegmentMerchantUser The ChildSpyAclEntitySegmentMerchantUser object to remove.
     * @return $this The current object (for fluent API support)
     */
    public function removeSpyAclEntitySegmentMerchantUser(ChildSpyAclEntitySegmentMerchantUser $spyAclEntitySegmentMerchantUser)
    {
        if ($this->getSpyAclEntitySegmentMerchantUsers()->contains($spyAclEntitySegmentMerchantUser)) {
            ...
            $spyAclEntitySegmentMerchantUser->setSpyMerchantUser(null);
        }
     ...
     * Otherwise if this SpyMerchantUser is new, it will return
     * an empty collection; or if this SpyMerchantUser has previously
     * been saved, it will retrieve related SpyAclEntitySegmentMerchantUsers from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in SpyMerchantUser.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param ConnectionInterface $con optional connection object
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildSpyAclEntitySegmentMerchantUser}> List of ChildSpyAclEntitySegmentMerchantUser objects
     */
    public function getSpyAclEntitySegmentMerchantUsersJoinSpyAclEntitySegment(?Criteria $criteria = null, ?ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildSpyAclEntitySegmentMerchantUserQuery::create(null, $criteria);
    ...
    {
        if (null !== $this->aSpyUser) {
            $this->aSpyUser->removeSpyMerchantUser($this);
        }
        if (null !== $this->aSpyMerchant) {
            $this->aSpyMerchant->removeSpyMerchantUser($this);
        }
        $this->id_merchant_user = null;
    ...
    {
        return (string) $this->exportTo(SpyMerchantUserTableMap::DEFAULT_STRING_FORMAT);
    }
