 ...
 *
 * @method     ChildSpyCategoryImage[]|Collection find(?ConnectionInterface $con = null) Return ChildSpyCategoryImage objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpyCategoryImage> find(?ConnectionInterface $con = null) Return ChildSpyCategoryImage objects based on current ModelCriteria
 *
 * @method     ChildSpyCategoryImage[]|Collection findByIdCategoryImage(int|array<int> $id_category_image) Return ChildSpyCategoryImage objects filtered by the id_category_image column
 * @psalm-method Collection&\Traversable<ChildSpyCategoryImage> findByIdCategoryImage(int|array<int> $id_category_image) Return ChildSpyCategoryImage objects filtered by the id_category_image column
 * @method     ChildSpyCategoryImage[]|Collection findByExternalUrlLarge(string|array<string> $external_url_large) Return ChildSpyCategoryImage objects filtered by the external_url_large column
 * @psalm-method Collection&\Traversable<ChildSpyCategoryImage> findByExternalUrlLarge(string|array<string> $external_url_large) Return ChildSpyCategoryImage objects filtered by the external_url_large column
 * @method     ChildSpyCategoryImage[]|Collection findByExternalUrlSmall(string|array<string> $external_url_small) Return ChildSpyCategoryImage objects filtered by the external_url_small column
 * @psalm-method Collection&\Traversable<ChildSpyCategoryImage> findByExternalUrlSmall(string|array<string> $external_url_small) Return ChildSpyCategoryImage objects filtered by the external_url_small column
 * @method     ChildSpyCategoryImage[]|Collection findByCreatedAt(string|array<string> $created_at) Return ChildSpyCategoryImage objects filtered by the created_at column
 * @psalm-method Collection&\Traversable<ChildSpyCategoryImage> findByCreatedAt(string|array<string> $created_at) Return ChildSpyCategoryImage objects filtered by the created_at column
 * @method     ChildSpyCategoryImage[]|Collection findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyCategoryImage objects filtered by the updated_at column
 * @psalm-method Collection&\Traversable<ChildSpyCategoryImage> findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyCategoryImage objects filtered by the updated_at column
 *
...
abstract class SpyCategoryImageQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SpyCategoryImageTableMap::COL_ID_CATEGORY_IMAGE, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SpyCategoryImageTableMap::COL_ID_CATEGORY_IMAGE, $keys, Criteria::IN);
    ...
    {
        $this->addUsingAlias(SpyCategoryImageTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addDescendingOrderByColumn(SpyCategoryImageTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addAscendingOrderByColumn(SpyCategoryImageTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addDescendingOrderByColumn(SpyCategoryImageTableMap::COL_CREATED_AT);
    ...
    {
        $this->addUsingAlias(SpyCategoryImageTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addAscendingOrderByColumn(SpyCategoryImageTableMap::COL_CREATED_AT);
