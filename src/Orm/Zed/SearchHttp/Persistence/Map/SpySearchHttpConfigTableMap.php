...
class SpySearchHttpConfigTableMap extends TableMap
{
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdSearchHttpConfig', 'Data', 'AliasKeys', 'Key', 'CreatedAt', 'UpdatedAt', ],
        self::TYPE_CAMELNAME     => ['idSearchHttpConfig', 'data', 'aliasKeys', 'key', 'createdAt', 'updatedAt', ],
        self::TYPE_COLNAME       => [SpySearchHttpConfigTableMap::COL_ID_SEARCH_HTTP_CONFIG, SpySearchHttpConfigTableMap::COL_DATA, SpySearchHttpConfigTableMap::COL_ALIAS_KEYS, SpySearchHttpConfigTableMap::COL_KEY, SpySearchHttpConfigTableMap::COL_CREATED_AT, SpySearchHttpConfigTableMap::COL_UPDATED_AT, ],
        self::TYPE_FIELDNAME     => ['id_search_http_config', 'data', 'alias_keys', 'key', 'created_at', 'updated_at', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdSearchHttpConfig' => 0, 'Data' => 1, 'AliasKeys' => 2, 'Key' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ],
        self::TYPE_CAMELNAME     => ['idSearchHttpConfig' => 0, 'data' => 1, 'aliasKeys' => 2, 'key' => 3, 'createdAt' => 4, 'updatedAt' => 5, ],
        self::TYPE_COLNAME       => [SpySearchHttpConfigTableMap::COL_ID_SEARCH_HTTP_CONFIG => 0, SpySearchHttpConfigTableMap::COL_DATA => 1, SpySearchHttpConfigTableMap::COL_ALIAS_KEYS => 2, SpySearchHttpConfigTableMap::COL_KEY => 3, SpySearchHttpConfigTableMap::COL_CREATED_AT => 4, SpySearchHttpConfigTableMap::COL_UPDATED_AT => 5, ],
        self::TYPE_FIELDNAME     => ['id_search_http_config' => 0, 'data' => 1, 'alias_keys' => 2, 'key' => 3, 'created_at' => 4, 'updated_at' => 5, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, 5, ]
    ];
    ...
    {
        return [
            'synchronization' => ['resource' => ['value' => 'search_http_config'], 'queue_group' => ['value' => 'sync.http.search.config'], 'queue_pool' => ['value' => 'synchronizationPool']],
