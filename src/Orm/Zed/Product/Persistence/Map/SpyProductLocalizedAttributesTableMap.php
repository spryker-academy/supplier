...
class SpyProductLocalizedAttributesTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'src.Orm.Zed.Product.Persistence.Map.SpyProductLocalizedAttributesTableMap';
     ...
     */
    public const TABLE_NAME = 'spy_product_localized_attributes';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'SpyProductLocalizedAttributes';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\Orm\\Zed\\Product\\Persistence\\SpyProductLocalizedAttributes';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'src.Orm.Zed.Product.Persistence.SpyProductLocalizedAttributes';
     ...
     */
    public const COL_ID_PRODUCT_ATTRIBUTES = 'spy_product_localized_attributes.id_product_attributes';

    /**
     * the column name for the fk_locale field
     */
    public const COL_FK_LOCALE = 'spy_product_localized_attributes.fk_locale';

    /**
     * the column name for the fk_product field
     */
    public const COL_FK_PRODUCT = 'spy_product_localized_attributes.fk_product';

    /**
     * the column name for the attributes field
     */
    public const COL_ATTRIBUTES = 'spy_product_localized_attributes.attributes';

    /**
     * the column name for the description field
     */
    public const COL_DESCRIPTION = 'spy_product_localized_attributes.description';

    /**
     * the column name for the is_complete field
     */
    public const COL_IS_COMPLETE = 'spy_product_localized_attributes.is_complete';

    /**
     * the column name for the name field
     */
    public const COL_NAME = 'spy_product_localized_attributes.name';

    /**
     * the column name for the created_at field
     */
    public const COL_CREATED_AT = 'spy_product_localized_attributes.created_at';

    /**
     * the column name for the updated_at field
     */
    public const COL_UPDATED_AT = 'spy_product_localized_attributes.updated_at';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdProductAttributes', 'FkLocale', 'FkProduct', 'Attributes', 'Description', 'IsComplete', 'Name', 'CreatedAt', 'UpdatedAt', ],
        self::TYPE_CAMELNAME     => ['idProductAttributes', 'fkLocale', 'fkProduct', 'attributes', 'description', 'isComplete', 'name', 'createdAt', 'updatedAt', ],
        self::TYPE_COLNAME       => [SpyProductLocalizedAttributesTableMap::COL_ID_PRODUCT_ATTRIBUTES, SpyProductLocalizedAttributesTableMap::COL_FK_LOCALE, SpyProductLocalizedAttributesTableMap::COL_FK_PRODUCT, SpyProductLocalizedAttributesTableMap::COL_ATTRIBUTES, SpyProductLocalizedAttributesTableMap::COL_DESCRIPTION, SpyProductLocalizedAttributesTableMap::COL_IS_COMPLETE, SpyProductLocalizedAttributesTableMap::COL_NAME, SpyProductLocalizedAttributesTableMap::COL_CREATED_AT, SpyProductLocalizedAttributesTableMap::COL_UPDATED_AT, ],
        self::TYPE_FIELDNAME     => ['id_product_attributes', 'fk_locale', 'fk_product', 'attributes', 'description', 'is_complete', 'name', 'created_at', 'updated_at', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdProductAttributes' => 0, 'FkLocale' => 1, 'FkProduct' => 2, 'Attributes' => 3, 'Description' => 4, 'IsComplete' => 5, 'Name' => 6, 'CreatedAt' => 7, 'UpdatedAt' => 8, ],
        self::TYPE_CAMELNAME     => ['idProductAttributes' => 0, 'fkLocale' => 1, 'fkProduct' => 2, 'attributes' => 3, 'description' => 4, 'isComplete' => 5, 'name' => 6, 'createdAt' => 7, 'updatedAt' => 8, ],
        self::TYPE_COLNAME       => [SpyProductLocalizedAttributesTableMap::COL_ID_PRODUCT_ATTRIBUTES => 0, SpyProductLocalizedAttributesTableMap::COL_FK_LOCALE => 1, SpyProductLocalizedAttributesTableMap::COL_FK_PRODUCT => 2, SpyProductLocalizedAttributesTableMap::COL_ATTRIBUTES => 3, SpyProductLocalizedAttributesTableMap::COL_DESCRIPTION => 4, SpyProductLocalizedAttributesTableMap::COL_IS_COMPLETE => 5, SpyProductLocalizedAttributesTableMap::COL_NAME => 6, SpyProductLocalizedAttributesTableMap::COL_CREATED_AT => 7, SpyProductLocalizedAttributesTableMap::COL_UPDATED_AT => 8, ],
        self::TYPE_FIELDNAME     => ['id_product_attributes' => 0, 'fk_locale' => 1, 'fk_product' => 2, 'attributes' => 3, 'description' => 4, 'is_complete' => 5, 'name' => 6, 'created_at' => 7, 'updated_at' => 8, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, 5, 6, 7, 8, ]
    ];
