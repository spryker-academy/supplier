 ...
 *
 * @method     ChildSpyPriceProductConcreteStorage[]|Collection find(?ConnectionInterface $con = null) Return ChildSpyPriceProductConcreteStorage objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpyPriceProductConcreteStorage> find(?ConnectionInterface $con = null) Return ChildSpyPriceProductConcreteStorage objects based on current ModelCriteria
 *
 * @method     ChildSpyPriceProductConcreteStorage[]|Collection findByIdPriceProductConcreteStorage(string|array<string> $id_price_product_concrete_storage) Return ChildSpyPriceProductConcreteStorage objects filtered by the id_price_product_concrete_storage column
 * @psalm-method Collection&\Traversable<ChildSpyPriceProductConcreteStorage> findByIdPriceProductConcreteStorage(string|array<string> $id_price_product_concrete_storage) Return ChildSpyPriceProductConcreteStorage objects filtered by the id_price_product_concrete_storage column
 * @method     ChildSpyPriceProductConcreteStorage[]|Collection findByFkProduct(int|array<int> $fk_product) Return ChildSpyPriceProductConcreteStorage objects filtered by the fk_product column
 * @psalm-method Collection&\Traversable<ChildSpyPriceProductConcreteStorage> findByFkProduct(int|array<int> $fk_product) Return ChildSpyPriceProductConcreteStorage objects filtered by the fk_product column
 * @method     ChildSpyPriceProductConcreteStorage[]|Collection findByData(string|array<string> $data) Return ChildSpyPriceProductConcreteStorage objects filtered by the data column
 * @psalm-method Collection&\Traversable<ChildSpyPriceProductConcreteStorage> findByData(string|array<string> $data) Return ChildSpyPriceProductConcreteStorage objects filtered by the data column
 * @method     ChildSpyPriceProductConcreteStorage[]|Collection findByStore(string|array<string> $store) Return ChildSpyPriceProductConcreteStorage objects filtered by the store column
 * @psalm-method Collection&\Traversable<ChildSpyPriceProductConcreteStorage> findByStore(string|array<string> $store) Return ChildSpyPriceProductConcreteStorage objects filtered by the store column
 * @method     ChildSpyPriceProductConcreteStorage[]|Collection findByAliasKeys(string|array<string> $alias_keys) Return ChildSpyPriceProductConcreteStorage objects filtered by the alias_keys column
 * @psalm-method Collection&\Traversable<ChildSpyPriceProductConcreteStorage> findByAliasKeys(string|array<string> $alias_keys) Return ChildSpyPriceProductConcreteStorage objects filtered by the alias_keys column
 * @method     ChildSpyPriceProductConcreteStorage[]|Collection findByKey(string|array<string> $key) Return ChildSpyPriceProductConcreteStorage objects filtered by the key column
 * @psalm-method Collection&\Traversable<ChildSpyPriceProductConcreteStorage> findByKey(string|array<string> $key) Return ChildSpyPriceProductConcreteStorage objects filtered by the key column
 * @method     ChildSpyPriceProductConcreteStorage[]|Collection findByCreatedAt(string|array<string> $created_at) Return ChildSpyPriceProductConcreteStorage objects filtered by the created_at column
 * @psalm-method Collection&\Traversable<ChildSpyPriceProductConcreteStorage> findByCreatedAt(string|array<string> $created_at) Return ChildSpyPriceProductConcreteStorage objects filtered by the created_at column
 * @method     ChildSpyPriceProductConcreteStorage[]|Collection findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyPriceProductConcreteStorage objects filtered by the updated_at column
 * @psalm-method Collection&\Traversable<ChildSpyPriceProductConcreteStorage> findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyPriceProductConcreteStorage objects filtered by the updated_at column
 *
...
abstract class SpyPriceProductConcreteStorageQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SpyPriceProductConcreteStorageTableMap::COL_ID_PRICE_PRODUCT_CONCRETE_STORAGE, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SpyPriceProductConcreteStorageTableMap::COL_ID_PRICE_PRODUCT_CONCRETE_STORAGE, $keys, Criteria::IN);
    ...
    {
        $this->addUsingAlias(SpyPriceProductConcreteStorageTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addDescendingOrderByColumn(SpyPriceProductConcreteStorageTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addAscendingOrderByColumn(SpyPriceProductConcreteStorageTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addDescendingOrderByColumn(SpyPriceProductConcreteStorageTableMap::COL_CREATED_AT);
    ...
    {
        $this->addUsingAlias(SpyPriceProductConcreteStorageTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addAscendingOrderByColumn(SpyPriceProductConcreteStorageTableMap::COL_CREATED_AT);
