 ...
 *
 * @method     ChildSpyCmsBlockProductStorage[]|Collection find(?ConnectionInterface $con = null) Return ChildSpyCmsBlockProductStorage objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpyCmsBlockProductStorage> find(?ConnectionInterface $con = null) Return ChildSpyCmsBlockProductStorage objects based on current ModelCriteria
 *
 * @method     ChildSpyCmsBlockProductStorage[]|Collection findByIdCmsBlockProductStorage(string|array<string> $id_cms_block_product_storage) Return ChildSpyCmsBlockProductStorage objects filtered by the id_cms_block_product_storage column
 * @psalm-method Collection&\Traversable<ChildSpyCmsBlockProductStorage> findByIdCmsBlockProductStorage(string|array<string> $id_cms_block_product_storage) Return ChildSpyCmsBlockProductStorage objects filtered by the id_cms_block_product_storage column
 * @method     ChildSpyCmsBlockProductStorage[]|Collection findByFkProductAbstract(int|array<int> $fk_product_abstract) Return ChildSpyCmsBlockProductStorage objects filtered by the fk_product_abstract column
 * @psalm-method Collection&\Traversable<ChildSpyCmsBlockProductStorage> findByFkProductAbstract(int|array<int> $fk_product_abstract) Return ChildSpyCmsBlockProductStorage objects filtered by the fk_product_abstract column
 * @method     ChildSpyCmsBlockProductStorage[]|Collection findByData(string|array<string> $data) Return ChildSpyCmsBlockProductStorage objects filtered by the data column
 * @psalm-method Collection&\Traversable<ChildSpyCmsBlockProductStorage> findByData(string|array<string> $data) Return ChildSpyCmsBlockProductStorage objects filtered by the data column
 * @method     ChildSpyCmsBlockProductStorage[]|Collection findByAliasKeys(string|array<string> $alias_keys) Return ChildSpyCmsBlockProductStorage objects filtered by the alias_keys column
 * @psalm-method Collection&\Traversable<ChildSpyCmsBlockProductStorage> findByAliasKeys(string|array<string> $alias_keys) Return ChildSpyCmsBlockProductStorage objects filtered by the alias_keys column
 * @method     ChildSpyCmsBlockProductStorage[]|Collection findByKey(string|array<string> $key) Return ChildSpyCmsBlockProductStorage objects filtered by the key column
 * @psalm-method Collection&\Traversable<ChildSpyCmsBlockProductStorage> findByKey(string|array<string> $key) Return ChildSpyCmsBlockProductStorage objects filtered by the key column
 * @method     ChildSpyCmsBlockProductStorage[]|Collection findByCreatedAt(string|array<string> $created_at) Return ChildSpyCmsBlockProductStorage objects filtered by the created_at column
 * @psalm-method Collection&\Traversable<ChildSpyCmsBlockProductStorage> findByCreatedAt(string|array<string> $created_at) Return ChildSpyCmsBlockProductStorage objects filtered by the created_at column
 * @method     ChildSpyCmsBlockProductStorage[]|Collection findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyCmsBlockProductStorage objects filtered by the updated_at column
 * @psalm-method Collection&\Traversable<ChildSpyCmsBlockProductStorage> findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyCmsBlockProductStorage objects filtered by the updated_at column
 *
...
abstract class SpyCmsBlockProductStorageQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SpyCmsBlockProductStorageTableMap::COL_ID_CMS_BLOCK_PRODUCT_STORAGE, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SpyCmsBlockProductStorageTableMap::COL_ID_CMS_BLOCK_PRODUCT_STORAGE, $keys, Criteria::IN);
    ...
    {
        $this->addUsingAlias(SpyCmsBlockProductStorageTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addDescendingOrderByColumn(SpyCmsBlockProductStorageTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addAscendingOrderByColumn(SpyCmsBlockProductStorageTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addDescendingOrderByColumn(SpyCmsBlockProductStorageTableMap::COL_CREATED_AT);
    ...
    {
        $this->addUsingAlias(SpyCmsBlockProductStorageTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addAscendingOrderByColumn(SpyCmsBlockProductStorageTableMap::COL_CREATED_AT);
