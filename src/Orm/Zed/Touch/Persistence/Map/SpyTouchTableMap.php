...
class SpyTouchTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'src.Orm.Zed.Touch.Persistence.Map.SpyTouchTableMap';
     ...
     */
    public const TABLE_PHP_NAME = 'SpyTouch';
     ...
     */
    public const CLASS_DEFAULT = 'src.Orm.Zed.Touch.Persistence.SpyTouch';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdTouch', 'ItemEvent', 'ItemId', 'ItemType', 'Touched', ],
        self::TYPE_CAMELNAME     => ['idTouch', 'itemEvent', 'itemId', 'itemType', 'touched', ],
        self::TYPE_COLNAME       => [SpyTouchTableMap::COL_ID_TOUCH, SpyTouchTableMap::COL_ITEM_EVENT, SpyTouchTableMap::COL_ITEM_ID, SpyTouchTableMap::COL_ITEM_TYPE, SpyTouchTableMap::COL_TOUCHED, ],
        self::TYPE_FIELDNAME     => ['id_touch', 'item_event', 'item_id', 'item_type', 'touched', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdTouch' => 0, 'ItemEvent' => 1, 'ItemId' => 2, 'ItemType' => 3, 'Touched' => 4, ],
        self::TYPE_CAMELNAME     => ['idTouch' => 0, 'itemEvent' => 1, 'itemId' => 2, 'itemType' => 3, 'touched' => 4, ],
        self::TYPE_COLNAME       => [SpyTouchTableMap::COL_ID_TOUCH => 0, SpyTouchTableMap::COL_ITEM_EVENT => 1, SpyTouchTableMap::COL_ITEM_ID => 2, SpyTouchTableMap::COL_ITEM_TYPE => 3, SpyTouchTableMap::COL_TOUCHED => 4, ],
        self::TYPE_FIELDNAME     => ['id_touch' => 0, 'item_event' => 1, 'item_id' => 2, 'item_type' => 3, 'touched' => 4, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, ]
    ];
