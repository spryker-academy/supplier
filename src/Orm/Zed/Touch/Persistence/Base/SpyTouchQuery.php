 ...
 *
 * @method     ChildSpyTouch[]|Collection findByIdTouch(int|array<int> $id_touch) Return ChildSpyTouch objects filtered by the id_touch column
 * @psalm-method Collection&\Traversable<ChildSpyTouch> findByIdTouch(int|array<int> $id_touch) Return ChildSpyTouch objects filtered by the id_touch column
 * @method     ChildSpyTouch[]|Collection findByItemEvent(int|array<int> $item_event) Return ChildSpyTouch objects filtered by the item_event column
 * @psalm-method Collection&\Traversable<ChildSpyTouch> findByItemEvent(int|array<int> $item_event) Return ChildSpyTouch objects filtered by the item_event column
 * @method     ChildSpyTouch[]|Collection findByItemId(int|array<int> $item_id) Return ChildSpyTouch objects filtered by the item_id column
 * @psalm-method Collection&\Traversable<ChildSpyTouch> findByItemId(int|array<int> $item_id) Return ChildSpyTouch objects filtered by the item_id column
 * @method     ChildSpyTouch[]|Collection findByItemType(string|array<string> $item_type) Return ChildSpyTouch objects filtered by the item_type column
 * @psalm-method Collection&\Traversable<ChildSpyTouch> findByItemType(string|array<string> $item_type) Return ChildSpyTouch objects filtered by the item_type column
 * @method     ChildSpyTouch[]|Collection findByTouched(string|array<string> $touched) Return ChildSpyTouch objects filtered by the touched column
 * @psalm-method Collection&\Traversable<ChildSpyTouch> findByTouched(string|array<string> $touched) Return ChildSpyTouch objects filtered by the touched column
 *
