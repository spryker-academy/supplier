...
abstract class SpyTouch implements ActiveRecordInterface
{
     ...
     * The event type for an item in the touch table (active, inactive, deleted).
     * @var        int
     */
     ...
     * The ID of the item that was "touched" or interacted with.
     * @var        int
     */
    protected $item_id;
     ...
     * The type of item being touched.
     * @var        string
     */
    protected $item_type;
     ...
     * The timestamp indicating when an item was last touched or updated.
     * @var        DateTime
     */
    protected $touched;
