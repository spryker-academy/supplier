 ...
 *
 * @method     ChildSpyTouchStorage[]|Collection find(?ConnectionInterface $con = null) Return ChildSpyTouchStorage objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpyTouchStorage> find(?ConnectionInterface $con = null) Return ChildSpyTouchStorage objects based on current ModelCriteria
 *
 * @method     ChildSpyTouchStorage[]|Collection findByIdTouchStorage(int|array<int> $id_touch_storage) Return ChildSpyTouchStorage objects filtered by the id_touch_storage column
 * @psalm-method Collection&\Traversable<ChildSpyTouchStorage> findByIdTouchStorage(int|array<int> $id_touch_storage) Return ChildSpyTouchStorage objects filtered by the id_touch_storage column
 * @method     ChildSpyTouchStorage[]|Collection findByFkLocale(int|array<int> $fk_locale) Return ChildSpyTouchStorage objects filtered by the fk_locale column
 * @psalm-method Collection&\Traversable<ChildSpyTouchStorage> findByFkLocale(int|array<int> $fk_locale) Return ChildSpyTouchStorage objects filtered by the fk_locale column
 * @method     ChildSpyTouchStorage[]|Collection findByFkStore(int|array<int> $fk_store) Return ChildSpyTouchStorage objects filtered by the fk_store column
 * @psalm-method Collection&\Traversable<ChildSpyTouchStorage> findByFkStore(int|array<int> $fk_store) Return ChildSpyTouchStorage objects filtered by the fk_store column
 * @method     ChildSpyTouchStorage[]|Collection findByFkTouch(int|array<int> $fk_touch) Return ChildSpyTouchStorage objects filtered by the fk_touch column
 * @psalm-method Collection&\Traversable<ChildSpyTouchStorage> findByFkTouch(int|array<int> $fk_touch) Return ChildSpyTouchStorage objects filtered by the fk_touch column
 * @method     ChildSpyTouchStorage[]|Collection findByKey(string|array<string> $key) Return ChildSpyTouchStorage objects filtered by the key column
 * @psalm-method Collection&\Traversable<ChildSpyTouchStorage> findByKey(string|array<string> $key) Return ChildSpyTouchStorage objects filtered by the key column
 *
...
abstract class SpyTouchStorageQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SpyTouchStorageTableMap::COL_ID_TOUCH_STORAGE, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SpyTouchStorageTableMap::COL_ID_TOUCH_STORAGE, $keys, Criteria::IN);
    ...
    {
        /** @var $q \Orm\Zed\Touch\Persistence\SpyTouchQuery */
        $q = $this->useExistsQuery('Touch', $modelAlias, $queryClass, $typeOfExists);
        return $q;
    }
    ...
    {
        /** @var $q \Orm\Zed\Touch\Persistence\SpyTouchQuery */
        $q = $this->useExistsQuery('Touch', $modelAlias, $queryClass, 'NOT EXISTS');
        return $q;
    }

    /**
     * Use the Touch relation to the SpyTouch table for an IN query.
     *
     ...
     *
     * @return \Orm\Zed\Touch\Persistence\SpyTouchQuery The inner query object of the IN statement
     */
    public function useInTouchQuery($modelAlias = null, $queryClass = null, $typeOfIn = 'IN')
    {
        /** @var $q \Orm\Zed\Touch\Persistence\SpyTouchQuery */
        $q = $this->useInQuery('Touch', $modelAlias, $queryClass, $typeOfIn);
        return $q;
    }

    /**
     * Use the Touch relation to the SpyTouch table for a NOT IN query.
     *
     * @see useTouchInQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     ...
     *
     * @return \Orm\Zed\Touch\Persistence\SpyTouchQuery The inner query object of the NOT IN statement
     */
    public function useNotInTouchQuery($modelAlias = null, $queryClass = null)
    {
        /** @var $q \Orm\Zed\Touch\Persistence\SpyTouchQuery */
        $q = $this->useInQuery('Touch', $modelAlias, $queryClass, 'NOT IN');
        return $q;
    }
