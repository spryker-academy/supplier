 ...
 *
 * @method     ChildSpyTouchSearch[]|Collection findByIdTouchSearch(int|array<int> $id_touch_search) Return ChildSpyTouchSearch objects filtered by the id_touch_search column
 * @psalm-method Collection&\Traversable<ChildSpyTouchSearch> findByIdTouchSearch(int|array<int> $id_touch_search) Return ChildSpyTouchSearch objects filtered by the id_touch_search column
 * @method     ChildSpyTouchSearch[]|Collection findByFkLocale(int|array<int> $fk_locale) Return ChildSpyTouchSearch objects filtered by the fk_locale column
 * @psalm-method Collection&\Traversable<ChildSpyTouchSearch> findByFkLocale(int|array<int> $fk_locale) Return ChildSpyTouchSearch objects filtered by the fk_locale column
 * @method     ChildSpyTouchSearch[]|Collection findByFkStore(int|array<int> $fk_store) Return ChildSpyTouchSearch objects filtered by the fk_store column
 * @psalm-method Collection&\Traversable<ChildSpyTouchSearch> findByFkStore(int|array<int> $fk_store) Return ChildSpyTouchSearch objects filtered by the fk_store column
 * @method     ChildSpyTouchSearch[]|Collection findByFkTouch(int|array<int> $fk_touch) Return ChildSpyTouchSearch objects filtered by the fk_touch column
 * @psalm-method Collection&\Traversable<ChildSpyTouchSearch> findByFkTouch(int|array<int> $fk_touch) Return ChildSpyTouchSearch objects filtered by the fk_touch column
 * @method     ChildSpyTouchSearch[]|Collection findByKey(string|array<string> $key) Return ChildSpyTouchSearch objects filtered by the key column
 * @psalm-method Collection&\Traversable<ChildSpyTouchSearch> findByKey(string|array<string> $key) Return ChildSpyTouchSearch objects filtered by the key column
 *
