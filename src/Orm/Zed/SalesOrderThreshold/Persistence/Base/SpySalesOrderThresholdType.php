...
abstract class SpySalesOrderThresholdType implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Orm\\Zed\\SalesOrderThreshold\\Persistence\\Map\\SpySalesOrderThresholdTypeTableMap';
     ...
     * A key to group similar sales order thresholds together.
     * @var        string
     */
     ...
     */
    protected function doAddSpySalesOrderThreshold(ChildSpySalesOrderThreshold $spySalesOrderThreshold): void
    {
