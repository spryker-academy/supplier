...
class SpyLocaleStoreTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'src.Orm.Zed.Locale.Persistence.Map.SpyLocaleStoreTableMap';
     ...
     */
    public const CLASS_DEFAULT = 'src.Orm.Zed.Locale.Persistence.SpyLocaleStore';
  ...
  array (
    ...
    {
        return [
            'event' => ['spy_locale_store_all' => ['column' => '*']],
