...
class SpyLocaleTableMap extends TableMap
{
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdLocale', 'IsActive', 'LocaleName', ],
        self::TYPE_CAMELNAME     => ['idLocale', 'isActive', 'localeName', ],
        self::TYPE_COLNAME       => [SpyLocaleTableMap::COL_ID_LOCALE, SpyLocaleTableMap::COL_IS_ACTIVE, SpyLocaleTableMap::COL_LOCALE_NAME, ],
        self::TYPE_FIELDNAME     => ['id_locale', 'is_active', 'locale_name', ],
        self::TYPE_NUM           => [0, 1, 2, ]
    ];
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdLocale' => 0, 'IsActive' => 1, 'LocaleName' => 2, ],
        self::TYPE_CAMELNAME     => ['idLocale' => 0, 'isActive' => 1, 'localeName' => 2, ],
        self::TYPE_COLNAME       => [SpyLocaleTableMap::COL_ID_LOCALE => 0, SpyLocaleTableMap::COL_IS_ACTIVE => 1, SpyLocaleTableMap::COL_LOCALE_NAME => 2, ],
        self::TYPE_FIELDNAME     => ['id_locale' => 0, 'is_active' => 1, 'locale_name' => 2, ],
        self::TYPE_NUM           => [0, 1, 2, ]
    ];
