...
abstract class SpyPriceProduct implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Orm\\Zed\\PriceProduct\\Persistence\\Map\\SpyPriceProductTableMap';
     ...
     */
    protected function doAddPriceProductStore(ChildSpyPriceProductStore $priceProductStore): void
    {
