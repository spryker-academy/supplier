...
class SpyCmsBlockCategoryPositionTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'src.Orm.Zed.CmsBlockCategoryConnector.Persistence.Map.SpyCmsBlockCategoryPositionTableMap';
     ...
     */
    public const TABLE_NAME = 'spy_cms_block_category_position';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'SpyCmsBlockCategoryPosition';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\Orm\\Zed\\CmsBlockCategoryConnector\\Persistence\\SpyCmsBlockCategoryPosition';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'src.Orm.Zed.CmsBlockCategoryConnector.Persistence.SpyCmsBlockCategoryPosition';
     ...
     */
    public const COL_ID_CMS_BLOCK_CATEGORY_POSITION = 'spy_cms_block_category_position.id_cms_block_category_position';

    /**
     * the column name for the name field
     */
    public const COL_NAME = 'spy_cms_block_category_position.name';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdCmsBlockCategoryPosition', 'Name', ],
        self::TYPE_CAMELNAME     => ['idCmsBlockCategoryPosition', 'name', ],
        self::TYPE_COLNAME       => [SpyCmsBlockCategoryPositionTableMap::COL_ID_CMS_BLOCK_CATEGORY_POSITION, SpyCmsBlockCategoryPositionTableMap::COL_NAME, ],
        self::TYPE_FIELDNAME     => ['id_cms_block_category_position', 'name', ],
        self::TYPE_NUM           => [0, 1, ]
    ];
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdCmsBlockCategoryPosition' => 0, 'Name' => 1, ],
        self::TYPE_CAMELNAME     => ['idCmsBlockCategoryPosition' => 0, 'name' => 1, ],
        self::TYPE_COLNAME       => [SpyCmsBlockCategoryPositionTableMap::COL_ID_CMS_BLOCK_CATEGORY_POSITION => 0, SpyCmsBlockCategoryPositionTableMap::COL_NAME => 1, ],
        self::TYPE_FIELDNAME     => ['id_cms_block_category_position' => 0, 'name' => 1, ],
        self::TYPE_NUM           => [0, 1, ]
    ];
