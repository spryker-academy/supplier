...
abstract class SpyCmsBlockCategoryPosition implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Orm\\Zed\\CmsBlockCategoryConnector\\Persistence\\Map\\SpyCmsBlockCategoryPositionTableMap';
     ...
     */
    protected function doAddSpyCmsBlockCategoryConnector(ChildSpyCmsBlockCategoryConnector $spyCmsBlockCategoryConnector): void
    {
