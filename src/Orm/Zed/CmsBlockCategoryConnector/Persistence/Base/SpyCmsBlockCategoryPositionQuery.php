 ...
 *
 * @method     ChildSpyCmsBlockCategoryPosition[]|Collection find(?ConnectionInterface $con = null) Return ChildSpyCmsBlockCategoryPosition objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpyCmsBlockCategoryPosition> find(?ConnectionInterface $con = null) Return ChildSpyCmsBlockCategoryPosition objects based on current ModelCriteria
 *
 * @method     ChildSpyCmsBlockCategoryPosition[]|Collection findByIdCmsBlockCategoryPosition(int|array<int> $id_cms_block_category_position) Return ChildSpyCmsBlockCategoryPosition objects filtered by the id_cms_block_category_position column
 * @psalm-method Collection&\Traversable<ChildSpyCmsBlockCategoryPosition> findByIdCmsBlockCategoryPosition(int|array<int> $id_cms_block_category_position) Return ChildSpyCmsBlockCategoryPosition objects filtered by the id_cms_block_category_position column
 * @method     ChildSpyCmsBlockCategoryPosition[]|Collection findByName(string|array<string> $name) Return ChildSpyCmsBlockCategoryPosition objects filtered by the name column
 * @psalm-method Collection&\Traversable<ChildSpyCmsBlockCategoryPosition> findByName(string|array<string> $name) Return ChildSpyCmsBlockCategoryPosition objects filtered by the name column
 *
...
abstract class SpyCmsBlockCategoryPositionQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SpyCmsBlockCategoryPositionTableMap::COL_ID_CMS_BLOCK_CATEGORY_POSITION, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SpyCmsBlockCategoryPositionTableMap::COL_ID_CMS_BLOCK_CATEGORY_POSITION, $keys, Criteria::IN);
     ...
     * @return $this The current query, for fluid interface
     */
    public function joinSpyCmsBlockCategoryConnector(?string $relationAlias = null, ?string $joinType = Criteria::LEFT_JOIN)
    {
