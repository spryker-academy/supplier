 ...
 *
 * @method     ChildSpySequenceNumber[]|Collection findByIdSequenceNumber(int|array<int> $id_sequence_number) Return ChildSpySequenceNumber objects filtered by the id_sequence_number column
 * @psalm-method Collection&\Traversable<ChildSpySequenceNumber> findByIdSequenceNumber(int|array<int> $id_sequence_number) Return ChildSpySequenceNumber objects filtered by the id_sequence_number column
 * @method     ChildSpySequenceNumber[]|Collection findByName(string|array<string> $name) Return ChildSpySequenceNumber objects filtered by the name column
 * @psalm-method Collection&\Traversable<ChildSpySequenceNumber> findByName(string|array<string> $name) Return ChildSpySequenceNumber objects filtered by the name column
 * @method     ChildSpySequenceNumber[]|Collection findByCurrentId(int|array<int> $current_id) Return ChildSpySequenceNumber objects filtered by the current_id column
 * @psalm-method Collection&\Traversable<ChildSpySequenceNumber> findByCurrentId(int|array<int> $current_id) Return ChildSpySequenceNumber objects filtered by the current_id column
 *
