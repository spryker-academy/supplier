 ...
 *
 * @method     ChildSpyStockProduct[]|Collection find(?ConnectionInterface $con = null) Return ChildSpyStockProduct objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpyStockProduct> find(?ConnectionInterface $con = null) Return ChildSpyStockProduct objects based on current ModelCriteria
 *
 * @method     ChildSpyStockProduct[]|Collection findByIdStockProduct(int|array<int> $id_stock_product) Return ChildSpyStockProduct objects filtered by the id_stock_product column
 * @psalm-method Collection&\Traversable<ChildSpyStockProduct> findByIdStockProduct(int|array<int> $id_stock_product) Return ChildSpyStockProduct objects filtered by the id_stock_product column
 * @method     ChildSpyStockProduct[]|Collection findByFkProduct(int|array<int> $fk_product) Return ChildSpyStockProduct objects filtered by the fk_product column
 * @psalm-method Collection&\Traversable<ChildSpyStockProduct> findByFkProduct(int|array<int> $fk_product) Return ChildSpyStockProduct objects filtered by the fk_product column
 * @method     ChildSpyStockProduct[]|Collection findByFkStock(int|array<int> $fk_stock) Return ChildSpyStockProduct objects filtered by the fk_stock column
 * @psalm-method Collection&\Traversable<ChildSpyStockProduct> findByFkStock(int|array<int> $fk_stock) Return ChildSpyStockProduct objects filtered by the fk_stock column
 * @method     ChildSpyStockProduct[]|Collection findByIsNeverOutOfStock(boolean|array<boolean> $is_never_out_of_stock) Return ChildSpyStockProduct objects filtered by the is_never_out_of_stock column
 * @psalm-method Collection&\Traversable<ChildSpyStockProduct> findByIsNeverOutOfStock(boolean|array<boolean> $is_never_out_of_stock) Return ChildSpyStockProduct objects filtered by the is_never_out_of_stock column
 * @method     ChildSpyStockProduct[]|Collection findByQuantity(string|array<string> $quantity) Return ChildSpyStockProduct objects filtered by the quantity column
 * @psalm-method Collection&\Traversable<ChildSpyStockProduct> findByQuantity(string|array<string> $quantity) Return ChildSpyStockProduct objects filtered by the quantity column
 *
...
abstract class SpyStockProductQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SpyStockProductTableMap::COL_ID_STOCK_PRODUCT, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SpyStockProductTableMap::COL_ID_STOCK_PRODUCT, $keys, Criteria::IN);
