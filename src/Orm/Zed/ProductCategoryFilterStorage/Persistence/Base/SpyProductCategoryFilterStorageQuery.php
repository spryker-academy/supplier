 ...
 *
 * @method     ChildSpyProductCategoryFilterStorage[]|Collection find(?ConnectionInterface $con = null) Return ChildSpyProductCategoryFilterStorage objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpyProductCategoryFilterStorage> find(?ConnectionInterface $con = null) Return ChildSpyProductCategoryFilterStorage objects based on current ModelCriteria
 *
 * @method     ChildSpyProductCategoryFilterStorage[]|Collection findByIdProductCategoryFilterStorage(string|array<string> $id_product_category_filter_storage) Return ChildSpyProductCategoryFilterStorage objects filtered by the id_product_category_filter_storage column
 * @psalm-method Collection&\Traversable<ChildSpyProductCategoryFilterStorage> findByIdProductCategoryFilterStorage(string|array<string> $id_product_category_filter_storage) Return ChildSpyProductCategoryFilterStorage objects filtered by the id_product_category_filter_storage column
 * @method     ChildSpyProductCategoryFilterStorage[]|Collection findByFkCategory(int|array<int> $fk_category) Return ChildSpyProductCategoryFilterStorage objects filtered by the fk_category column
 * @psalm-method Collection&\Traversable<ChildSpyProductCategoryFilterStorage> findByFkCategory(int|array<int> $fk_category) Return ChildSpyProductCategoryFilterStorage objects filtered by the fk_category column
 * @method     ChildSpyProductCategoryFilterStorage[]|Collection findByData(string|array<string> $data) Return ChildSpyProductCategoryFilterStorage objects filtered by the data column
 * @psalm-method Collection&\Traversable<ChildSpyProductCategoryFilterStorage> findByData(string|array<string> $data) Return ChildSpyProductCategoryFilterStorage objects filtered by the data column
 * @method     ChildSpyProductCategoryFilterStorage[]|Collection findByAliasKeys(string|array<string> $alias_keys) Return ChildSpyProductCategoryFilterStorage objects filtered by the alias_keys column
 * @psalm-method Collection&\Traversable<ChildSpyProductCategoryFilterStorage> findByAliasKeys(string|array<string> $alias_keys) Return ChildSpyProductCategoryFilterStorage objects filtered by the alias_keys column
 * @method     ChildSpyProductCategoryFilterStorage[]|Collection findByKey(string|array<string> $key) Return ChildSpyProductCategoryFilterStorage objects filtered by the key column
 * @psalm-method Collection&\Traversable<ChildSpyProductCategoryFilterStorage> findByKey(string|array<string> $key) Return ChildSpyProductCategoryFilterStorage objects filtered by the key column
 * @method     ChildSpyProductCategoryFilterStorage[]|Collection findByCreatedAt(string|array<string> $created_at) Return ChildSpyProductCategoryFilterStorage objects filtered by the created_at column
 * @psalm-method Collection&\Traversable<ChildSpyProductCategoryFilterStorage> findByCreatedAt(string|array<string> $created_at) Return ChildSpyProductCategoryFilterStorage objects filtered by the created_at column
 * @method     ChildSpyProductCategoryFilterStorage[]|Collection findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyProductCategoryFilterStorage objects filtered by the updated_at column
 * @psalm-method Collection&\Traversable<ChildSpyProductCategoryFilterStorage> findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyProductCategoryFilterStorage objects filtered by the updated_at column
 *
...
abstract class SpyProductCategoryFilterStorageQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SpyProductCategoryFilterStorageTableMap::COL_ID_PRODUCT_CATEGORY_FILTER_STORAGE, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SpyProductCategoryFilterStorageTableMap::COL_ID_PRODUCT_CATEGORY_FILTER_STORAGE, $keys, Criteria::IN);
    ...
    {
        $this->addUsingAlias(SpyProductCategoryFilterStorageTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addDescendingOrderByColumn(SpyProductCategoryFilterStorageTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addAscendingOrderByColumn(SpyProductCategoryFilterStorageTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addDescendingOrderByColumn(SpyProductCategoryFilterStorageTableMap::COL_CREATED_AT);
    ...
    {
        $this->addUsingAlias(SpyProductCategoryFilterStorageTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addAscendingOrderByColumn(SpyProductCategoryFilterStorageTableMap::COL_CREATED_AT);
