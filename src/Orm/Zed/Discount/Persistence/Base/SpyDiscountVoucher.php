...
abstract class SpyDiscountVoucher implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Orm\\Zed\\Discount\\Persistence\\Map\\SpyDiscountVoucherTableMap';
     ...
     * The maximum number of times a discount voucher can be used in total.
     * @var        int|null
     */
     ...
     * The current number of times a discount voucher has been used.
     * @var        int|null
     */
     ...
     * An identifier to group a batch of generated discount vouchers.
