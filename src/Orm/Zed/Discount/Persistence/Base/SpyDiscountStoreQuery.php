 ...
 *
 * @method     ChildSpyDiscountStore[]|Collection find(?ConnectionInterface $con = null) Return ChildSpyDiscountStore objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpyDiscountStore> find(?ConnectionInterface $con = null) Return ChildSpyDiscountStore objects based on current ModelCriteria
 *
 * @method     ChildSpyDiscountStore[]|Collection findByIdDiscountStore(int|array<int> $id_discount_store) Return ChildSpyDiscountStore objects filtered by the id_discount_store column
 * @psalm-method Collection&\Traversable<ChildSpyDiscountStore> findByIdDiscountStore(int|array<int> $id_discount_store) Return ChildSpyDiscountStore objects filtered by the id_discount_store column
 * @method     ChildSpyDiscountStore[]|Collection findByFkDiscount(int|array<int> $fk_discount) Return ChildSpyDiscountStore objects filtered by the fk_discount column
 * @psalm-method Collection&\Traversable<ChildSpyDiscountStore> findByFkDiscount(int|array<int> $fk_discount) Return ChildSpyDiscountStore objects filtered by the fk_discount column
 * @method     ChildSpyDiscountStore[]|Collection findByFkStore(int|array<int> $fk_store) Return ChildSpyDiscountStore objects filtered by the fk_store column
 * @psalm-method Collection&\Traversable<ChildSpyDiscountStore> findByFkStore(int|array<int> $fk_store) Return ChildSpyDiscountStore objects filtered by the fk_store column
 *
...
abstract class SpyDiscountStoreQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SpyDiscountStoreTableMap::COL_ID_DISCOUNT_STORE, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SpyDiscountStoreTableMap::COL_ID_DISCOUNT_STORE, $keys, Criteria::IN);
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterBySpyDiscount($spyDiscount, ?string $comparison = null)
    {
     ...
     * @return $this The current query, for fluid interface
     */
    public function joinSpyDiscount(?string $relationAlias = null, ?string $joinType = Criteria::INNER_JOIN)
    {
    ...
    public function useSpyDiscountExistsQuery($modelAlias = null, $queryClass = null, $typeOfExists = 'EXISTS')
    {
        ...
        $q = $this->useExistsQuery('SpyDiscount', $modelAlias, $queryClass, $typeOfExists);
        return $q;
    }
    ...
    {
        /** @var $q \Orm\Zed\Discount\Persistence\SpyDiscountQuery */
        $q = $this->useExistsQuery('SpyDiscount', $modelAlias, $queryClass, 'NOT EXISTS');
        return $q;
    }

    /**
     * Use the relation to SpyDiscount table for an IN query.
     *
     ...
     */
    public function useInSpyDiscountQuery($modelAlias = null, $queryClass = null, $typeOfIn = 'IN')
    {
        /** @var $q \Orm\Zed\Discount\Persistence\SpyDiscountQuery */
        $q = $this->useInQuery('SpyDiscount', $modelAlias, $queryClass, $typeOfIn);
        return $q;
    }

    /**
     * Use the relation to SpyDiscount table for a NOT IN query.
     *
     * @see useSpyDiscountInQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     ...
     */
    public function useNotInSpyDiscountQuery($modelAlias = null, $queryClass = null)
    {
        /** @var $q \Orm\Zed\Discount\Persistence\SpyDiscountQuery */
        $q = $this->useInQuery('SpyDiscount', $modelAlias, $queryClass, 'NOT IN');
        return $q;
    }
