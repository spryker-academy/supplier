 ...
 *
 * @method     ChildSpyProductAbstractRelationStorage[]|Collection find(?ConnectionInterface $con = null) Return ChildSpyProductAbstractRelationStorage objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpyProductAbstractRelationStorage> find(?ConnectionInterface $con = null) Return ChildSpyProductAbstractRelationStorage objects based on current ModelCriteria
 *
 * @method     ChildSpyProductAbstractRelationStorage[]|Collection findByIdProductAbstractRelationStorage(string|array<string> $id_product_abstract_relation_storage) Return ChildSpyProductAbstractRelationStorage objects filtered by the id_product_abstract_relation_storage column
 * @psalm-method Collection&\Traversable<ChildSpyProductAbstractRelationStorage> findByIdProductAbstractRelationStorage(string|array<string> $id_product_abstract_relation_storage) Return ChildSpyProductAbstractRelationStorage objects filtered by the id_product_abstract_relation_storage column
 * @method     ChildSpyProductAbstractRelationStorage[]|Collection findByFkProductAbstract(int|array<int> $fk_product_abstract) Return ChildSpyProductAbstractRelationStorage objects filtered by the fk_product_abstract column
 * @psalm-method Collection&\Traversable<ChildSpyProductAbstractRelationStorage> findByFkProductAbstract(int|array<int> $fk_product_abstract) Return ChildSpyProductAbstractRelationStorage objects filtered by the fk_product_abstract column
 * @method     ChildSpyProductAbstractRelationStorage[]|Collection findByData(string|array<string> $data) Return ChildSpyProductAbstractRelationStorage objects filtered by the data column
 * @psalm-method Collection&\Traversable<ChildSpyProductAbstractRelationStorage> findByData(string|array<string> $data) Return ChildSpyProductAbstractRelationStorage objects filtered by the data column
 * @method     ChildSpyProductAbstractRelationStorage[]|Collection findByStore(string|array<string> $store) Return ChildSpyProductAbstractRelationStorage objects filtered by the store column
 * @psalm-method Collection&\Traversable<ChildSpyProductAbstractRelationStorage> findByStore(string|array<string> $store) Return ChildSpyProductAbstractRelationStorage objects filtered by the store column
 * @method     ChildSpyProductAbstractRelationStorage[]|Collection findByAliasKeys(string|array<string> $alias_keys) Return ChildSpyProductAbstractRelationStorage objects filtered by the alias_keys column
 * @psalm-method Collection&\Traversable<ChildSpyProductAbstractRelationStorage> findByAliasKeys(string|array<string> $alias_keys) Return ChildSpyProductAbstractRelationStorage objects filtered by the alias_keys column
 * @method     ChildSpyProductAbstractRelationStorage[]|Collection findByKey(string|array<string> $key) Return ChildSpyProductAbstractRelationStorage objects filtered by the key column
 * @psalm-method Collection&\Traversable<ChildSpyProductAbstractRelationStorage> findByKey(string|array<string> $key) Return ChildSpyProductAbstractRelationStorage objects filtered by the key column
 * @method     ChildSpyProductAbstractRelationStorage[]|Collection findByCreatedAt(string|array<string> $created_at) Return ChildSpyProductAbstractRelationStorage objects filtered by the created_at column
 * @psalm-method Collection&\Traversable<ChildSpyProductAbstractRelationStorage> findByCreatedAt(string|array<string> $created_at) Return ChildSpyProductAbstractRelationStorage objects filtered by the created_at column
 * @method     ChildSpyProductAbstractRelationStorage[]|Collection findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyProductAbstractRelationStorage objects filtered by the updated_at column
 * @psalm-method Collection&\Traversable<ChildSpyProductAbstractRelationStorage> findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyProductAbstractRelationStorage objects filtered by the updated_at column
 *
...
abstract class SpyProductAbstractRelationStorageQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SpyProductAbstractRelationStorageTableMap::COL_ID_PRODUCT_ABSTRACT_RELATION_STORAGE, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SpyProductAbstractRelationStorageTableMap::COL_ID_PRODUCT_ABSTRACT_RELATION_STORAGE, $keys, Criteria::IN);
    ...
    {
        $this->addUsingAlias(SpyProductAbstractRelationStorageTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addDescendingOrderByColumn(SpyProductAbstractRelationStorageTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addAscendingOrderByColumn(SpyProductAbstractRelationStorageTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addDescendingOrderByColumn(SpyProductAbstractRelationStorageTableMap::COL_CREATED_AT);
    ...
    {
        $this->addUsingAlias(SpyProductAbstractRelationStorageTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addAscendingOrderByColumn(SpyProductAbstractRelationStorageTableMap::COL_CREATED_AT);
