 ...
 *
 * @method     ChildSpyCmsPageStorage[]|Collection find(?ConnectionInterface $con = null) Return ChildSpyCmsPageStorage objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpyCmsPageStorage> find(?ConnectionInterface $con = null) Return ChildSpyCmsPageStorage objects based on current ModelCriteria
 *
 * @method     ChildSpyCmsPageStorage[]|Collection findByIdCmsPageStorage(string|array<string> $id_cms_page_storage) Return ChildSpyCmsPageStorage objects filtered by the id_cms_page_storage column
 * @psalm-method Collection&\Traversable<ChildSpyCmsPageStorage> findByIdCmsPageStorage(string|array<string> $id_cms_page_storage) Return ChildSpyCmsPageStorage objects filtered by the id_cms_page_storage column
 * @method     ChildSpyCmsPageStorage[]|Collection findByFkCmsPage(int|array<int> $fk_cms_page) Return ChildSpyCmsPageStorage objects filtered by the fk_cms_page column
 * @psalm-method Collection&\Traversable<ChildSpyCmsPageStorage> findByFkCmsPage(int|array<int> $fk_cms_page) Return ChildSpyCmsPageStorage objects filtered by the fk_cms_page column
 * @method     ChildSpyCmsPageStorage[]|Collection findByData(string|array<string> $data) Return ChildSpyCmsPageStorage objects filtered by the data column
 * @psalm-method Collection&\Traversable<ChildSpyCmsPageStorage> findByData(string|array<string> $data) Return ChildSpyCmsPageStorage objects filtered by the data column
 * @method     ChildSpyCmsPageStorage[]|Collection findByStore(string|array<string> $store) Return ChildSpyCmsPageStorage objects filtered by the store column
 * @psalm-method Collection&\Traversable<ChildSpyCmsPageStorage> findByStore(string|array<string> $store) Return ChildSpyCmsPageStorage objects filtered by the store column
 * @method     ChildSpyCmsPageStorage[]|Collection findByLocale(string|array<string> $locale) Return ChildSpyCmsPageStorage objects filtered by the locale column
 * @psalm-method Collection&\Traversable<ChildSpyCmsPageStorage> findByLocale(string|array<string> $locale) Return ChildSpyCmsPageStorage objects filtered by the locale column
 * @method     ChildSpyCmsPageStorage[]|Collection findByAliasKeys(string|array<string> $alias_keys) Return ChildSpyCmsPageStorage objects filtered by the alias_keys column
 * @psalm-method Collection&\Traversable<ChildSpyCmsPageStorage> findByAliasKeys(string|array<string> $alias_keys) Return ChildSpyCmsPageStorage objects filtered by the alias_keys column
 * @method     ChildSpyCmsPageStorage[]|Collection findByKey(string|array<string> $key) Return ChildSpyCmsPageStorage objects filtered by the key column
 * @psalm-method Collection&\Traversable<ChildSpyCmsPageStorage> findByKey(string|array<string> $key) Return ChildSpyCmsPageStorage objects filtered by the key column
 * @method     ChildSpyCmsPageStorage[]|Collection findByCreatedAt(string|array<string> $created_at) Return ChildSpyCmsPageStorage objects filtered by the created_at column
 * @psalm-method Collection&\Traversable<ChildSpyCmsPageStorage> findByCreatedAt(string|array<string> $created_at) Return ChildSpyCmsPageStorage objects filtered by the created_at column
 * @method     ChildSpyCmsPageStorage[]|Collection findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyCmsPageStorage objects filtered by the updated_at column
 * @psalm-method Collection&\Traversable<ChildSpyCmsPageStorage> findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyCmsPageStorage objects filtered by the updated_at column
 *
...
abstract class SpyCmsPageStorageQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SpyCmsPageStorageTableMap::COL_ID_CMS_PAGE_STORAGE, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SpyCmsPageStorageTableMap::COL_ID_CMS_PAGE_STORAGE, $keys, Criteria::IN);
    ...
    {
        $this->addUsingAlias(SpyCmsPageStorageTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addDescendingOrderByColumn(SpyCmsPageStorageTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addAscendingOrderByColumn(SpyCmsPageStorageTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addDescendingOrderByColumn(SpyCmsPageStorageTableMap::COL_CREATED_AT);
    ...
    {
        $this->addUsingAlias(SpyCmsPageStorageTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addAscendingOrderByColumn(SpyCmsPageStorageTableMap::COL_CREATED_AT);
