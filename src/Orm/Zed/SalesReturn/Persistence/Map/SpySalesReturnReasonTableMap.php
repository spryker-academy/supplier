...
class SpySalesReturnReasonTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'src.Orm.Zed.SalesReturn.Persistence.Map.SpySalesReturnReasonTableMap';
     ...
     */
    public const TABLE_NAME = 'spy_sales_return_reason';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'SpySalesReturnReason';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\Orm\\Zed\\SalesReturn\\Persistence\\SpySalesReturnReason';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'src.Orm.Zed.SalesReturn.Persistence.SpySalesReturnReason';
     ...
     */
    public const COL_ID_SALES_RETURN_REASON = 'spy_sales_return_reason.id_sales_return_reason';

    /**
     * the column name for the glossary_key_reason field
     */
    public const COL_GLOSSARY_KEY_REASON = 'spy_sales_return_reason.glossary_key_reason';

    /**
     * the column name for the key field
     */
    public const COL_KEY = 'spy_sales_return_reason.key';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdSalesReturnReason', 'GlossaryKeyReason', 'Key', ],
        self::TYPE_CAMELNAME     => ['idSalesReturnReason', 'glossaryKeyReason', 'key', ],
        self::TYPE_COLNAME       => [SpySalesReturnReasonTableMap::COL_ID_SALES_RETURN_REASON, SpySalesReturnReasonTableMap::COL_GLOSSARY_KEY_REASON, SpySalesReturnReasonTableMap::COL_KEY, ],
        self::TYPE_FIELDNAME     => ['id_sales_return_reason', 'glossary_key_reason', 'key', ],
        self::TYPE_NUM           => [0, 1, 2, ]
    ];
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdSalesReturnReason' => 0, 'GlossaryKeyReason' => 1, 'Key' => 2, ],
        self::TYPE_CAMELNAME     => ['idSalesReturnReason' => 0, 'glossaryKeyReason' => 1, 'key' => 2, ],
        self::TYPE_COLNAME       => [SpySalesReturnReasonTableMap::COL_ID_SALES_RETURN_REASON => 0, SpySalesReturnReasonTableMap::COL_GLOSSARY_KEY_REASON => 1, SpySalesReturnReasonTableMap::COL_KEY => 2, ],
        self::TYPE_FIELDNAME     => ['id_sales_return_reason' => 0, 'glossary_key_reason' => 1, 'key' => 2, ],
        self::TYPE_NUM           => [0, 1, 2, ]
    ];
