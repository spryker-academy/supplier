...
class SpySalesReturnItemTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'src.Orm.Zed.SalesReturn.Persistence.Map.SpySalesReturnItemTableMap';
     ...
     */
    public const TABLE_NAME = 'spy_sales_return_item';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'SpySalesReturnItem';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\Orm\\Zed\\SalesReturn\\Persistence\\SpySalesReturnItem';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'src.Orm.Zed.SalesReturn.Persistence.SpySalesReturnItem';
     ...
     */
    public const COL_ID_SALES_RETURN_ITEM = 'spy_sales_return_item.id_sales_return_item';

    /**
     * the column name for the fk_sales_order_item field
     */
    public const COL_FK_SALES_ORDER_ITEM = 'spy_sales_return_item.fk_sales_order_item';

    /**
     * the column name for the fk_sales_return field
     */
    public const COL_FK_SALES_RETURN = 'spy_sales_return_item.fk_sales_return';

    /**
     * the column name for the reason field
     */
    public const COL_REASON = 'spy_sales_return_item.reason';

    /**
     * the column name for the uuid field
     */
    public const COL_UUID = 'spy_sales_return_item.uuid';

    /**
     * the column name for the created_at field
     */
    public const COL_CREATED_AT = 'spy_sales_return_item.created_at';

    /**
     * the column name for the updated_at field
     */
    public const COL_UPDATED_AT = 'spy_sales_return_item.updated_at';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdSalesReturnItem', 'FkSalesOrderItem', 'FkSalesReturn', 'Reason', 'Uuid', 'CreatedAt', 'UpdatedAt', ],
        self::TYPE_CAMELNAME     => ['idSalesReturnItem', 'fkSalesOrderItem', 'fkSalesReturn', 'reason', 'uuid', 'createdAt', 'updatedAt', ],
        self::TYPE_COLNAME       => [SpySalesReturnItemTableMap::COL_ID_SALES_RETURN_ITEM, SpySalesReturnItemTableMap::COL_FK_SALES_ORDER_ITEM, SpySalesReturnItemTableMap::COL_FK_SALES_RETURN, SpySalesReturnItemTableMap::COL_REASON, SpySalesReturnItemTableMap::COL_UUID, SpySalesReturnItemTableMap::COL_CREATED_AT, SpySalesReturnItemTableMap::COL_UPDATED_AT, ],
        self::TYPE_FIELDNAME     => ['id_sales_return_item', 'fk_sales_order_item', 'fk_sales_return', 'reason', 'uuid', 'created_at', 'updated_at', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdSalesReturnItem' => 0, 'FkSalesOrderItem' => 1, 'FkSalesReturn' => 2, 'Reason' => 3, 'Uuid' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ],
        self::TYPE_CAMELNAME     => ['idSalesReturnItem' => 0, 'fkSalesOrderItem' => 1, 'fkSalesReturn' => 2, 'reason' => 3, 'uuid' => 4, 'createdAt' => 5, 'updatedAt' => 6, ],
        self::TYPE_COLNAME       => [SpySalesReturnItemTableMap::COL_ID_SALES_RETURN_ITEM => 0, SpySalesReturnItemTableMap::COL_FK_SALES_ORDER_ITEM => 1, SpySalesReturnItemTableMap::COL_FK_SALES_RETURN => 2, SpySalesReturnItemTableMap::COL_REASON => 3, SpySalesReturnItemTableMap::COL_UUID => 4, SpySalesReturnItemTableMap::COL_CREATED_AT => 5, SpySalesReturnItemTableMap::COL_UPDATED_AT => 6, ],
        self::TYPE_FIELDNAME     => ['id_sales_return_item' => 0, 'fk_sales_order_item' => 1, 'fk_sales_return' => 2, 'reason' => 3, 'uuid' => 4, 'created_at' => 5, 'updated_at' => 6, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, 5, 6, ]
    ];
