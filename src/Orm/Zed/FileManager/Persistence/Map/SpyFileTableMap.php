...
class SpyFileTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'src.Orm.Zed.FileManager.Persistence.Map.SpyFileTableMap';
     ...
     */
    public const TABLE_NAME = 'spy_file';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'SpyFile';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\Orm\\Zed\\FileManager\\Persistence\\SpyFile';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'src.Orm.Zed.FileManager.Persistence.SpyFile';
     ...
     */
    public const COL_ID_FILE = 'spy_file.id_file';

    /**
     * the column name for the fk_file_directory field
     */
    public const COL_FK_FILE_DIRECTORY = 'spy_file.fk_file_directory';

    /**
     * the column name for the file_name field
     */
    public const COL_FILE_NAME = 'spy_file.file_name';

    /**
     * the column name for the file_reference field
     */
    public const COL_FILE_REFERENCE = 'spy_file.file_reference';

    /**
     * the column name for the uuid field
     */
    public const COL_UUID = 'spy_file.uuid';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdFile', 'FkFileDirectory', 'FileName', 'FileReference', 'Uuid', ],
        self::TYPE_CAMELNAME     => ['idFile', 'fkFileDirectory', 'fileName', 'fileReference', 'uuid', ],
        self::TYPE_COLNAME       => [SpyFileTableMap::COL_ID_FILE, SpyFileTableMap::COL_FK_FILE_DIRECTORY, SpyFileTableMap::COL_FILE_NAME, SpyFileTableMap::COL_FILE_REFERENCE, SpyFileTableMap::COL_UUID, ],
        self::TYPE_FIELDNAME     => ['id_file', 'fk_file_directory', 'file_name', 'file_reference', 'uuid', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdFile' => 0, 'FkFileDirectory' => 1, 'FileName' => 2, 'FileReference' => 3, 'Uuid' => 4, ],
        self::TYPE_CAMELNAME     => ['idFile' => 0, 'fkFileDirectory' => 1, 'fileName' => 2, 'fileReference' => 3, 'uuid' => 4, ],
        self::TYPE_COLNAME       => [SpyFileTableMap::COL_ID_FILE => 0, SpyFileTableMap::COL_FK_FILE_DIRECTORY => 1, SpyFileTableMap::COL_FILE_NAME => 2, SpyFileTableMap::COL_FILE_REFERENCE => 3, SpyFileTableMap::COL_UUID => 4, ],
        self::TYPE_FIELDNAME     => ['id_file' => 0, 'fk_file_directory' => 1, 'file_name' => 2, 'file_reference' => 3, 'uuid' => 4, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        ...
        'SpyFile.FileReference' => 'FILE_REFERENCE',
        'fileReference' => 'FILE_REFERENCE',
        'spyFile.fileReference' => 'FILE_REFERENCE',
        'SpyFileTableMap::COL_FILE_REFERENCE' => 'FILE_REFERENCE',
        'COL_FILE_REFERENCE' => 'FILE_REFERENCE',
        'file_reference' => 'FILE_REFERENCE',
        'spy_file.file_reference' => 'FILE_REFERENCE',
        'Uuid' => 'UUID',
        'SpyFile.Uuid' => 'UUID',
        'uuid' => 'UUID',
        'spyFile.uuid' => 'UUID',
        'SpyFileTableMap::COL_UUID' => 'UUID',
        'COL_UUID' => 'UUID',
        'spy_file.uuid' => 'UUID',
    ];
    ...
    public function initialize(): void
    {
        ...
        $this->addColumn('file_reference', 'FileReference', 'VARCHAR', false, 255, null);
  ...
  array (
    ...
    1 => ':id_file_directory',
        ...
        $this->addRelation('SpyCompanyUserFile', '\\Orm\\Zed\\SelfServicePortal\\Persistence\\SpyCompanyUserFile', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':fk_file',
    1 => ':id_file',
  ),
), 'CASCADE', null, 'SpyCompanyUserFiles', false);
...
), 'CASCADE', null, 'SpyCompanyBusinessUnitFiles', false);
...
), 'CASCADE', null, 'SpySspAssetFiles', false);
...
), 'SET NULL', null, 'SpySspAssets', false);
        $this->addRelation('SpySspModel', '\\Orm\\Zed\\SelfServicePortal\\Persistence\\SpySspModel', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':fk_image_file',
    1 => ':id_file',
  ),
), 'SET NULL', null, 'SpySspModels', false);
  ...
  array (
...
), 'CASCADE', null, 'SpySspModelToFiles', false);
    }
    ...
    {
        return [
            'uuid' => ['key_prefix' => NULL, 'key_columns' => 'id_file'],
    ...
    public static function addSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SpyFileTableMap::COL_FILE_REFERENCE);
            $criteria->addSelectColumn(SpyFileTableMap::COL_UUID);
        } else {
            ...
            $criteria->addSelectColumn($alias . '.file_reference');
    ...
    public static function removeSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn(SpyFileTableMap::COL_FILE_REFERENCE);
            $criteria->removeSelectColumn(SpyFileTableMap::COL_UUID);
        } else {
            ...
            $criteria->removeSelectColumn($alias . '.file_reference');
