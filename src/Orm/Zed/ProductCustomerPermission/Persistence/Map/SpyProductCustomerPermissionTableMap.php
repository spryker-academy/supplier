...
class SpyProductCustomerPermissionTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'src.Orm.Zed.ProductCustomerPermission.Persistence.Map.SpyProductCustomerPermissionTableMap';
     ...
     */
    public const TABLE_NAME = 'spy_product_customer_permission';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'SpyProductCustomerPermission';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\Orm\\Zed\\ProductCustomerPermission\\Persistence\\SpyProductCustomerPermission';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'src.Orm.Zed.ProductCustomerPermission.Persistence.SpyProductCustomerPermission';
     ...
     */
    public const COL_ID_PRODUCT_CUSTOMER_PERMISSION = 'spy_product_customer_permission.id_product_customer_permission';

    /**
     * the column name for the fk_customer field
     */
    public const COL_FK_CUSTOMER = 'spy_product_customer_permission.fk_customer';

    /**
     * the column name for the fk_product_abstract field
     */
    public const COL_FK_PRODUCT_ABSTRACT = 'spy_product_customer_permission.fk_product_abstract';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdProductCustomerPermission', 'FkCustomer', 'FkProductAbstract', ],
        self::TYPE_CAMELNAME     => ['idProductCustomerPermission', 'fkCustomer', 'fkProductAbstract', ],
        self::TYPE_COLNAME       => [SpyProductCustomerPermissionTableMap::COL_ID_PRODUCT_CUSTOMER_PERMISSION, SpyProductCustomerPermissionTableMap::COL_FK_CUSTOMER, SpyProductCustomerPermissionTableMap::COL_FK_PRODUCT_ABSTRACT, ],
        self::TYPE_FIELDNAME     => ['id_product_customer_permission', 'fk_customer', 'fk_product_abstract', ],
        self::TYPE_NUM           => [0, 1, 2, ]
    ];
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdProductCustomerPermission' => 0, 'FkCustomer' => 1, 'FkProductAbstract' => 2, ],
        self::TYPE_CAMELNAME     => ['idProductCustomerPermission' => 0, 'fkCustomer' => 1, 'fkProductAbstract' => 2, ],
        self::TYPE_COLNAME       => [SpyProductCustomerPermissionTableMap::COL_ID_PRODUCT_CUSTOMER_PERMISSION => 0, SpyProductCustomerPermissionTableMap::COL_FK_CUSTOMER => 1, SpyProductCustomerPermissionTableMap::COL_FK_PRODUCT_ABSTRACT => 2, ],
        self::TYPE_FIELDNAME     => ['id_product_customer_permission' => 0, 'fk_customer' => 1, 'fk_product_abstract' => 2, ],
        self::TYPE_NUM           => [0, 1, 2, ]
    ];
