...
class SpySalesReclamationItemTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'src.Orm.Zed.SalesReclamation.Persistence.Map.SpySalesReclamationItemTableMap';
     ...
     */
    public const TABLE_NAME = 'spy_sales_reclamation_item';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'SpySalesReclamationItem';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\Orm\\Zed\\SalesReclamation\\Persistence\\SpySalesReclamationItem';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'src.Orm.Zed.SalesReclamation.Persistence.SpySalesReclamationItem';
     ...
     */
    public const COL_ID_SALES_RECLAMATION_ITEM = 'spy_sales_reclamation_item.id_sales_reclamation_item';

    /**
     * the column name for the fk_sales_order_item field
     */
    public const COL_FK_SALES_ORDER_ITEM = 'spy_sales_reclamation_item.fk_sales_order_item';

    /**
     * the column name for the fk_sales_reclamation field
     */
    public const COL_FK_SALES_RECLAMATION = 'spy_sales_reclamation_item.fk_sales_reclamation';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdSalesReclamationItem', 'FkSalesOrderItem', 'FkSalesReclamation', ],
        self::TYPE_CAMELNAME     => ['idSalesReclamationItem', 'fkSalesOrderItem', 'fkSalesReclamation', ],
        self::TYPE_COLNAME       => [SpySalesReclamationItemTableMap::COL_ID_SALES_RECLAMATION_ITEM, SpySalesReclamationItemTableMap::COL_FK_SALES_ORDER_ITEM, SpySalesReclamationItemTableMap::COL_FK_SALES_RECLAMATION, ],
        self::TYPE_FIELDNAME     => ['id_sales_reclamation_item', 'fk_sales_order_item', 'fk_sales_reclamation', ],
        self::TYPE_NUM           => [0, 1, 2, ]
    ];
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdSalesReclamationItem' => 0, 'FkSalesOrderItem' => 1, 'FkSalesReclamation' => 2, ],
        self::TYPE_CAMELNAME     => ['idSalesReclamationItem' => 0, 'fkSalesOrderItem' => 1, 'fkSalesReclamation' => 2, ],
        self::TYPE_COLNAME       => [SpySalesReclamationItemTableMap::COL_ID_SALES_RECLAMATION_ITEM => 0, SpySalesReclamationItemTableMap::COL_FK_SALES_ORDER_ITEM => 1, SpySalesReclamationItemTableMap::COL_FK_SALES_RECLAMATION => 2, ],
        self::TYPE_FIELDNAME     => ['id_sales_reclamation_item' => 0, 'fk_sales_order_item' => 1, 'fk_sales_reclamation' => 2, ],
        self::TYPE_NUM           => [0, 1, 2, ]
    ];
