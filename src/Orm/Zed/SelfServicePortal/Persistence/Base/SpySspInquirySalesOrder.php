...
/**
 * Base class that represents a row from the 'spy_ssp_inquiry_sales_order' table.
 *
 *
 *
 * @package    propel.generator.src.Orm.Zed.SelfServicePortal.Persistence.Base
 */
abstract class SpySspInquirySalesOrder implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\Orm\\Zed\\SelfServicePortal\\Persistence\\Map\\SpySspInquirySalesOrderTableMap';
    ...
    /**
     * The value for the id_ssp_inquiry_sales_order field.
     *
     * @var        int
     */
    protected $id_ssp_inquiry_sales_order;
    ...
    /**
     * @var        ObjectCollection|ChildSpySspInquirySalesOrderItem[] Collection to store aggregation of ChildSpySspInquirySalesOrderItem objects.
     * @phpstan-var ObjectCollection&\Traversable<ChildSpySspInquirySalesOrderItem> Collection to store aggregation of ChildSpySspInquirySalesOrderItem objects.
     */
     ...
     * @var ObjectCollection|ChildSpySspInquirySalesOrderItem[]
     * @phpstan-var ObjectCollection&\Traversable<ChildSpySspInquirySalesOrderItem>
     */
    protected $spySspInquirySalesOrderItemsScheduledForDeletion = null;

    /**
     * Initializes internal state of Orm\Zed\SelfServicePortal\Persistence\Base\SpySspInquirySalesOrder object.
     */
    ...
    /**
     * Compares this with another <code>SpySspInquirySalesOrder</code> instance.  If
     * <code>obj</code> is an instance of <code>SpySspInquirySalesOrder</code>, delegates to
     * <code>equals(SpySspInquirySalesOrder)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    /**
     * Get the [id_ssp_inquiry_sales_order] column value.
     *
     * @return int
     */
    public function getIdSspInquirySalesOrder()
    {
        return $this->id_ssp_inquiry_sales_order;
    }
    ...
    /**
     * Set the value of [id_ssp_inquiry_sales_order] column.
     *
     * @param int $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setIdSspInquirySalesOrder($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->id_ssp_inquiry_sales_order !== $v) {
            $this->id_ssp_inquiry_sales_order = $v;
            $this->modifiedColumns[SpySspInquirySalesOrderTableMap::COL_ID_SSP_INQUIRY_SALES_ORDER] = true;
        }
    ...
    public function setFkSspInquiry($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->fk_ssp_inquiry !== $v) {
            ...
            $this->modifiedColumns[SpySspInquirySalesOrderTableMap::COL_FK_SSP_INQUIRY] = true;
        }
    ...
    public function setFkSalesOrder($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->fk_sales_order !== $v) {
            ...
            $this->modifiedColumns[SpySspInquirySalesOrderTableMap::COL_FK_SALES_ORDER] = true;
        }
    ...
    public function setUuid($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->uuid !== $v) {
            $this->uuid = $v;
            $this->modifiedColumns[SpySspInquirySalesOrderTableMap::COL_UUID] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[SpySspInquirySalesOrderTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[SpySspInquirySalesOrderTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SpySspInquirySalesOrderTableMap::translateFieldName('IdSspInquirySalesOrder', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_ssp_inquiry_sales_order = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SpySspInquirySalesOrderTableMap::translateFieldName('FkSspInquiry', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fk_ssp_inquiry = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SpySspInquirySalesOrderTableMap::translateFieldName('FkSalesOrder', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fk_sales_order = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SpySspInquirySalesOrderTableMap::translateFieldName('Uuid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uuid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SpySspInquirySalesOrderTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : SpySspInquirySalesOrderTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 6; // 6 = SpySspInquirySalesOrderTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Orm\\Zed\\SelfServicePortal\\Persistence\\SpySspInquirySalesOrder'), 0, $e);
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        if ($con === null) {
            $con = Propel::getServiceContainer()->getReadConnection(SpySspInquirySalesOrderTableMap::DATABASE_NAME);
        }

        // We don't need to alter the object instance pool; we're just modifying this instance
        // already in the pool.

        $dataFetcher = ChildSpySspInquirySalesOrderQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws \Propel\Runtime\Exception\PropelException
     * @see SpySspInquirySalesOrder::setDeleted()
     * @see SpySspInquirySalesOrder::isDeleted()
     */
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildSpySspInquirySalesOrderQuery::create()
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(SpySspInquirySalesOrderTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt($highPrecision);
                }
                if (!$this->isColumnModified(SpySspInquirySalesOrderTableMap::COL_UPDATED_AT)) {
                ...
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(SpySspInquirySalesOrderTableMap::COL_UPDATED_AT)) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SpySspInquirySalesOrderTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(SpySspInquirySalesOrderTableMap::COL_ID_SSP_INQUIRY_SALES_ORDER)) {
            $modifiedColumns[':p' . $index++]  = 'id_ssp_inquiry_sales_order';
        }
        if ($this->isColumnModified(SpySspInquirySalesOrderTableMap::COL_FK_SSP_INQUIRY)) {
            $modifiedColumns[':p' . $index++]  = 'fk_ssp_inquiry';
        }
        if ($this->isColumnModified(SpySspInquirySalesOrderTableMap::COL_FK_SALES_ORDER)) {
            $modifiedColumns[':p' . $index++]  = 'fk_sales_order';
        }
        if ($this->isColumnModified(SpySspInquirySalesOrderTableMap::COL_UUID)) {
        ...
        $sql = sprintf(
            'INSERT INTO spy_ssp_inquiry_sales_order (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id_ssp_inquiry_sales_order':
                        $stmt->bindValue($identifier, $this->id_ssp_inquiry_sales_order, PDO::PARAM_INT);
        ...
        try {
            $pk = $con->lastInsertId('id_ssp_inquiry_sales_order_pk_seq');
        } catch (Exception $e) {
            throw new PropelException('Unable to get autoincrement id.', 0, $e);
        }
        if ($pk !== null) {
            $this->setIdSspInquirySalesOrder($pk);
        }
    ...
    {
        $pos = SpySspInquirySalesOrderTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function getByPosition(int $pos)
    {
        switch ($pos) {
            case 0:
                return $this->getIdSspInquirySalesOrder();
    ...
    {
        if (isset($alreadyDumpedObjects['SpySspInquirySalesOrder'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['SpySspInquirySalesOrder'][$this->hashCode()] = true;
        $keys = SpySspInquirySalesOrderTableMap::getFieldNames($keyType);
        $result = [
            $keys[0] => $this->getIdSspInquirySalesOrder(),
    ...
    public function setByPosition(int $pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setIdSspInquirySalesOrder($value);
                break;
            case 1:
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setIdSspInquirySalesOrder($arr[$keys[0]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(SpySspInquirySalesOrderTableMap::COL_ID_SSP_INQUIRY_SALES_ORDER)) {
            $criteria->add(SpySspInquirySalesOrderTableMap::COL_ID_SSP_INQUIRY_SALES_ORDER, $this->id_ssp_inquiry_sales_order);
        }
        if ($this->isColumnModified(SpySspInquirySalesOrderTableMap::COL_FK_SSP_INQUIRY)) {
            $criteria->add(SpySspInquirySalesOrderTableMap::COL_FK_SSP_INQUIRY, $this->fk_ssp_inquiry);
        }
        if ($this->isColumnModified(SpySspInquirySalesOrderTableMap::COL_FK_SALES_ORDER)) {
            $criteria->add(SpySspInquirySalesOrderTableMap::COL_FK_SALES_ORDER, $this->fk_sales_order);
        }
        if ($this->isColumnModified(SpySspInquirySalesOrderTableMap::COL_UUID)) {
            $criteria->add(SpySspInquirySalesOrderTableMap::COL_UUID, $this->uuid);
        }
        if ($this->isColumnModified(SpySspInquirySalesOrderTableMap::COL_CREATED_AT)) {
            $criteria->add(SpySspInquirySalesOrderTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(SpySspInquirySalesOrderTableMap::COL_UPDATED_AT)) {
            $criteria->add(SpySspInquirySalesOrderTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    {
        $criteria = ChildSpySspInquirySalesOrderQuery::create();
        $criteria->add(SpySspInquirySalesOrderTableMap::COL_ID_SSP_INQUIRY_SALES_ORDER, $this->id_ssp_inquiry_sales_order);
    ...
    {
        $validPk = null !== $this->getIdSspInquirySalesOrder();
    ...
    /**
     * Generic method to set the primary key (id_ssp_inquiry_sales_order column).
     *
    ...
    {
        $this->setIdSspInquirySalesOrder($key);
    }
    ...
    {
        return null === $this->getIdSspInquirySalesOrder();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of \Orm\Zed\SelfServicePortal\Persistence\SpySspInquirySalesOrder (or compatible) type.
    ...
    public function copyInto(object $copyObj, bool $deepCopy = false, bool $makeNew = true): void
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdSspInquirySalesOrder(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Orm\Zed\SelfServicePortal\Persistence\SpySspInquirySalesOrder Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    public function setSpySspInquiry(ChildSpySspInquiry $v = null)
    {
        ...
        if ($v !== null) {
            $v->addSpySspInquirySalesOrder($this);
        }
    ...
    public function getSpySspInquiry(?ConnectionInterface $con = null)
    {
        if ($this->aSpySspInquiry === null && ($this->fk_ssp_inquiry != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aSpySspInquiry->addSpySspInquirySalesOrders($this);
             */
        }
    ...
    public function getSpySalesOrder(?ConnectionInterface $con = null)
    {
        if ($this->aSpySalesOrder === null && ($this->fk_sales_order != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSpySalesOrder->addSpySspInquirySalesOrders($this);
             */
        }
    ...
    /**
     * Gets an array of ChildSpySspInquirySalesOrderItem objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     * If this ChildSpySspInquirySalesOrder is new, it will return
     * an empty collection or the current collection; the criteria is ignored on a new object.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param ConnectionInterface $con optional connection object
     * @return ObjectCollection|ChildSpySspInquirySalesOrderItem[] List of ChildSpySspInquirySalesOrderItem objects
     * @phpstan-return ObjectCollection&\Traversable<ChildSpySspInquirySalesOrderItem> List of ChildSpySspInquirySalesOrderItem objects
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function getSpySspInquirySalesOrderItems(?Criteria $criteria = null, ?ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collSpySspInquirySalesOrderItems || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                $collSpySspInquirySalesOrderItems = ChildSpySspInquirySalesOrderItemQuery::create(null, $criteria)
                    ->filterBySpySspInquirySalesOrder($this)
                    ->find($con);
    ...
    /**
     * Sets a collection of ChildSpySspInquirySalesOrderItem objects related by a one-to-many relationship
    ...
    {
        /** @var ChildSpySspInquirySalesOrderItem[] $spySspInquirySalesOrderItemsToDelete */
        ...
        foreach ($spySspInquirySalesOrderItemsToDelete as $spySspInquirySalesOrderItemRemoved) {
            $spySspInquirySalesOrderItemRemoved->setSpySspInquirySalesOrder(null);
        }
    ...
    /**
     * Returns the number of related SpySspInquirySalesOrderItem objects.
     *
     * @param Criteria $criteria
     * @param bool $distinct
     * @param ConnectionInterface $con
     * @return int Count of related SpySspInquirySalesOrderItem objects.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function countSpySspInquirySalesOrderItems(?Criteria $criteria = null, bool $distinct = false, ?ConnectionInterface $con = null): int
    {
        ...
        if (null === $this->collSpySspInquirySalesOrderItems || null !== $criteria || $partial) {
            ...
            $query = ChildSpySspInquirySalesOrderItemQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
    ...
    /**
     * Method called to associate a ChildSpySspInquirySalesOrderItem object to this object
     * through the ChildSpySspInquirySalesOrderItem foreign key attribute.
     *
     * @param ChildSpySspInquirySalesOrderItem $l ChildSpySspInquirySalesOrderItem
     * @return $this The current object (for fluent API support)
     */
    public function addSpySspInquirySalesOrderItem(ChildSpySspInquirySalesOrderItem $l)
    {
        if ($this->collSpySspInquirySalesOrderItems === null) {
            $this->initSpySspInquirySalesOrderItems();
            $this->collSpySspInquirySalesOrderItemsPartial = true;
    ...
    /**
     * @param ChildSpySspInquirySalesOrderItem $spySspInquirySalesOrderItem The ChildSpySspInquirySalesOrderItem object to add.
     */
    protected function doAddSpySspInquirySalesOrderItem(ChildSpySspInquirySalesOrderItem $spySspInquirySalesOrderItem): void
    {
        $this->collSpySspInquirySalesOrderItems[]= $spySspInquirySalesOrderItem;
        $spySspInquirySalesOrderItem->setSpySspInquirySalesOrder($this);
    }

    /**
     * @param ChildSpySspInquirySalesOrderItem $spySspInquirySalesOrderItem The ChildSpySspInquirySalesOrderItem object to remove.
     * @return $this The current object (for fluent API support)
     */
    public function removeSpySspInquirySalesOrderItem(ChildSpySspInquirySalesOrderItem $spySspInquirySalesOrderItem)
    {
        if ($this->getSpySspInquirySalesOrderItems()->contains($spySspInquirySalesOrderItem)) {
            ...
            $spySspInquirySalesOrderItem->setSpySspInquirySalesOrder(null);
        }
     ...
     * Otherwise if this SpySspInquirySalesOrder is new, it will return
     * an empty collection; or if this SpySspInquirySalesOrder has previously
     * been saved, it will retrieve related SpySspInquirySalesOrderItems from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in SpySspInquirySalesOrder.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param ConnectionInterface $con optional connection object
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildSpySspInquirySalesOrderItem}> List of ChildSpySspInquirySalesOrderItem objects
     */
    public function getSpySspInquirySalesOrderItemsJoinSpySalesOrderItem(?Criteria $criteria = null, ?ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildSpySspInquirySalesOrderItemQuery::create(null, $criteria);
    ...
    {
        if (null !== $this->aSpySspInquiry) {
            $this->aSpySspInquiry->removeSpySspInquirySalesOrder($this);
        }
        if (null !== $this->aSpySalesOrder) {
            $this->aSpySalesOrder->removeSpySspInquirySalesOrder($this);
        }
        $this->id_ssp_inquiry_sales_order = null;
    ...
    {
        return (string) $this->exportTo(SpySspInquirySalesOrderTableMap::DEFAULT_STRING_FORMAT);
    }
    ...
    protected function setGeneratedUuid()
    {
        ...
        $name = 'spy_ssp_inquiry_sales_order' . '.' . $this->getIdSspInquirySalesOrder();
