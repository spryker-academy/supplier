...
class SpyCmsSlotTemplateTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'src.Orm.Zed.CmsSlot.Persistence.Map.SpyCmsSlotTemplateTableMap';
     ...
     */
    public const TABLE_NAME = 'spy_cms_slot_template';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'SpyCmsSlotTemplate';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\Orm\\Zed\\CmsSlot\\Persistence\\SpyCmsSlotTemplate';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'src.Orm.Zed.CmsSlot.Persistence.SpyCmsSlotTemplate';
     ...
     */
    public const COL_ID_CMS_SLOT_TEMPLATE = 'spy_cms_slot_template.id_cms_slot_template';

    /**
     * the column name for the description field
     */
    public const COL_DESCRIPTION = 'spy_cms_slot_template.description';

    /**
     * the column name for the name field
     */
    public const COL_NAME = 'spy_cms_slot_template.name';

    /**
     * the column name for the path field
     */
    public const COL_PATH = 'spy_cms_slot_template.path';

    /**
     * the column name for the path_hash field
     */
    public const COL_PATH_HASH = 'spy_cms_slot_template.path_hash';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdCmsSlotTemplate', 'Description', 'Name', 'Path', 'PathHash', ],
        self::TYPE_CAMELNAME     => ['idCmsSlotTemplate', 'description', 'name', 'path', 'pathHash', ],
        self::TYPE_COLNAME       => [SpyCmsSlotTemplateTableMap::COL_ID_CMS_SLOT_TEMPLATE, SpyCmsSlotTemplateTableMap::COL_DESCRIPTION, SpyCmsSlotTemplateTableMap::COL_NAME, SpyCmsSlotTemplateTableMap::COL_PATH, SpyCmsSlotTemplateTableMap::COL_PATH_HASH, ],
        self::TYPE_FIELDNAME     => ['id_cms_slot_template', 'description', 'name', 'path', 'path_hash', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdCmsSlotTemplate' => 0, 'Description' => 1, 'Name' => 2, 'Path' => 3, 'PathHash' => 4, ],
        self::TYPE_CAMELNAME     => ['idCmsSlotTemplate' => 0, 'description' => 1, 'name' => 2, 'path' => 3, 'pathHash' => 4, ],
        self::TYPE_COLNAME       => [SpyCmsSlotTemplateTableMap::COL_ID_CMS_SLOT_TEMPLATE => 0, SpyCmsSlotTemplateTableMap::COL_DESCRIPTION => 1, SpyCmsSlotTemplateTableMap::COL_NAME => 2, SpyCmsSlotTemplateTableMap::COL_PATH => 3, SpyCmsSlotTemplateTableMap::COL_PATH_HASH => 4, ],
        self::TYPE_FIELDNAME     => ['id_cms_slot_template' => 0, 'description' => 1, 'name' => 2, 'path' => 3, 'path_hash' => 4, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, ]
    ];
