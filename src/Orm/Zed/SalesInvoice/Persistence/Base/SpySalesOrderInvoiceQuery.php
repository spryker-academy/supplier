 ...
 *
 * @method     ChildSpySalesOrderInvoice[]|Collection find(?ConnectionInterface $con = null) Return ChildSpySalesOrderInvoice objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpySalesOrderInvoice> find(?ConnectionInterface $con = null) Return ChildSpySalesOrderInvoice objects based on current ModelCriteria
 *
 * @method     ChildSpySalesOrderInvoice[]|Collection findByIdSalesOrderInvoice(int|array<int> $id_sales_order_invoice) Return ChildSpySalesOrderInvoice objects filtered by the id_sales_order_invoice column
 * @psalm-method Collection&\Traversable<ChildSpySalesOrderInvoice> findByIdSalesOrderInvoice(int|array<int> $id_sales_order_invoice) Return ChildSpySalesOrderInvoice objects filtered by the id_sales_order_invoice column
 * @method     ChildSpySalesOrderInvoice[]|Collection findByFkSalesOrder(int|array<int> $fk_sales_order) Return ChildSpySalesOrderInvoice objects filtered by the fk_sales_order column
 * @psalm-method Collection&\Traversable<ChildSpySalesOrderInvoice> findByFkSalesOrder(int|array<int> $fk_sales_order) Return ChildSpySalesOrderInvoice objects filtered by the fk_sales_order column
 * @method     ChildSpySalesOrderInvoice[]|Collection findByReference(string|array<string> $reference) Return ChildSpySalesOrderInvoice objects filtered by the reference column
 * @psalm-method Collection&\Traversable<ChildSpySalesOrderInvoice> findByReference(string|array<string> $reference) Return ChildSpySalesOrderInvoice objects filtered by the reference column
 * @method     ChildSpySalesOrderInvoice[]|Collection findByIssueDate(string|array<string> $issue_date) Return ChildSpySalesOrderInvoice objects filtered by the issue_date column
 * @psalm-method Collection&\Traversable<ChildSpySalesOrderInvoice> findByIssueDate(string|array<string> $issue_date) Return ChildSpySalesOrderInvoice objects filtered by the issue_date column
 * @method     ChildSpySalesOrderInvoice[]|Collection findByTemplatePath(string|array<string> $template_path) Return ChildSpySalesOrderInvoice objects filtered by the template_path column
 * @psalm-method Collection&\Traversable<ChildSpySalesOrderInvoice> findByTemplatePath(string|array<string> $template_path) Return ChildSpySalesOrderInvoice objects filtered by the template_path column
 * @method     ChildSpySalesOrderInvoice[]|Collection findByEmailSent(boolean|array<boolean> $email_sent) Return ChildSpySalesOrderInvoice objects filtered by the email_sent column
 * @psalm-method Collection&\Traversable<ChildSpySalesOrderInvoice> findByEmailSent(boolean|array<boolean> $email_sent) Return ChildSpySalesOrderInvoice objects filtered by the email_sent column
 * @method     ChildSpySalesOrderInvoice[]|Collection findByCreatedAt(string|array<string> $created_at) Return ChildSpySalesOrderInvoice objects filtered by the created_at column
 * @psalm-method Collection&\Traversable<ChildSpySalesOrderInvoice> findByCreatedAt(string|array<string> $created_at) Return ChildSpySalesOrderInvoice objects filtered by the created_at column
 * @method     ChildSpySalesOrderInvoice[]|Collection findByUpdatedAt(string|array<string> $updated_at) Return ChildSpySalesOrderInvoice objects filtered by the updated_at column
 * @psalm-method Collection&\Traversable<ChildSpySalesOrderInvoice> findByUpdatedAt(string|array<string> $updated_at) Return ChildSpySalesOrderInvoice objects filtered by the updated_at column
 *
...
abstract class SpySalesOrderInvoiceQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SpySalesOrderInvoiceTableMap::COL_ID_SALES_ORDER_INVOICE, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SpySalesOrderInvoiceTableMap::COL_ID_SALES_ORDER_INVOICE, $keys, Criteria::IN);
    ...
    {
        $this->addUsingAlias(SpySalesOrderInvoiceTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addDescendingOrderByColumn(SpySalesOrderInvoiceTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addAscendingOrderByColumn(SpySalesOrderInvoiceTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addDescendingOrderByColumn(SpySalesOrderInvoiceTableMap::COL_CREATED_AT);
    ...
    {
        $this->addUsingAlias(SpySalesOrderInvoiceTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addAscendingOrderByColumn(SpySalesOrderInvoiceTableMap::COL_CREATED_AT);
