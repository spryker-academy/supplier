...
abstract class SpyOauthClient implements ActiveRecordInterface
{
     ...
     * A flag indicating if an OAuth client is confidential.
     * @var        boolean|null
     */
     ...
     * The URI to which the user is redirected after an OAuth authorization flow.
     * @var        string|null
     */
     ...
     * The secret key for an OAuth client, used for authenticating the client itself.
     * @var        string|null
     */
    protected $secret;
