...
abstract class SpyNavigationNodeLocalizedAttributes implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Orm\\Zed\\Navigation\\Persistence\\Map\\SpyNavigationNodeLocalizedAttributesTableMap';
     ...
     * A CSS class to be applied to an HTML element.
     * @var        string|null
     */
    protected $css_class;
     ...
     * The direct URL associated with a navigation node.
     * @var        string|null
     */
    protected $link;
