...
abstract class SpyNavigation implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Orm\\Zed\\Navigation\\Persistence\\Map\\SpyNavigationTableMap';
     ...
     * @return void
     */
    public function resetPartialSpyNavigationNodes($v = true): void
    {
     ...
     * @return void
     */
    public function initSpyNavigationNodes(bool $overrideExisting = true): void
    {
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function countSpyNavigationNodes(?Criteria $criteria = null, bool $distinct = false, ?ConnectionInterface $con = null): int
    {
        $partial = $this->collSpyNavigationNodesPartial && !$this->isNew();
        if (null === $this->collSpyNavigationNodes || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpyNavigationNode(ChildSpyNavigationNode $spyNavigationNode): void
    {
