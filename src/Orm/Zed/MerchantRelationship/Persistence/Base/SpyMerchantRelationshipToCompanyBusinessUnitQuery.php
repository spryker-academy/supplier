 ...
 *
 * @method     ChildSpyMerchantRelationshipToCompanyBusinessUnit[]|Collection find(?ConnectionInterface $con = null) Return ChildSpyMerchantRelationshipToCompanyBusinessUnit objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpyMerchantRelationshipToCompanyBusinessUnit> find(?ConnectionInterface $con = null) Return ChildSpyMerchantRelationshipToCompanyBusinessUnit objects based on current ModelCriteria
 *
 * @method     ChildSpyMerchantRelationshipToCompanyBusinessUnit[]|Collection findByIdMerchantRelationshipToCompanyBusinessUnit(int|array<int> $id_merchant_relationship_to_company_business_unit) Return ChildSpyMerchantRelationshipToCompanyBusinessUnit objects filtered by the id_merchant_relationship_to_company_business_unit column
 * @psalm-method Collection&\Traversable<ChildSpyMerchantRelationshipToCompanyBusinessUnit> findByIdMerchantRelationshipToCompanyBusinessUnit(int|array<int> $id_merchant_relationship_to_company_business_unit) Return ChildSpyMerchantRelationshipToCompanyBusinessUnit objects filtered by the id_merchant_relationship_to_company_business_unit column
 * @method     ChildSpyMerchantRelationshipToCompanyBusinessUnit[]|Collection findByFkCompanyBusinessUnit(int|array<int> $fk_company_business_unit) Return ChildSpyMerchantRelationshipToCompanyBusinessUnit objects filtered by the fk_company_business_unit column
 * @psalm-method Collection&\Traversable<ChildSpyMerchantRelationshipToCompanyBusinessUnit> findByFkCompanyBusinessUnit(int|array<int> $fk_company_business_unit) Return ChildSpyMerchantRelationshipToCompanyBusinessUnit objects filtered by the fk_company_business_unit column
 * @method     ChildSpyMerchantRelationshipToCompanyBusinessUnit[]|Collection findByFkMerchantRelationship(int|array<int> $fk_merchant_relationship) Return ChildSpyMerchantRelationshipToCompanyBusinessUnit objects filtered by the fk_merchant_relationship column
 * @psalm-method Collection&\Traversable<ChildSpyMerchantRelationshipToCompanyBusinessUnit> findByFkMerchantRelationship(int|array<int> $fk_merchant_relationship) Return ChildSpyMerchantRelationshipToCompanyBusinessUnit objects filtered by the fk_merchant_relationship column
 *
...
abstract class SpyMerchantRelationshipToCompanyBusinessUnitQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SpyMerchantRelationshipToCompanyBusinessUnitTableMap::COL_ID_MERCHANT_RELATIONSHIP_TO_COMPANY_BUSINESS_UNIT, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SpyMerchantRelationshipToCompanyBusinessUnitTableMap::COL_ID_MERCHANT_RELATIONSHIP_TO_COMPANY_BUSINESS_UNIT, $keys, Criteria::IN);
