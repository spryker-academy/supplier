...
abstract class SpyMerchantRelationship implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Orm\\Zed\\MerchantRelationship\\Persistence\\Map\\SpyMerchantRelationshipTableMap';
    ...
    /**
     * The value for the merchant_relation_request_uuid field.
     * The UUID of the original request that created the merchant relationship.
     * @var        string|null
     */
    protected $merchant_relation_request_uuid;
    ...
    /**
     * Get the [merchant_relation_request_uuid] column value.
     * The UUID of the original request that created the merchant relationship.
     * @return string|null
     */
    public function getMerchantRelationRequestUuid()
    {
        return $this->merchant_relation_request_uuid;
    }
    ...
    /**
     * Set the value of [merchant_relation_request_uuid] column.
     * The UUID of the original request that created the merchant relationship.
     * @param string|null $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setMerchantRelationRequestUuid($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->merchant_relation_request_uuid !== $v) {
            $this->merchant_relation_request_uuid = $v;
            $this->modifiedColumns[SpyMerchantRelationshipTableMap::COL_MERCHANT_RELATION_REQUEST_UUID] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SpyMerchantRelationshipTableMap::translateFieldName('MerchantRelationRequestUuid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->merchant_relation_request_uuid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SpyMerchantRelationshipTableMap::translateFieldName('MerchantRelationshipKey', TableMap::TYPE_PHPNAME, $indexType)];
            $this->merchant_relationship_key = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : SpyMerchantRelationshipTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : SpyMerchantRelationshipTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 7; // 7 = SpyMerchantRelationshipTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(SpyMerchantRelationshipTableMap::COL_MERCHANT_RELATION_REQUEST_UUID)) {
            $modifiedColumns[':p' . $index++]  = 'merchant_relation_request_uuid';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'fk_merchant':
                        ...
                        break;
                    case 'merchant_relation_request_uuid':
                        $stmt->bindValue($identifier, $this->merchant_relation_request_uuid, PDO::PARAM_STR);
    ...
    public function getByPosition(int $pos)
    {
        switch ($pos) {
            ...
            case 3:
                return $this->getMerchantRelationRequestUuid();
    ...
    public function toArray(string $keyType = TableMap::TYPE_FIELDNAME, bool $includeLazyLoadColumns = true, array $alreadyDumpedObjects = [], bool $includeForeignObjects = false): array
    {
        ...
        $result = [
            ...
            $keys[3] => $this->getMerchantRelationRequestUuid(),
            $keys[4] => $this->getMerchantRelationshipKey(),
    ...
    public function setByPosition(int $pos, $value)
    {
        switch ($pos) {
            ...
            case 2:
                ...
                break;
            case 3:
                $this->setMerchantRelationRequestUuid($value);
                break;
            case 4:
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) {
            $this->setMerchantRelationRequestUuid($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setMerchantRelationshipKey($arr[$keys[4]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(SpyMerchantRelationshipTableMap::COL_MERCHANT_RELATION_REQUEST_UUID)) {
            $criteria->add(SpyMerchantRelationshipTableMap::COL_MERCHANT_RELATION_REQUEST_UUID, $this->merchant_relation_request_uuid);
        }
        if ($this->isColumnModified(SpyMerchantRelationshipTableMap::COL_MERCHANT_RELATIONSHIP_KEY)) {
    ...
    public function copyInto(object $copyObj, bool $deepCopy = false, bool $makeNew = true): void
    {
        ...
        $copyObj->setMerchantRelationRequestUuid($this->getMerchantRelationRequestUuid());
     ...
     */
    protected function doAddSpyMerchantRelationshipToCompanyBusinessUnit(ChildSpyMerchantRelationshipToCompanyBusinessUnit $spyMerchantRelationshipToCompanyBusinessUnit): void
    {
     ...
     * @return void
     */
    public function resetPartialSpyProductLists($v = true): void
    {
     ...
     * @return void
     */
    public function initSpyProductLists(bool $overrideExisting = true): void
    {
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function countSpyProductLists(?Criteria $criteria = null, bool $distinct = false, ?ConnectionInterface $con = null): int
    {
        $partial = $this->collSpyProductListsPartial && !$this->isNew();
        if (null === $this->collSpyProductLists || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpyProductList(SpyProductList $spyProductList): void
    {
    ...
    public function clear()
    {
        ...
        $this->merchant_relation_request_uuid = null;
