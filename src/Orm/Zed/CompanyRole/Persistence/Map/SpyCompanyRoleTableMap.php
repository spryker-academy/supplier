...
class SpyCompanyRoleTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'src.Orm.Zed.CompanyRole.Persistence.Map.SpyCompanyRoleTableMap';
     ...
     */
    public const TABLE_NAME = 'spy_company_role';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'SpyCompanyRole';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\Orm\\Zed\\CompanyRole\\Persistence\\SpyCompanyRole';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'src.Orm.Zed.CompanyRole.Persistence.SpyCompanyRole';
     ...
     */
    public const COL_ID_COMPANY_ROLE = 'spy_company_role.id_company_role';

    /**
     * the column name for the fk_company field
     */
    public const COL_FK_COMPANY = 'spy_company_role.fk_company';

    /**
     * the column name for the is_default field
     */
    public const COL_IS_DEFAULT = 'spy_company_role.is_default';

    /**
     * the column name for the key field
     */
    public const COL_KEY = 'spy_company_role.key';

    /**
     * the column name for the name field
     */
    public const COL_NAME = 'spy_company_role.name';

    /**
     * the column name for the uuid field
     */
    public const COL_UUID = 'spy_company_role.uuid';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdCompanyRole', 'FkCompany', 'IsDefault', 'Key', 'Name', 'Uuid', ],
        self::TYPE_CAMELNAME     => ['idCompanyRole', 'fkCompany', 'isDefault', 'key', 'name', 'uuid', ],
        self::TYPE_COLNAME       => [SpyCompanyRoleTableMap::COL_ID_COMPANY_ROLE, SpyCompanyRoleTableMap::COL_FK_COMPANY, SpyCompanyRoleTableMap::COL_IS_DEFAULT, SpyCompanyRoleTableMap::COL_KEY, SpyCompanyRoleTableMap::COL_NAME, SpyCompanyRoleTableMap::COL_UUID, ],
        self::TYPE_FIELDNAME     => ['id_company_role', 'fk_company', 'is_default', 'key', 'name', 'uuid', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdCompanyRole' => 0, 'FkCompany' => 1, 'IsDefault' => 2, 'Key' => 3, 'Name' => 4, 'Uuid' => 5, ],
        self::TYPE_CAMELNAME     => ['idCompanyRole' => 0, 'fkCompany' => 1, 'isDefault' => 2, 'key' => 3, 'name' => 4, 'uuid' => 5, ],
        self::TYPE_COLNAME       => [SpyCompanyRoleTableMap::COL_ID_COMPANY_ROLE => 0, SpyCompanyRoleTableMap::COL_FK_COMPANY => 1, SpyCompanyRoleTableMap::COL_IS_DEFAULT => 2, SpyCompanyRoleTableMap::COL_KEY => 3, SpyCompanyRoleTableMap::COL_NAME => 4, SpyCompanyRoleTableMap::COL_UUID => 5, ],
        self::TYPE_FIELDNAME     => ['id_company_role' => 0, 'fk_company' => 1, 'is_default' => 2, 'key' => 3, 'name' => 4, 'uuid' => 5, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, 5, ]
    ];
