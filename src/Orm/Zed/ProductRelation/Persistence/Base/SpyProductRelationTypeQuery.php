 ...
 *
 * @method     ChildSpyProductRelationType[]|Collection find(?ConnectionInterface $con = null) Return ChildSpyProductRelationType objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpyProductRelationType> find(?ConnectionInterface $con = null) Return ChildSpyProductRelationType objects based on current ModelCriteria
 *
 * @method     ChildSpyProductRelationType[]|Collection findByIdProductRelationType(int|array<int> $id_product_relation_type) Return ChildSpyProductRelationType objects filtered by the id_product_relation_type column
 * @psalm-method Collection&\Traversable<ChildSpyProductRelationType> findByIdProductRelationType(int|array<int> $id_product_relation_type) Return ChildSpyProductRelationType objects filtered by the id_product_relation_type column
 * @method     ChildSpyProductRelationType[]|Collection findByKey(string|array<string> $key) Return ChildSpyProductRelationType objects filtered by the key column
 * @psalm-method Collection&\Traversable<ChildSpyProductRelationType> findByKey(string|array<string> $key) Return ChildSpyProductRelationType objects filtered by the key column
 * @method     ChildSpyProductRelationType[]|Collection findByCreatedAt(string|array<string> $created_at) Return ChildSpyProductRelationType objects filtered by the created_at column
 * @psalm-method Collection&\Traversable<ChildSpyProductRelationType> findByCreatedAt(string|array<string> $created_at) Return ChildSpyProductRelationType objects filtered by the created_at column
 * @method     ChildSpyProductRelationType[]|Collection findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyProductRelationType objects filtered by the updated_at column
 * @psalm-method Collection&\Traversable<ChildSpyProductRelationType> findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyProductRelationType objects filtered by the updated_at column
 *
...
abstract class SpyProductRelationTypeQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SpyProductRelationTypeTableMap::COL_ID_PRODUCT_RELATION_TYPE, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SpyProductRelationTypeTableMap::COL_ID_PRODUCT_RELATION_TYPE, $keys, Criteria::IN);
    ...
    {
        $this->addUsingAlias(SpyProductRelationTypeTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addDescendingOrderByColumn(SpyProductRelationTypeTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addAscendingOrderByColumn(SpyProductRelationTypeTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addDescendingOrderByColumn(SpyProductRelationTypeTableMap::COL_CREATED_AT);
    ...
    {
        $this->addUsingAlias(SpyProductRelationTypeTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addAscendingOrderByColumn(SpyProductRelationTypeTableMap::COL_CREATED_AT);
