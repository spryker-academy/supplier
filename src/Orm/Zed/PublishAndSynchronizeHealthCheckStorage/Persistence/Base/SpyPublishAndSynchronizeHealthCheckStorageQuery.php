 ...
 *
 * @method     ChildSpyPublishAndSynchronizeHealthCheckStorage[]|Collection find(?ConnectionInterface $con = null) Return ChildSpyPublishAndSynchronizeHealthCheckStorage objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpyPublishAndSynchronizeHealthCheckStorage> find(?ConnectionInterface $con = null) Return ChildSpyPublishAndSynchronizeHealthCheckStorage objects based on current ModelCriteria
 *
 * @method     ChildSpyPublishAndSynchronizeHealthCheckStorage[]|Collection findByIdPublishAndSynchronizeHealthCheckStorage(string|array<string> $id_publish_and_synchronize_health_check_storage) Return ChildSpyPublishAndSynchronizeHealthCheckStorage objects filtered by the id_publish_and_synchronize_health_check_storage column
 * @psalm-method Collection&\Traversable<ChildSpyPublishAndSynchronizeHealthCheckStorage> findByIdPublishAndSynchronizeHealthCheckStorage(string|array<string> $id_publish_and_synchronize_health_check_storage) Return ChildSpyPublishAndSynchronizeHealthCheckStorage objects filtered by the id_publish_and_synchronize_health_check_storage column
 * @method     ChildSpyPublishAndSynchronizeHealthCheckStorage[]|Collection findByFkPublishAndSynchronizeHealthCheck(int|array<int> $fk_publish_and_synchronize_health_check) Return ChildSpyPublishAndSynchronizeHealthCheckStorage objects filtered by the fk_publish_and_synchronize_health_check column
 * @psalm-method Collection&\Traversable<ChildSpyPublishAndSynchronizeHealthCheckStorage> findByFkPublishAndSynchronizeHealthCheck(int|array<int> $fk_publish_and_synchronize_health_check) Return ChildSpyPublishAndSynchronizeHealthCheckStorage objects filtered by the fk_publish_and_synchronize_health_check column
 * @method     ChildSpyPublishAndSynchronizeHealthCheckStorage[]|Collection findByHealthCheckKey(string|array<string> $health_check_key) Return ChildSpyPublishAndSynchronizeHealthCheckStorage objects filtered by the health_check_key column
 * @psalm-method Collection&\Traversable<ChildSpyPublishAndSynchronizeHealthCheckStorage> findByHealthCheckKey(string|array<string> $health_check_key) Return ChildSpyPublishAndSynchronizeHealthCheckStorage objects filtered by the health_check_key column
 * @method     ChildSpyPublishAndSynchronizeHealthCheckStorage[]|Collection findByData(string|array<string> $data) Return ChildSpyPublishAndSynchronizeHealthCheckStorage objects filtered by the data column
 * @psalm-method Collection&\Traversable<ChildSpyPublishAndSynchronizeHealthCheckStorage> findByData(string|array<string> $data) Return ChildSpyPublishAndSynchronizeHealthCheckStorage objects filtered by the data column
 * @method     ChildSpyPublishAndSynchronizeHealthCheckStorage[]|Collection findByAliasKeys(string|array<string> $alias_keys) Return ChildSpyPublishAndSynchronizeHealthCheckStorage objects filtered by the alias_keys column
 * @psalm-method Collection&\Traversable<ChildSpyPublishAndSynchronizeHealthCheckStorage> findByAliasKeys(string|array<string> $alias_keys) Return ChildSpyPublishAndSynchronizeHealthCheckStorage objects filtered by the alias_keys column
 * @method     ChildSpyPublishAndSynchronizeHealthCheckStorage[]|Collection findByKey(string|array<string> $key) Return ChildSpyPublishAndSynchronizeHealthCheckStorage objects filtered by the key column
 * @psalm-method Collection&\Traversable<ChildSpyPublishAndSynchronizeHealthCheckStorage> findByKey(string|array<string> $key) Return ChildSpyPublishAndSynchronizeHealthCheckStorage objects filtered by the key column
 * @method     ChildSpyPublishAndSynchronizeHealthCheckStorage[]|Collection findByCreatedAt(string|array<string> $created_at) Return ChildSpyPublishAndSynchronizeHealthCheckStorage objects filtered by the created_at column
 * @psalm-method Collection&\Traversable<ChildSpyPublishAndSynchronizeHealthCheckStorage> findByCreatedAt(string|array<string> $created_at) Return ChildSpyPublishAndSynchronizeHealthCheckStorage objects filtered by the created_at column
 * @method     ChildSpyPublishAndSynchronizeHealthCheckStorage[]|Collection findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyPublishAndSynchronizeHealthCheckStorage objects filtered by the updated_at column
 * @psalm-method Collection&\Traversable<ChildSpyPublishAndSynchronizeHealthCheckStorage> findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyPublishAndSynchronizeHealthCheckStorage objects filtered by the updated_at column
 *
...
abstract class SpyPublishAndSynchronizeHealthCheckStorageQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SpyPublishAndSynchronizeHealthCheckStorageTableMap::COL_ID_PUBLISH_AND_SYNCHRONIZE_HEALTH_CHECK_STORAGE, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SpyPublishAndSynchronizeHealthCheckStorageTableMap::COL_ID_PUBLISH_AND_SYNCHRONIZE_HEALTH_CHECK_STORAGE, $keys, Criteria::IN);
    ...
    {
        $this->addUsingAlias(SpyPublishAndSynchronizeHealthCheckStorageTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addDescendingOrderByColumn(SpyPublishAndSynchronizeHealthCheckStorageTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addAscendingOrderByColumn(SpyPublishAndSynchronizeHealthCheckStorageTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addDescendingOrderByColumn(SpyPublishAndSynchronizeHealthCheckStorageTableMap::COL_CREATED_AT);
    ...
    {
        $this->addUsingAlias(SpyPublishAndSynchronizeHealthCheckStorageTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addAscendingOrderByColumn(SpyPublishAndSynchronizeHealthCheckStorageTableMap::COL_CREATED_AT);
