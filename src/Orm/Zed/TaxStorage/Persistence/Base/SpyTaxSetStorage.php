...
abstract class SpyTaxSetStorage implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Orm\\Zed\\TaxStorage\\Persistence\\Map\\SpyTaxSetStorageTableMap';
    ...
    protected function sendToBuffer(array $message): void
    {
        ...
        $synchronizationMessageTransfer->setResource('tax_set');
