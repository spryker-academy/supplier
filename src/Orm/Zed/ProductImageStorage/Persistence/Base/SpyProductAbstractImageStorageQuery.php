 ...
 *
 * @method     ChildSpyProductAbstractImageStorage[]|Collection find(?ConnectionInterface $con = null) Return ChildSpyProductAbstractImageStorage objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpyProductAbstractImageStorage> find(?ConnectionInterface $con = null) Return ChildSpyProductAbstractImageStorage objects based on current ModelCriteria
 *
 * @method     ChildSpyProductAbstractImageStorage[]|Collection findByIdProductAbstractImageStorage(string|array<string> $id_product_abstract_image_storage) Return ChildSpyProductAbstractImageStorage objects filtered by the id_product_abstract_image_storage column
 * @psalm-method Collection&\Traversable<ChildSpyProductAbstractImageStorage> findByIdProductAbstractImageStorage(string|array<string> $id_product_abstract_image_storage) Return ChildSpyProductAbstractImageStorage objects filtered by the id_product_abstract_image_storage column
 * @method     ChildSpyProductAbstractImageStorage[]|Collection findByFkProductAbstract(int|array<int> $fk_product_abstract) Return ChildSpyProductAbstractImageStorage objects filtered by the fk_product_abstract column
 * @psalm-method Collection&\Traversable<ChildSpyProductAbstractImageStorage> findByFkProductAbstract(int|array<int> $fk_product_abstract) Return ChildSpyProductAbstractImageStorage objects filtered by the fk_product_abstract column
 * @method     ChildSpyProductAbstractImageStorage[]|Collection findByData(string|array<string> $data) Return ChildSpyProductAbstractImageStorage objects filtered by the data column
 * @psalm-method Collection&\Traversable<ChildSpyProductAbstractImageStorage> findByData(string|array<string> $data) Return ChildSpyProductAbstractImageStorage objects filtered by the data column
 * @method     ChildSpyProductAbstractImageStorage[]|Collection findByLocale(string|array<string> $locale) Return ChildSpyProductAbstractImageStorage objects filtered by the locale column
 * @psalm-method Collection&\Traversable<ChildSpyProductAbstractImageStorage> findByLocale(string|array<string> $locale) Return ChildSpyProductAbstractImageStorage objects filtered by the locale column
 * @method     ChildSpyProductAbstractImageStorage[]|Collection findByAliasKeys(string|array<string> $alias_keys) Return ChildSpyProductAbstractImageStorage objects filtered by the alias_keys column
 * @psalm-method Collection&\Traversable<ChildSpyProductAbstractImageStorage> findByAliasKeys(string|array<string> $alias_keys) Return ChildSpyProductAbstractImageStorage objects filtered by the alias_keys column
 * @method     ChildSpyProductAbstractImageStorage[]|Collection findByKey(string|array<string> $key) Return ChildSpyProductAbstractImageStorage objects filtered by the key column
 * @psalm-method Collection&\Traversable<ChildSpyProductAbstractImageStorage> findByKey(string|array<string> $key) Return ChildSpyProductAbstractImageStorage objects filtered by the key column
 * @method     ChildSpyProductAbstractImageStorage[]|Collection findByCreatedAt(string|array<string> $created_at) Return ChildSpyProductAbstractImageStorage objects filtered by the created_at column
 * @psalm-method Collection&\Traversable<ChildSpyProductAbstractImageStorage> findByCreatedAt(string|array<string> $created_at) Return ChildSpyProductAbstractImageStorage objects filtered by the created_at column
 * @method     ChildSpyProductAbstractImageStorage[]|Collection findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyProductAbstractImageStorage objects filtered by the updated_at column
 * @psalm-method Collection&\Traversable<ChildSpyProductAbstractImageStorage> findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyProductAbstractImageStorage objects filtered by the updated_at column
 *
...
abstract class SpyProductAbstractImageStorageQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SpyProductAbstractImageStorageTableMap::COL_ID_PRODUCT_ABSTRACT_IMAGE_STORAGE, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SpyProductAbstractImageStorageTableMap::COL_ID_PRODUCT_ABSTRACT_IMAGE_STORAGE, $keys, Criteria::IN);
    ...
    {
        $this->addUsingAlias(SpyProductAbstractImageStorageTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addDescendingOrderByColumn(SpyProductAbstractImageStorageTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addAscendingOrderByColumn(SpyProductAbstractImageStorageTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addDescendingOrderByColumn(SpyProductAbstractImageStorageTableMap::COL_CREATED_AT);
    ...
    {
        $this->addUsingAlias(SpyProductAbstractImageStorageTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addAscendingOrderByColumn(SpyProductAbstractImageStorageTableMap::COL_CREATED_AT);
