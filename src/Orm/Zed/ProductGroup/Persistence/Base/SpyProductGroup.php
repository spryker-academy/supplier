...
abstract class SpyProductGroup implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Orm\\Zed\\ProductGroup\\Persistence\\Map\\SpyProductGroupTableMap';
     ...
     */
    protected function doAddSpyProductAbstractGroup(ChildSpyProductAbstractGroup $spyProductAbstractGroup): void
    {
