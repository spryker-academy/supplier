...
/**
 * Base class that represents a row from the 'spy_date_schedule' table.
 *
 *
 *
 * @package    propel.generator.src.Orm.Zed.WeekdaySchedule.Persistence.Base
 */
abstract class SpyDateSchedule implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\Orm\\Zed\\WeekdaySchedule\\Persistence\\Map\\SpyDateScheduleTableMap';
    ...
    /**
     * The value for the id_date_schedule field.
     *
     * @var        int
     */
    protected $id_date_schedule;
     ...
     * The end time of a schedule.
     * @var        DateTime|null
     */
    protected $time_to;

    /**
     * The value for the note_glossary_key field.
     * The glossary key for a note.
     * @var        string|null
     */
    protected $note_glossary_key;
    ...
    /**
     * Initializes internal state of Orm\Zed\WeekdaySchedule\Persistence\Base\SpyDateSchedule object.
     */
    ...
    /**
     * Compares this with another <code>SpyDateSchedule</code> instance.  If
     * <code>obj</code> is an instance of <code>SpyDateSchedule</code>, delegates to
     * <code>equals(SpyDateSchedule)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    /**
     * Get the [id_date_schedule] column value.
     *
     * @return int
     */
    public function getIdDateSchedule()
    {
        return $this->id_date_schedule;
    }
    ...
    /**
     * Get the [note_glossary_key] column value.
     * The glossary key for a note.
     * @return string|null
     */
    public function getNoteGlossaryKey()
    {
        return $this->note_glossary_key;
    }
    ...
    /**
     * Set the value of [id_date_schedule] column.
     *
     * @param int $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setIdDateSchedule($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->id_date_schedule !== $v) {
            $this->id_date_schedule = $v;
            $this->modifiedColumns[SpyDateScheduleTableMap::COL_ID_DATE_SCHEDULE] = true;
        }
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== null || $dt !== null) {
            if ($this->date === null || $dt === null || $dt->format("Y-m-d") !== $this->date->format("Y-m-d")) {
                ...
                $this->modifiedColumns[SpyDateScheduleTableMap::COL_DATE] = true;
            }
    ...
    public function setTimeFrom($v)
    {
        ...
        if ($this->time_from !== null || $dt !== null) {
            if ($this->time_from === null || $dt === null || $dt->format("H:i:s.u") !== $this->time_from->format("H:i:s.u")) {
                ...
                $this->modifiedColumns[SpyDateScheduleTableMap::COL_TIME_FROM] = true;
            }
        } // if either are not null
    ...
    public function setTimeTo($v)
    {
        ...
        if ($this->time_to !== null || $dt !== null) {
            if ($this->time_to === null || $dt === null || $dt->format("H:i:s.u") !== $this->time_to->format("H:i:s.u")) {
                ...
                $this->modifiedColumns[SpyDateScheduleTableMap::COL_TIME_TO] = true;
            }
        } // if either are not null
    ...
    /**
     * Set the value of [note_glossary_key] column.
     * The glossary key for a note.
     * @param string|null $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setNoteGlossaryKey($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->note_glossary_key !== $v) {
            $this->note_glossary_key = $v;
            $this->modifiedColumns[SpyDateScheduleTableMap::COL_NOTE_GLOSSARY_KEY] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[SpyDateScheduleTableMap::COL_CREATED_AT] = true;
            }
        } // if either are not null
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[SpyDateScheduleTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SpyDateScheduleTableMap::translateFieldName('IdDateSchedule', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_date_schedule = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SpyDateScheduleTableMap::translateFieldName('Date', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SpyDateScheduleTableMap::translateFieldName('TimeFrom', TableMap::TYPE_PHPNAME, $indexType)];
            $this->time_from = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SpyDateScheduleTableMap::translateFieldName('TimeTo', TableMap::TYPE_PHPNAME, $indexType)];
            $this->time_to = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SpyDateScheduleTableMap::translateFieldName('NoteGlossaryKey', TableMap::TYPE_PHPNAME, $indexType)];
            $this->note_glossary_key = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : SpyDateScheduleTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : SpyDateScheduleTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 7; // 7 = SpyDateScheduleTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Orm\\Zed\\WeekdaySchedule\\Persistence\\SpyDateSchedule'), 0, $e);
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        if ($con === null) {
            $con = Propel::getServiceContainer()->getReadConnection(SpyDateScheduleTableMap::DATABASE_NAME);
        }

        // We don't need to alter the object instance pool; we're just modifying this instance
        // already in the pool.

        $dataFetcher = ChildSpyDateScheduleQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws \Propel\Runtime\Exception\PropelException
     * @see SpyDateSchedule::setDeleted()
     * @see SpyDateSchedule::isDeleted()
     */
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildSpyDateScheduleQuery::create()
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(SpyDateScheduleTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt($highPrecision);
                }
                if (!$this->isColumnModified(SpyDateScheduleTableMap::COL_UPDATED_AT)) {
                ...
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(SpyDateScheduleTableMap::COL_UPDATED_AT)) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SpyDateScheduleTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(SpyDateScheduleTableMap::COL_ID_DATE_SCHEDULE)) {
            $modifiedColumns[':p' . $index++]  = 'id_date_schedule';
        }
        if ($this->isColumnModified(SpyDateScheduleTableMap::COL_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'date';
        }
        if ($this->isColumnModified(SpyDateScheduleTableMap::COL_TIME_FROM)) {
            $modifiedColumns[':p' . $index++]  = 'time_from';
        }
        if ($this->isColumnModified(SpyDateScheduleTableMap::COL_TIME_TO)) {
            $modifiedColumns[':p' . $index++]  = 'time_to';
        }
        if ($this->isColumnModified(SpyDateScheduleTableMap::COL_NOTE_GLOSSARY_KEY)) {
            $modifiedColumns[':p' . $index++]  = 'note_glossary_key';
        }
        if ($this->isColumnModified(SpyDateScheduleTableMap::COL_CREATED_AT)) {
        ...
        $sql = sprintf(
            'INSERT INTO spy_date_schedule (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id_date_schedule':
                        $stmt->bindValue($identifier, $this->id_date_schedule, PDO::PARAM_INT);
                    ...
                    case 'date':
                        ...
                        break;
                    case 'time_from':
                        $stmt->bindValue($identifier, $this->time_from ? $this->time_from->format("H:i:s.u") : null, PDO::PARAM_STR);

                        break;
                    case 'time_to':
                        $stmt->bindValue($identifier, $this->time_to ? $this->time_to->format("H:i:s.u") : null, PDO::PARAM_STR);

                        break;
                    case 'note_glossary_key':
                        $stmt->bindValue($identifier, $this->note_glossary_key, PDO::PARAM_STR);
    ...
    {
        $pos = SpyDateScheduleTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function getByPosition(int $pos)
    {
        switch ($pos) {
            ...
            case 4:
                return $this->getNoteGlossaryKey();
    ...
    {
        if (isset($alreadyDumpedObjects['SpyDateSchedule'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['SpyDateSchedule'][$this->hashCode()] = true;
        $keys = SpyDateScheduleTableMap::getFieldNames($keyType);
        $result = [
            $keys[0] => $this->getIdDateSchedule(),
            $keys[1] => $this->getDate(),
            $keys[2] => $this->getTimeFrom(),
            $keys[3] => $this->getTimeTo(),
            $keys[4] => $this->getNoteGlossaryKey(),
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setIdDateSchedule($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setDate($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setTimeFrom($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setTimeTo($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setNoteGlossaryKey($arr[$keys[4]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(SpyDateScheduleTableMap::COL_ID_DATE_SCHEDULE)) {
            $criteria->add(SpyDateScheduleTableMap::COL_ID_DATE_SCHEDULE, $this->id_date_schedule);
        }
        if ($this->isColumnModified(SpyDateScheduleTableMap::COL_DATE)) {
            $criteria->add(SpyDateScheduleTableMap::COL_DATE, $this->date);
        }
        if ($this->isColumnModified(SpyDateScheduleTableMap::COL_TIME_FROM)) {
            $criteria->add(SpyDateScheduleTableMap::COL_TIME_FROM, $this->time_from);
        }
        if ($this->isColumnModified(SpyDateScheduleTableMap::COL_TIME_TO)) {
            $criteria->add(SpyDateScheduleTableMap::COL_TIME_TO, $this->time_to);
        }
        if ($this->isColumnModified(SpyDateScheduleTableMap::COL_NOTE_GLOSSARY_KEY)) {
            $criteria->add(SpyDateScheduleTableMap::COL_NOTE_GLOSSARY_KEY, $this->note_glossary_key);
        }
        if ($this->isColumnModified(SpyDateScheduleTableMap::COL_CREATED_AT)) {
            $criteria->add(SpyDateScheduleTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(SpyDateScheduleTableMap::COL_UPDATED_AT)) {
            $criteria->add(SpyDateScheduleTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    {
        $criteria = ChildSpyDateScheduleQuery::create();
        $criteria->add(SpyDateScheduleTableMap::COL_ID_DATE_SCHEDULE, $this->id_date_schedule);
    ...
    {
        $validPk = null !== $this->getIdDateSchedule();
    ...
    /**
     * Generic method to set the primary key (id_date_schedule column).
     *
    ...
    {
        return null === $this->getIdDateSchedule();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of \Orm\Zed\WeekdaySchedule\Persistence\SpyDateSchedule (or compatible) type.
    ...
    public function copyInto(object $copyObj, bool $deepCopy = false, bool $makeNew = true): void
    {
        ...
        $copyObj->setNoteGlossaryKey($this->getNoteGlossaryKey());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdDateSchedule(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Orm\Zed\WeekdaySchedule\Persistence\SpyDateSchedule Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
     ...
     * If this ChildSpyDateSchedule is new, it will return
    ...
    public function setSpyMerchantOpeningHoursDateSchedules(Collection $spyMerchantOpeningHoursDateSchedules, ?ConnectionInterface $con = null)
    {
        ...
        foreach ($spyMerchantOpeningHoursDateSchedulesToDelete as $spyMerchantOpeningHoursDateScheduleRemoved) {
            $spyMerchantOpeningHoursDateScheduleRemoved->setSpyDateSchedule(null);
        }
    ...
    protected function doAddSpyMerchantOpeningHoursDateSchedule(SpyMerchantOpeningHoursDateSchedule $spyMerchantOpeningHoursDateSchedule): void
    {
        ...
        $spyMerchantOpeningHoursDateSchedule->setSpyDateSchedule($this);
    }
    ...
    public function removeSpyMerchantOpeningHoursDateSchedule(SpyMerchantOpeningHoursDateSchedule $spyMerchantOpeningHoursDateSchedule)
    {
        if ($this->getSpyMerchantOpeningHoursDateSchedules()->contains($spyMerchantOpeningHoursDateSchedule)) {
            ...
            $spyMerchantOpeningHoursDateSchedule->setSpyDateSchedule(null);
        }
     ...
     * Otherwise if this SpyDateSchedule is new, it will return
     * an empty collection; or if this SpyDateSchedule has previously
     * been saved, it will retrieve related SpyMerchantOpeningHoursDateSchedules from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in SpyDateSchedule.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param ConnectionInterface $con optional connection object
     ...
     * @phpstan-return ObjectCollection&\Traversable<SpyMerchantOpeningHoursDateSchedule}> List of SpyMerchantOpeningHoursDateSchedule objects
     */
    public function getSpyMerchantOpeningHoursDateSchedulesJoinSpyMerchant(?Criteria $criteria = null, ?ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = SpyMerchantOpeningHoursDateScheduleQuery::create(null, $criteria);
    ...
    {
        $this->id_date_schedule = null;
        $this->date = null;
        $this->time_from = null;
        $this->time_to = null;
        $this->note_glossary_key = null;
    ...
    {
        return (string) $this->exportTo(SpyDateScheduleTableMap::DEFAULT_STRING_FORMAT);
    }
