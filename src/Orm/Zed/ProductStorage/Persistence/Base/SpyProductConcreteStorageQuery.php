 ...
 *
 * @method     ChildSpyProductConcreteStorage[]|Collection find(?ConnectionInterface $con = null) Return ChildSpyProductConcreteStorage objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpyProductConcreteStorage> find(?ConnectionInterface $con = null) Return ChildSpyProductConcreteStorage objects based on current ModelCriteria
 *
 * @method     ChildSpyProductConcreteStorage[]|Collection findByIdProductConcreteStorage(string|array<string> $id_product_concrete_storage) Return ChildSpyProductConcreteStorage objects filtered by the id_product_concrete_storage column
 * @psalm-method Collection&\Traversable<ChildSpyProductConcreteStorage> findByIdProductConcreteStorage(string|array<string> $id_product_concrete_storage) Return ChildSpyProductConcreteStorage objects filtered by the id_product_concrete_storage column
 * @method     ChildSpyProductConcreteStorage[]|Collection findByFkProduct(int|array<int> $fk_product) Return ChildSpyProductConcreteStorage objects filtered by the fk_product column
 * @psalm-method Collection&\Traversable<ChildSpyProductConcreteStorage> findByFkProduct(int|array<int> $fk_product) Return ChildSpyProductConcreteStorage objects filtered by the fk_product column
 * @method     ChildSpyProductConcreteStorage[]|Collection findBySku(string|array<string> $sku) Return ChildSpyProductConcreteStorage objects filtered by the sku column
 * @psalm-method Collection&\Traversable<ChildSpyProductConcreteStorage> findBySku(string|array<string> $sku) Return ChildSpyProductConcreteStorage objects filtered by the sku column
 * @method     ChildSpyProductConcreteStorage[]|Collection findByData(string|array<string> $data) Return ChildSpyProductConcreteStorage objects filtered by the data column
 * @psalm-method Collection&\Traversable<ChildSpyProductConcreteStorage> findByData(string|array<string> $data) Return ChildSpyProductConcreteStorage objects filtered by the data column
 * @method     ChildSpyProductConcreteStorage[]|Collection findByLocale(string|array<string> $locale) Return ChildSpyProductConcreteStorage objects filtered by the locale column
 * @psalm-method Collection&\Traversable<ChildSpyProductConcreteStorage> findByLocale(string|array<string> $locale) Return ChildSpyProductConcreteStorage objects filtered by the locale column
 * @method     ChildSpyProductConcreteStorage[]|Collection findByAliasKeys(string|array<string> $alias_keys) Return ChildSpyProductConcreteStorage objects filtered by the alias_keys column
 * @psalm-method Collection&\Traversable<ChildSpyProductConcreteStorage> findByAliasKeys(string|array<string> $alias_keys) Return ChildSpyProductConcreteStorage objects filtered by the alias_keys column
 * @method     ChildSpyProductConcreteStorage[]|Collection findByKey(string|array<string> $key) Return ChildSpyProductConcreteStorage objects filtered by the key column
 * @psalm-method Collection&\Traversable<ChildSpyProductConcreteStorage> findByKey(string|array<string> $key) Return ChildSpyProductConcreteStorage objects filtered by the key column
 * @method     ChildSpyProductConcreteStorage[]|Collection findByCreatedAt(string|array<string> $created_at) Return ChildSpyProductConcreteStorage objects filtered by the created_at column
 * @psalm-method Collection&\Traversable<ChildSpyProductConcreteStorage> findByCreatedAt(string|array<string> $created_at) Return ChildSpyProductConcreteStorage objects filtered by the created_at column
 * @method     ChildSpyProductConcreteStorage[]|Collection findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyProductConcreteStorage objects filtered by the updated_at column
 * @psalm-method Collection&\Traversable<ChildSpyProductConcreteStorage> findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyProductConcreteStorage objects filtered by the updated_at column
 *
...
abstract class SpyProductConcreteStorageQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SpyProductConcreteStorageTableMap::COL_ID_PRODUCT_CONCRETE_STORAGE, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SpyProductConcreteStorageTableMap::COL_ID_PRODUCT_CONCRETE_STORAGE, $keys, Criteria::IN);
    ...
    {
        $this->addUsingAlias(SpyProductConcreteStorageTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addDescendingOrderByColumn(SpyProductConcreteStorageTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addAscendingOrderByColumn(SpyProductConcreteStorageTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addDescendingOrderByColumn(SpyProductConcreteStorageTableMap::COL_CREATED_AT);
    ...
    {
        $this->addUsingAlias(SpyProductConcreteStorageTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addAscendingOrderByColumn(SpyProductConcreteStorageTableMap::COL_CREATED_AT);
