 ...
 *
 * @method     ChildSpyProductAbstractStorage[]|Collection find(?ConnectionInterface $con = null) Return ChildSpyProductAbstractStorage objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpyProductAbstractStorage> find(?ConnectionInterface $con = null) Return ChildSpyProductAbstractStorage objects based on current ModelCriteria
 *
 * @method     ChildSpyProductAbstractStorage[]|Collection findByIdProductAbstractStorage(string|array<string> $id_product_abstract_storage) Return ChildSpyProductAbstractStorage objects filtered by the id_product_abstract_storage column
 * @psalm-method Collection&\Traversable<ChildSpyProductAbstractStorage> findByIdProductAbstractStorage(string|array<string> $id_product_abstract_storage) Return ChildSpyProductAbstractStorage objects filtered by the id_product_abstract_storage column
 * @method     ChildSpyProductAbstractStorage[]|Collection findByFkProductAbstract(int|array<int> $fk_product_abstract) Return ChildSpyProductAbstractStorage objects filtered by the fk_product_abstract column
 * @psalm-method Collection&\Traversable<ChildSpyProductAbstractStorage> findByFkProductAbstract(int|array<int> $fk_product_abstract) Return ChildSpyProductAbstractStorage objects filtered by the fk_product_abstract column
 * @method     ChildSpyProductAbstractStorage[]|Collection findBySku(string|array<string> $sku) Return ChildSpyProductAbstractStorage objects filtered by the sku column
 * @psalm-method Collection&\Traversable<ChildSpyProductAbstractStorage> findBySku(string|array<string> $sku) Return ChildSpyProductAbstractStorage objects filtered by the sku column
 * @method     ChildSpyProductAbstractStorage[]|Collection findByData(string|array<string> $data) Return ChildSpyProductAbstractStorage objects filtered by the data column
 * @psalm-method Collection&\Traversable<ChildSpyProductAbstractStorage> findByData(string|array<string> $data) Return ChildSpyProductAbstractStorage objects filtered by the data column
 * @method     ChildSpyProductAbstractStorage[]|Collection findByStore(string|array<string> $store) Return ChildSpyProductAbstractStorage objects filtered by the store column
 * @psalm-method Collection&\Traversable<ChildSpyProductAbstractStorage> findByStore(string|array<string> $store) Return ChildSpyProductAbstractStorage objects filtered by the store column
 * @method     ChildSpyProductAbstractStorage[]|Collection findByLocale(string|array<string> $locale) Return ChildSpyProductAbstractStorage objects filtered by the locale column
 * @psalm-method Collection&\Traversable<ChildSpyProductAbstractStorage> findByLocale(string|array<string> $locale) Return ChildSpyProductAbstractStorage objects filtered by the locale column
 * @method     ChildSpyProductAbstractStorage[]|Collection findByAliasKeys(string|array<string> $alias_keys) Return ChildSpyProductAbstractStorage objects filtered by the alias_keys column
 * @psalm-method Collection&\Traversable<ChildSpyProductAbstractStorage> findByAliasKeys(string|array<string> $alias_keys) Return ChildSpyProductAbstractStorage objects filtered by the alias_keys column
 * @method     ChildSpyProductAbstractStorage[]|Collection findByKey(string|array<string> $key) Return ChildSpyProductAbstractStorage objects filtered by the key column
 * @psalm-method Collection&\Traversable<ChildSpyProductAbstractStorage> findByKey(string|array<string> $key) Return ChildSpyProductAbstractStorage objects filtered by the key column
 * @method     ChildSpyProductAbstractStorage[]|Collection findByCreatedAt(string|array<string> $created_at) Return ChildSpyProductAbstractStorage objects filtered by the created_at column
 * @psalm-method Collection&\Traversable<ChildSpyProductAbstractStorage> findByCreatedAt(string|array<string> $created_at) Return ChildSpyProductAbstractStorage objects filtered by the created_at column
 * @method     ChildSpyProductAbstractStorage[]|Collection findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyProductAbstractStorage objects filtered by the updated_at column
 * @psalm-method Collection&\Traversable<ChildSpyProductAbstractStorage> findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyProductAbstractStorage objects filtered by the updated_at column
 *
...
abstract class SpyProductAbstractStorageQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SpyProductAbstractStorageTableMap::COL_ID_PRODUCT_ABSTRACT_STORAGE, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SpyProductAbstractStorageTableMap::COL_ID_PRODUCT_ABSTRACT_STORAGE, $keys, Criteria::IN);
    ...
    {
        $this->addUsingAlias(SpyProductAbstractStorageTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addDescendingOrderByColumn(SpyProductAbstractStorageTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addAscendingOrderByColumn(SpyProductAbstractStorageTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addDescendingOrderByColumn(SpyProductAbstractStorageTableMap::COL_CREATED_AT);
    ...
    {
        $this->addUsingAlias(SpyProductAbstractStorageTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addAscendingOrderByColumn(SpyProductAbstractStorageTableMap::COL_CREATED_AT);
