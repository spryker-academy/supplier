 ...
 *
 * @method     ChildSpyShoppingListPermissionGroupToPermission[]|Collection find(?ConnectionInterface $con = null) Return ChildSpyShoppingListPermissionGroupToPermission objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpyShoppingListPermissionGroupToPermission> find(?ConnectionInterface $con = null) Return ChildSpyShoppingListPermissionGroupToPermission objects based on current ModelCriteria
 *
 * @method     ChildSpyShoppingListPermissionGroupToPermission[]|Collection findByIdShoppingListPermissionGroupToPermission(int|array<int> $id_shopping_list_permission_group_to_permission) Return ChildSpyShoppingListPermissionGroupToPermission objects filtered by the id_shopping_list_permission_group_to_permission column
 * @psalm-method Collection&\Traversable<ChildSpyShoppingListPermissionGroupToPermission> findByIdShoppingListPermissionGroupToPermission(int|array<int> $id_shopping_list_permission_group_to_permission) Return ChildSpyShoppingListPermissionGroupToPermission objects filtered by the id_shopping_list_permission_group_to_permission column
 * @method     ChildSpyShoppingListPermissionGroupToPermission[]|Collection findByFkPermission(int|array<int> $fk_permission) Return ChildSpyShoppingListPermissionGroupToPermission objects filtered by the fk_permission column
 * @psalm-method Collection&\Traversable<ChildSpyShoppingListPermissionGroupToPermission> findByFkPermission(int|array<int> $fk_permission) Return ChildSpyShoppingListPermissionGroupToPermission objects filtered by the fk_permission column
 * @method     ChildSpyShoppingListPermissionGroupToPermission[]|Collection findByFkShoppingListPermissionGroup(int|array<int> $fk_shopping_list_permission_group) Return ChildSpyShoppingListPermissionGroupToPermission objects filtered by the fk_shopping_list_permission_group column
 * @psalm-method Collection&\Traversable<ChildSpyShoppingListPermissionGroupToPermission> findByFkShoppingListPermissionGroup(int|array<int> $fk_shopping_list_permission_group) Return ChildSpyShoppingListPermissionGroupToPermission objects filtered by the fk_shopping_list_permission_group column
 *
...
abstract class SpyShoppingListPermissionGroupToPermissionQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SpyShoppingListPermissionGroupToPermissionTableMap::COL_ID_SHOPPING_LIST_PERMISSION_GROUP_TO_PERMISSION, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SpyShoppingListPermissionGroupToPermissionTableMap::COL_ID_SHOPPING_LIST_PERMISSION_GROUP_TO_PERMISSION, $keys, Criteria::IN);
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterBySpyPermission($spyPermission, ?string $comparison = null)
    {
     ...
     * @return $this The current query, for fluid interface
     */
    public function joinSpyPermission(?string $relationAlias = null, ?string $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    public function useSpyPermissionExistsQuery($modelAlias = null, $queryClass = null, $typeOfExists = 'EXISTS')
    {
        ...
        $q = $this->useExistsQuery('SpyPermission', $modelAlias, $queryClass, $typeOfExists);
        return $q;
    }
    ...
    {
        /** @var $q \Orm\Zed\Permission\Persistence\SpyPermissionQuery */
        $q = $this->useExistsQuery('SpyPermission', $modelAlias, $queryClass, 'NOT EXISTS');
        return $q;
    }

    /**
     * Use the relation to SpyPermission table for an IN query.
     *
     * @see \Propel\Runtime\ActiveQuery\ModelCriteria::useInQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     ...
     */
    public function useInSpyPermissionQuery($modelAlias = null, $queryClass = null, $typeOfIn = 'IN')
    {
        /** @var $q \Orm\Zed\Permission\Persistence\SpyPermissionQuery */
        $q = $this->useInQuery('SpyPermission', $modelAlias, $queryClass, $typeOfIn);
        return $q;
    }

    /**
     * Use the relation to SpyPermission table for a NOT IN query.
     *
     * @see useSpyPermissionInQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     * @param string|null $queryClass Allows to use a custom query class for the NOT IN query, like ExtendedBookQuery::class
     *
     ...
     */
    public function useNotInSpyPermissionQuery($modelAlias = null, $queryClass = null)
    {
        /** @var $q \Orm\Zed\Permission\Persistence\SpyPermissionQuery */
        $q = $this->useInQuery('SpyPermission', $modelAlias, $queryClass, 'NOT IN');
        return $q;
    }
