...
class SpyShoppingListPermissionGroupToPermissionTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'src.Orm.Zed.ShoppingList.Persistence.Map.SpyShoppingListPermissionGroupToPermissionTableMap';
     ...
     */
    public const TABLE_NAME = 'spy_shopping_list_permission_group_to_permission';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'SpyShoppingListPermissionGroupToPermission';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\Orm\\Zed\\ShoppingList\\Persistence\\SpyShoppingListPermissionGroupToPermission';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'src.Orm.Zed.ShoppingList.Persistence.SpyShoppingListPermissionGroupToPermission';
     ...
     */
    public const COL_ID_SHOPPING_LIST_PERMISSION_GROUP_TO_PERMISSION = 'spy_shopping_list_permission_group_to_permission.id_shopping_list_permission_group_to_permission';

    /**
     * the column name for the fk_permission field
     */
    public const COL_FK_PERMISSION = 'spy_shopping_list_permission_group_to_permission.fk_permission';

    /**
     * the column name for the fk_shopping_list_permission_group field
     */
    public const COL_FK_SHOPPING_LIST_PERMISSION_GROUP = 'spy_shopping_list_permission_group_to_permission.fk_shopping_list_permission_group';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdShoppingListPermissionGroupToPermission', 'FkPermission', 'FkShoppingListPermissionGroup', ],
        self::TYPE_CAMELNAME     => ['idShoppingListPermissionGroupToPermission', 'fkPermission', 'fkShoppingListPermissionGroup', ],
        self::TYPE_COLNAME       => [SpyShoppingListPermissionGroupToPermissionTableMap::COL_ID_SHOPPING_LIST_PERMISSION_GROUP_TO_PERMISSION, SpyShoppingListPermissionGroupToPermissionTableMap::COL_FK_PERMISSION, SpyShoppingListPermissionGroupToPermissionTableMap::COL_FK_SHOPPING_LIST_PERMISSION_GROUP, ],
        self::TYPE_FIELDNAME     => ['id_shopping_list_permission_group_to_permission', 'fk_permission', 'fk_shopping_list_permission_group', ],
        self::TYPE_NUM           => [0, 1, 2, ]
    ];
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdShoppingListPermissionGroupToPermission' => 0, 'FkPermission' => 1, 'FkShoppingListPermissionGroup' => 2, ],
        self::TYPE_CAMELNAME     => ['idShoppingListPermissionGroupToPermission' => 0, 'fkPermission' => 1, 'fkShoppingListPermissionGroup' => 2, ],
        self::TYPE_COLNAME       => [SpyShoppingListPermissionGroupToPermissionTableMap::COL_ID_SHOPPING_LIST_PERMISSION_GROUP_TO_PERMISSION => 0, SpyShoppingListPermissionGroupToPermissionTableMap::COL_FK_PERMISSION => 1, SpyShoppingListPermissionGroupToPermissionTableMap::COL_FK_SHOPPING_LIST_PERMISSION_GROUP => 2, ],
        self::TYPE_FIELDNAME     => ['id_shopping_list_permission_group_to_permission' => 0, 'fk_permission' => 1, 'fk_shopping_list_permission_group' => 2, ],
        self::TYPE_NUM           => [0, 1, 2, ]
    ];
