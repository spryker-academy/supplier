 ...
 *
 * @method     ChildSpyCustomerGroup[]|Collection find(?ConnectionInterface $con = null) Return ChildSpyCustomerGroup objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpyCustomerGroup> find(?ConnectionInterface $con = null) Return ChildSpyCustomerGroup objects based on current ModelCriteria
 *
 * @method     ChildSpyCustomerGroup[]|Collection findByIdCustomerGroup(int|array<int> $id_customer_group) Return ChildSpyCustomerGroup objects filtered by the id_customer_group column
 * @psalm-method Collection&\Traversable<ChildSpyCustomerGroup> findByIdCustomerGroup(int|array<int> $id_customer_group) Return ChildSpyCustomerGroup objects filtered by the id_customer_group column
 * @method     ChildSpyCustomerGroup[]|Collection findByDescription(string|array<string> $description) Return ChildSpyCustomerGroup objects filtered by the description column
 * @psalm-method Collection&\Traversable<ChildSpyCustomerGroup> findByDescription(string|array<string> $description) Return ChildSpyCustomerGroup objects filtered by the description column
 * @method     ChildSpyCustomerGroup[]|Collection findByName(string|array<string> $name) Return ChildSpyCustomerGroup objects filtered by the name column
 * @psalm-method Collection&\Traversable<ChildSpyCustomerGroup> findByName(string|array<string> $name) Return ChildSpyCustomerGroup objects filtered by the name column
 * @method     ChildSpyCustomerGroup[]|Collection findByCreatedAt(string|array<string> $created_at) Return ChildSpyCustomerGroup objects filtered by the created_at column
 * @psalm-method Collection&\Traversable<ChildSpyCustomerGroup> findByCreatedAt(string|array<string> $created_at) Return ChildSpyCustomerGroup objects filtered by the created_at column
 * @method     ChildSpyCustomerGroup[]|Collection findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyCustomerGroup objects filtered by the updated_at column
 * @psalm-method Collection&\Traversable<ChildSpyCustomerGroup> findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyCustomerGroup objects filtered by the updated_at column
 *
...
abstract class SpyCustomerGroupQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SpyCustomerGroupTableMap::COL_ID_CUSTOMER_GROUP, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SpyCustomerGroupTableMap::COL_ID_CUSTOMER_GROUP, $keys, Criteria::IN);
    ...
    {
        $this->addUsingAlias(SpyCustomerGroupTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addDescendingOrderByColumn(SpyCustomerGroupTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addAscendingOrderByColumn(SpyCustomerGroupTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addDescendingOrderByColumn(SpyCustomerGroupTableMap::COL_CREATED_AT);
    ...
    {
        $this->addUsingAlias(SpyCustomerGroupTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addAscendingOrderByColumn(SpyCustomerGroupTableMap::COL_CREATED_AT);
