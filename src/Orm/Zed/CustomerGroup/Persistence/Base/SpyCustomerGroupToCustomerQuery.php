 ...
 *
 * @method     ChildSpyCustomerGroupToCustomer[]|Collection find(?ConnectionInterface $con = null) Return ChildSpyCustomerGroupToCustomer objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpyCustomerGroupToCustomer> find(?ConnectionInterface $con = null) Return ChildSpyCustomerGroupToCustomer objects based on current ModelCriteria
 *
 * @method     ChildSpyCustomerGroupToCustomer[]|Collection findByIdCustomerGroupToCustomer(int|array<int> $id_customer_group_to_customer) Return ChildSpyCustomerGroupToCustomer objects filtered by the id_customer_group_to_customer column
 * @psalm-method Collection&\Traversable<ChildSpyCustomerGroupToCustomer> findByIdCustomerGroupToCustomer(int|array<int> $id_customer_group_to_customer) Return ChildSpyCustomerGroupToCustomer objects filtered by the id_customer_group_to_customer column
 * @method     ChildSpyCustomerGroupToCustomer[]|Collection findByFkCustomer(int|array<int> $fk_customer) Return ChildSpyCustomerGroupToCustomer objects filtered by the fk_customer column
 * @psalm-method Collection&\Traversable<ChildSpyCustomerGroupToCustomer> findByFkCustomer(int|array<int> $fk_customer) Return ChildSpyCustomerGroupToCustomer objects filtered by the fk_customer column
 * @method     ChildSpyCustomerGroupToCustomer[]|Collection findByFkCustomerGroup(int|array<int> $fk_customer_group) Return ChildSpyCustomerGroupToCustomer objects filtered by the fk_customer_group column
 * @psalm-method Collection&\Traversable<ChildSpyCustomerGroupToCustomer> findByFkCustomerGroup(int|array<int> $fk_customer_group) Return ChildSpyCustomerGroupToCustomer objects filtered by the fk_customer_group column
 * @method     ChildSpyCustomerGroupToCustomer[]|Collection findByCreatedAt(string|array<string> $created_at) Return ChildSpyCustomerGroupToCustomer objects filtered by the created_at column
 * @psalm-method Collection&\Traversable<ChildSpyCustomerGroupToCustomer> findByCreatedAt(string|array<string> $created_at) Return ChildSpyCustomerGroupToCustomer objects filtered by the created_at column
 * @method     ChildSpyCustomerGroupToCustomer[]|Collection findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyCustomerGroupToCustomer objects filtered by the updated_at column
 * @psalm-method Collection&\Traversable<ChildSpyCustomerGroupToCustomer> findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyCustomerGroupToCustomer objects filtered by the updated_at column
 *
...
abstract class SpyCustomerGroupToCustomerQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SpyCustomerGroupToCustomerTableMap::COL_ID_CUSTOMER_GROUP_TO_CUSTOMER, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SpyCustomerGroupToCustomerTableMap::COL_ID_CUSTOMER_GROUP_TO_CUSTOMER, $keys, Criteria::IN);
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterByCustomerGroup($spyCustomerGroup, ?string $comparison = null)
    {
    ...
    {
        /** @var $q \Orm\Zed\CustomerGroup\Persistence\SpyCustomerGroupQuery */
        $q = $this->useExistsQuery('CustomerGroup', $modelAlias, $queryClass, $typeOfExists);
        return $q;
    }
    ...
    {
        /** @var $q \Orm\Zed\CustomerGroup\Persistence\SpyCustomerGroupQuery */
        $q = $this->useExistsQuery('CustomerGroup', $modelAlias, $queryClass, 'NOT EXISTS');
        return $q;
    }

    /**
     * Use the CustomerGroup relation to the SpyCustomerGroup table for an IN query.
     *
     ...
     *
     * @return \Orm\Zed\CustomerGroup\Persistence\SpyCustomerGroupQuery The inner query object of the IN statement
     */
    public function useInCustomerGroupQuery($modelAlias = null, $queryClass = null, $typeOfIn = 'IN')
    {
        /** @var $q \Orm\Zed\CustomerGroup\Persistence\SpyCustomerGroupQuery */
        $q = $this->useInQuery('CustomerGroup', $modelAlias, $queryClass, $typeOfIn);
        return $q;
    }

    /**
     * Use the CustomerGroup relation to the SpyCustomerGroup table for a NOT IN query.
     *
     * @see useCustomerGroupInQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     * @param string|null $queryClass Allows to use a custom query class for the NOT IN query, like ExtendedBookQuery::class
     *
     * @return \Orm\Zed\CustomerGroup\Persistence\SpyCustomerGroupQuery The inner query object of the NOT IN statement
     */
    public function useNotInCustomerGroupQuery($modelAlias = null, $queryClass = null)
    {
        /** @var $q \Orm\Zed\CustomerGroup\Persistence\SpyCustomerGroupQuery */
        $q = $this->useInQuery('CustomerGroup', $modelAlias, $queryClass, 'NOT IN');
        return $q;
    }
    ...
    {
        $this->addUsingAlias(SpyCustomerGroupToCustomerTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addDescendingOrderByColumn(SpyCustomerGroupToCustomerTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addAscendingOrderByColumn(SpyCustomerGroupToCustomerTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addDescendingOrderByColumn(SpyCustomerGroupToCustomerTableMap::COL_CREATED_AT);
    ...
    {
        $this->addUsingAlias(SpyCustomerGroupToCustomerTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addAscendingOrderByColumn(SpyCustomerGroupToCustomerTableMap::COL_CREATED_AT);
