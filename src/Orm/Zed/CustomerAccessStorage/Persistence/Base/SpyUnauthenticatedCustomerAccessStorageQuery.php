 ...
 *
 * @method     ChildSpyUnauthenticatedCustomerAccessStorage[]|Collection find(?ConnectionInterface $con = null) Return ChildSpyUnauthenticatedCustomerAccessStorage objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpyUnauthenticatedCustomerAccessStorage> find(?ConnectionInterface $con = null) Return ChildSpyUnauthenticatedCustomerAccessStorage objects based on current ModelCriteria
 *
 * @method     ChildSpyUnauthenticatedCustomerAccessStorage[]|Collection findByIdUnauthenticatedCustomerAccessStorage(int|array<int> $id_unauthenticated_customer_access_storage) Return ChildSpyUnauthenticatedCustomerAccessStorage objects filtered by the id_unauthenticated_customer_access_storage column
 * @psalm-method Collection&\Traversable<ChildSpyUnauthenticatedCustomerAccessStorage> findByIdUnauthenticatedCustomerAccessStorage(int|array<int> $id_unauthenticated_customer_access_storage) Return ChildSpyUnauthenticatedCustomerAccessStorage objects filtered by the id_unauthenticated_customer_access_storage column
 * @method     ChildSpyUnauthenticatedCustomerAccessStorage[]|Collection findByData(string|array<string> $data) Return ChildSpyUnauthenticatedCustomerAccessStorage objects filtered by the data column
 * @psalm-method Collection&\Traversable<ChildSpyUnauthenticatedCustomerAccessStorage> findByData(string|array<string> $data) Return ChildSpyUnauthenticatedCustomerAccessStorage objects filtered by the data column
 * @method     ChildSpyUnauthenticatedCustomerAccessStorage[]|Collection findByKey(string|array<string> $key) Return ChildSpyUnauthenticatedCustomerAccessStorage objects filtered by the key column
 * @psalm-method Collection&\Traversable<ChildSpyUnauthenticatedCustomerAccessStorage> findByKey(string|array<string> $key) Return ChildSpyUnauthenticatedCustomerAccessStorage objects filtered by the key column
 * @method     ChildSpyUnauthenticatedCustomerAccessStorage[]|Collection findByAliasKeys(string|array<string> $alias_keys) Return ChildSpyUnauthenticatedCustomerAccessStorage objects filtered by the alias_keys column
 * @psalm-method Collection&\Traversable<ChildSpyUnauthenticatedCustomerAccessStorage> findByAliasKeys(string|array<string> $alias_keys) Return ChildSpyUnauthenticatedCustomerAccessStorage objects filtered by the alias_keys column
 * @method     ChildSpyUnauthenticatedCustomerAccessStorage[]|Collection findByCreatedAt(string|array<string> $created_at) Return ChildSpyUnauthenticatedCustomerAccessStorage objects filtered by the created_at column
 * @psalm-method Collection&\Traversable<ChildSpyUnauthenticatedCustomerAccessStorage> findByCreatedAt(string|array<string> $created_at) Return ChildSpyUnauthenticatedCustomerAccessStorage objects filtered by the created_at column
 * @method     ChildSpyUnauthenticatedCustomerAccessStorage[]|Collection findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyUnauthenticatedCustomerAccessStorage objects filtered by the updated_at column
 * @psalm-method Collection&\Traversable<ChildSpyUnauthenticatedCustomerAccessStorage> findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyUnauthenticatedCustomerAccessStorage objects filtered by the updated_at column
 *
...
abstract class SpyUnauthenticatedCustomerAccessStorageQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SpyUnauthenticatedCustomerAccessStorageTableMap::COL_ID_UNAUTHENTICATED_CUSTOMER_ACCESS_STORAGE, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SpyUnauthenticatedCustomerAccessStorageTableMap::COL_ID_UNAUTHENTICATED_CUSTOMER_ACCESS_STORAGE, $keys, Criteria::IN);
    ...
    {
        $this->addUsingAlias(SpyUnauthenticatedCustomerAccessStorageTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addDescendingOrderByColumn(SpyUnauthenticatedCustomerAccessStorageTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addAscendingOrderByColumn(SpyUnauthenticatedCustomerAccessStorageTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addDescendingOrderByColumn(SpyUnauthenticatedCustomerAccessStorageTableMap::COL_CREATED_AT);
    ...
    {
        $this->addUsingAlias(SpyUnauthenticatedCustomerAccessStorageTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addAscendingOrderByColumn(SpyUnauthenticatedCustomerAccessStorageTableMap::COL_CREATED_AT);
