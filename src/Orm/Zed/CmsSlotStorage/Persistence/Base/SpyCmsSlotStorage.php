...
abstract class SpyCmsSlotStorage implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Orm\\Zed\\CmsSlotStorage\\Persistence\\Map\\SpyCmsSlotStorageTableMap';
    ...
    protected function sendToBuffer(array $message): void
    {
        ...
        $synchronizationMessageTransfer->setResource('cms_slot');
