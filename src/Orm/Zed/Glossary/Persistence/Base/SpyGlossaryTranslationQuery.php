 ...
 *
 * @method     ChildSpyGlossaryTranslation[]|Collection findByIdGlossaryTranslation(int|array<int> $id_glossary_translation) Return ChildSpyGlossaryTranslation objects filtered by the id_glossary_translation column
 * @psalm-method Collection&\Traversable<ChildSpyGlossaryTranslation> findByIdGlossaryTranslation(int|array<int> $id_glossary_translation) Return ChildSpyGlossaryTranslation objects filtered by the id_glossary_translation column
 * @method     ChildSpyGlossaryTranslation[]|Collection findByFkGlossaryKey(int|array<int> $fk_glossary_key) Return ChildSpyGlossaryTranslation objects filtered by the fk_glossary_key column
 * @psalm-method Collection&\Traversable<ChildSpyGlossaryTranslation> findByFkGlossaryKey(int|array<int> $fk_glossary_key) Return ChildSpyGlossaryTranslation objects filtered by the fk_glossary_key column
 * @method     ChildSpyGlossaryTranslation[]|Collection findByFkLocale(int|array<int> $fk_locale) Return ChildSpyGlossaryTranslation objects filtered by the fk_locale column
 * @psalm-method Collection&\Traversable<ChildSpyGlossaryTranslation> findByFkLocale(int|array<int> $fk_locale) Return ChildSpyGlossaryTranslation objects filtered by the fk_locale column
 * @method     ChildSpyGlossaryTranslation[]|Collection findByIsActive(boolean|array<boolean> $is_active) Return ChildSpyGlossaryTranslation objects filtered by the is_active column
 * @psalm-method Collection&\Traversable<ChildSpyGlossaryTranslation> findByIsActive(boolean|array<boolean> $is_active) Return ChildSpyGlossaryTranslation objects filtered by the is_active column
 * @method     ChildSpyGlossaryTranslation[]|Collection findByValue(string|array<string> $value) Return ChildSpyGlossaryTranslation objects filtered by the value column
 * @psalm-method Collection&\Traversable<ChildSpyGlossaryTranslation> findByValue(string|array<string> $value) Return ChildSpyGlossaryTranslation objects filtered by the value column
 *
