...
abstract class SpyGlossaryKey implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Orm\\Zed\\Glossary\\Persistence\\Map\\SpyGlossaryKeyTableMap';
     ...
     */
    protected function doAddSpyCmsGlossaryKeyMapping(SpyCmsGlossaryKeyMapping $spyCmsGlossaryKeyMapping): void
    {
     ...
     */
    protected function doAddSpyCmsBlockGlossaryKeyMapping(SpyCmsBlockGlossaryKeyMapping $spyCmsBlockGlossaryKeyMapping): void
    {
     ...
     */
    protected function doAddSpyGlossaryTranslation(ChildSpyGlossaryTranslation $spyGlossaryTranslation): void
    {
