...
class SpyGlossaryKeyTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'src.Orm.Zed.Glossary.Persistence.Map.SpyGlossaryKeyTableMap';
     ...
     */
    public const TABLE_PHP_NAME = 'SpyGlossaryKey';
     ...
     */
    public const CLASS_DEFAULT = 'src.Orm.Zed.Glossary.Persistence.SpyGlossaryKey';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdGlossaryKey', 'IsActive', 'Key', ],
        self::TYPE_CAMELNAME     => ['idGlossaryKey', 'isActive', 'key', ],
        self::TYPE_COLNAME       => [SpyGlossaryKeyTableMap::COL_ID_GLOSSARY_KEY, SpyGlossaryKeyTableMap::COL_IS_ACTIVE, SpyGlossaryKeyTableMap::COL_KEY, ],
        self::TYPE_FIELDNAME     => ['id_glossary_key', 'is_active', 'key', ],
        self::TYPE_NUM           => [0, 1, 2, ]
    ];
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdGlossaryKey' => 0, 'IsActive' => 1, 'Key' => 2, ],
        self::TYPE_CAMELNAME     => ['idGlossaryKey' => 0, 'isActive' => 1, 'key' => 2, ],
        self::TYPE_COLNAME       => [SpyGlossaryKeyTableMap::COL_ID_GLOSSARY_KEY => 0, SpyGlossaryKeyTableMap::COL_IS_ACTIVE => 1, SpyGlossaryKeyTableMap::COL_KEY => 2, ],
        self::TYPE_FIELDNAME     => ['id_glossary_key' => 0, 'is_active' => 1, 'key' => 2, ],
        self::TYPE_NUM           => [0, 1, 2, ]
    ];
