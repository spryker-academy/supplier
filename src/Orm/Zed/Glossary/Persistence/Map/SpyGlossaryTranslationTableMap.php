...
class SpyGlossaryTranslationTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'src.Orm.Zed.Glossary.Persistence.Map.SpyGlossaryTranslationTableMap';
     ...
     */
    public const TABLE_PHP_NAME = 'SpyGlossaryTranslation';
     ...
     */
    public const CLASS_DEFAULT = 'src.Orm.Zed.Glossary.Persistence.SpyGlossaryTranslation';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdGlossaryTranslation', 'FkGlossaryKey', 'FkLocale', 'IsActive', 'Value', ],
        self::TYPE_CAMELNAME     => ['idGlossaryTranslation', 'fkGlossaryKey', 'fkLocale', 'isActive', 'value', ],
        self::TYPE_COLNAME       => [SpyGlossaryTranslationTableMap::COL_ID_GLOSSARY_TRANSLATION, SpyGlossaryTranslationTableMap::COL_FK_GLOSSARY_KEY, SpyGlossaryTranslationTableMap::COL_FK_LOCALE, SpyGlossaryTranslationTableMap::COL_IS_ACTIVE, SpyGlossaryTranslationTableMap::COL_VALUE, ],
        self::TYPE_FIELDNAME     => ['id_glossary_translation', 'fk_glossary_key', 'fk_locale', 'is_active', 'value', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdGlossaryTranslation' => 0, 'FkGlossaryKey' => 1, 'FkLocale' => 2, 'IsActive' => 3, 'Value' => 4, ],
        self::TYPE_CAMELNAME     => ['idGlossaryTranslation' => 0, 'fkGlossaryKey' => 1, 'fkLocale' => 2, 'isActive' => 3, 'value' => 4, ],
        self::TYPE_COLNAME       => [SpyGlossaryTranslationTableMap::COL_ID_GLOSSARY_TRANSLATION => 0, SpyGlossaryTranslationTableMap::COL_FK_GLOSSARY_KEY => 1, SpyGlossaryTranslationTableMap::COL_FK_LOCALE => 2, SpyGlossaryTranslationTableMap::COL_IS_ACTIVE => 3, SpyGlossaryTranslationTableMap::COL_VALUE => 4, ],
        self::TYPE_FIELDNAME     => ['id_glossary_translation' => 0, 'fk_glossary_key' => 1, 'fk_locale' => 2, 'is_active' => 3, 'value' => 4, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, ]
    ];
