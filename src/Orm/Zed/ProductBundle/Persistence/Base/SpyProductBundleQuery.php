 ...
 *
 * @method     ChildSpyProductBundleQuery leftJoinBundledProduct($relationAlias = null) Adds a LEFT JOIN clause to the query using the BundledProduct relation
 * @method     ChildSpyProductBundleQuery rightJoinBundledProduct($relationAlias = null) Adds a RIGHT JOIN clause to the query using the BundledProduct relation
 * @method     ChildSpyProductBundleQuery innerJoinBundledProduct($relationAlias = null) Adds a INNER JOIN clause to the query using the BundledProduct relation
 *
 * @method     ChildSpyProductBundleQuery joinWithBundledProduct($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the BundledProduct relation
 *
 * @method     ChildSpyProductBundleQuery leftJoinWithBundledProduct() Adds a LEFT JOIN clause and with to the query using the BundledProduct relation
 * @method     ChildSpyProductBundleQuery rightJoinWithBundledProduct() Adds a RIGHT JOIN clause and with to the query using the BundledProduct relation
 * @method     ChildSpyProductBundleQuery innerJoinWithBundledProduct() Adds a INNER JOIN clause and with to the query using the BundledProduct relation
 *
...
abstract class SpyProductBundleQuery extends ModelCriteria
{
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterByBundledProduct($spyProduct, ?string $comparison = null)
    {
        if ($spyProduct instanceof \Orm\Zed\Product\Persistence\SpyProduct) {
            ...
            throw new PropelException('filterByBundledProduct() only accepts arguments of type \Orm\Zed\Product\Persistence\SpyProduct or Collection');
        }
    }
    ...
    /**
     * Use the BundledProduct relation SpyProduct object
     *
     * @see useQuery()
     *
    ...
    public function useBundledProductQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'BundledProduct', '\Orm\Zed\Product\Persistence\SpyProductQuery');
    }
    ...
    /**
     * Use the BundledProduct relation to the SpyProduct table for an EXISTS query.
     *
    ...
    /**
     * Use the BundledProduct relation to the SpyProduct table for a NOT EXISTS query.
     *
    ...
    /**
     * Use the BundledProduct relation to the SpyProduct table for an IN query.
     *
    ...
    /**
     * Use the BundledProduct relation to the SpyProduct table for a NOT IN query.
     *
