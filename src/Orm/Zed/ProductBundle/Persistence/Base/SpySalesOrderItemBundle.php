...
abstract class SpySalesOrderItemBundle implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Orm\\Zed\\ProductBundle\\Persistence\\Map\\SpySalesOrderItemBundleTableMap';
     ...
     * @return void
     */
    public function resetPartialSalesOrderItems($v = true): void
    {
     ...
     * @return void
     */
    public function initSalesOrderItems(bool $overrideExisting = true): void
    {
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function countSalesOrderItems(?Criteria $criteria = null, bool $distinct = false, ?ConnectionInterface $con = null): int
    {
        $partial = $this->collSalesOrderItemsPartial && !$this->isNew();
        if (null === $this->collSalesOrderItems || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSalesOrderItem(SpySalesOrderItem $salesOrderItem): void
    {
