...
class SpyUnauthenticatedCustomerAccessTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'src.Orm.Zed.CustomerAccess.Persistence.Map.SpyUnauthenticatedCustomerAccessTableMap';
     ...
     */
    public const TABLE_NAME = 'spy_unauthenticated_customer_access';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'SpyUnauthenticatedCustomerAccess';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\Orm\\Zed\\CustomerAccess\\Persistence\\SpyUnauthenticatedCustomerAccess';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'src.Orm.Zed.CustomerAccess.Persistence.SpyUnauthenticatedCustomerAccess';
     ...
     */
    public const COL_ID_UNAUTHENTICATED_CUSTOMER_ACCESS = 'spy_unauthenticated_customer_access.id_unauthenticated_customer_access';

    /**
     * the column name for the content_type field
     */
    public const COL_CONTENT_TYPE = 'spy_unauthenticated_customer_access.content_type';

    /**
     * the column name for the is_restricted field
     */
    public const COL_IS_RESTRICTED = 'spy_unauthenticated_customer_access.is_restricted';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdUnauthenticatedCustomerAccess', 'ContentType', 'IsRestricted', ],
        self::TYPE_CAMELNAME     => ['idUnauthenticatedCustomerAccess', 'contentType', 'isRestricted', ],
        self::TYPE_COLNAME       => [SpyUnauthenticatedCustomerAccessTableMap::COL_ID_UNAUTHENTICATED_CUSTOMER_ACCESS, SpyUnauthenticatedCustomerAccessTableMap::COL_CONTENT_TYPE, SpyUnauthenticatedCustomerAccessTableMap::COL_IS_RESTRICTED, ],
        self::TYPE_FIELDNAME     => ['id_unauthenticated_customer_access', 'content_type', 'is_restricted', ],
        self::TYPE_NUM           => [0, 1, 2, ]
    ];
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdUnauthenticatedCustomerAccess' => 0, 'ContentType' => 1, 'IsRestricted' => 2, ],
        self::TYPE_CAMELNAME     => ['idUnauthenticatedCustomerAccess' => 0, 'contentType' => 1, 'isRestricted' => 2, ],
        self::TYPE_COLNAME       => [SpyUnauthenticatedCustomerAccessTableMap::COL_ID_UNAUTHENTICATED_CUSTOMER_ACCESS => 0, SpyUnauthenticatedCustomerAccessTableMap::COL_CONTENT_TYPE => 1, SpyUnauthenticatedCustomerAccessTableMap::COL_IS_RESTRICTED => 2, ],
        self::TYPE_FIELDNAME     => ['id_unauthenticated_customer_access' => 0, 'content_type' => 1, 'is_restricted' => 2, ],
        self::TYPE_NUM           => [0, 1, 2, ]
    ];
