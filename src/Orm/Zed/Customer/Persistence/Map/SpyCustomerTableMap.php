...
class SpyCustomerTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'src.Orm.Zed.Customer.Persistence.Map.SpyCustomerTableMap';
     ...
     */
    public const TABLE_PHP_NAME = 'SpyCustomer';
     ...
     */
    public const CLASS_DEFAULT = 'src.Orm.Zed.Customer.Persistence.SpyCustomer';
     ...
     */
    public const COL_FK_USER = 'spy_customer.fk_user';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdCustomer', 'FkLocale', 'FkUser', 'AnonymizedAt', 'Company', 'CustomerReference', 'DateOfBirth', 'DefaultBillingAddress', 'DefaultShippingAddress', 'Email', 'FirstName', 'Gender', 'LastName', 'Password', 'Phone', 'Registered', 'RegistrationKey', 'RestorePasswordDate', 'RestorePasswordKey', 'Salutation', 'CreatedAt', 'UpdatedAt', ],
        self::TYPE_CAMELNAME     => ['idCustomer', 'fkLocale', 'fkUser', 'anonymizedAt', 'company', 'customerReference', 'dateOfBirth', 'defaultBillingAddress', 'defaultShippingAddress', 'email', 'firstName', 'gender', 'lastName', 'password', 'phone', 'registered', 'registrationKey', 'restorePasswordDate', 'restorePasswordKey', 'salutation', 'createdAt', 'updatedAt', ],
        self::TYPE_COLNAME       => [SpyCustomerTableMap::COL_ID_CUSTOMER, SpyCustomerTableMap::COL_FK_LOCALE, SpyCustomerTableMap::COL_FK_USER, SpyCustomerTableMap::COL_ANONYMIZED_AT, SpyCustomerTableMap::COL_COMPANY, SpyCustomerTableMap::COL_CUSTOMER_REFERENCE, SpyCustomerTableMap::COL_DATE_OF_BIRTH, SpyCustomerTableMap::COL_DEFAULT_BILLING_ADDRESS, SpyCustomerTableMap::COL_DEFAULT_SHIPPING_ADDRESS, SpyCustomerTableMap::COL_EMAIL, SpyCustomerTableMap::COL_FIRST_NAME, SpyCustomerTableMap::COL_GENDER, SpyCustomerTableMap::COL_LAST_NAME, SpyCustomerTableMap::COL_PASSWORD, SpyCustomerTableMap::COL_PHONE, SpyCustomerTableMap::COL_REGISTERED, SpyCustomerTableMap::COL_REGISTRATION_KEY, SpyCustomerTableMap::COL_RESTORE_PASSWORD_DATE, SpyCustomerTableMap::COL_RESTORE_PASSWORD_KEY, SpyCustomerTableMap::COL_SALUTATION, SpyCustomerTableMap::COL_CREATED_AT, SpyCustomerTableMap::COL_UPDATED_AT, ],
        self::TYPE_FIELDNAME     => ['id_customer', 'fk_locale', 'fk_user', 'anonymized_at', 'company', 'customer_reference', 'date_of_birth', 'default_billing_address', 'default_shipping_address', 'email', 'first_name', 'gender', 'last_name', 'password', 'phone', 'registered', 'registration_key', 'restore_password_date', 'restore_password_key', 'salutation', 'created_at', 'updated_at', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdCustomer' => 0, 'FkLocale' => 1, 'FkUser' => 2, 'AnonymizedAt' => 3, 'Company' => 4, 'CustomerReference' => 5, 'DateOfBirth' => 6, 'DefaultBillingAddress' => 7, 'DefaultShippingAddress' => 8, 'Email' => 9, 'FirstName' => 10, 'Gender' => 11, 'LastName' => 12, 'Password' => 13, 'Phone' => 14, 'Registered' => 15, 'RegistrationKey' => 16, 'RestorePasswordDate' => 17, 'RestorePasswordKey' => 18, 'Salutation' => 19, 'CreatedAt' => 20, 'UpdatedAt' => 21, ],
        self::TYPE_CAMELNAME     => ['idCustomer' => 0, 'fkLocale' => 1, 'fkUser' => 2, 'anonymizedAt' => 3, 'company' => 4, 'customerReference' => 5, 'dateOfBirth' => 6, 'defaultBillingAddress' => 7, 'defaultShippingAddress' => 8, 'email' => 9, 'firstName' => 10, 'gender' => 11, 'lastName' => 12, 'password' => 13, 'phone' => 14, 'registered' => 15, 'registrationKey' => 16, 'restorePasswordDate' => 17, 'restorePasswordKey' => 18, 'salutation' => 19, 'createdAt' => 20, 'updatedAt' => 21, ],
  ...
  array (
    ...
    1 => ':id_customer',
        ...
        $this->addRelation('CustomerDataChangeRequest', '\\Orm\\Zed\\CustomerDataChangeRequest\\Persistence\\SpyCustomerDataChangeRequest', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':fk_customer',
    1 => ':id_customer',
  ),
), 'CASCADE', null, 'CustomerDataChangeRequests', false);
...
), null, null, 'SpyCustomerDiscounts', false);
  ...
  array (
    ...
    1 => ':id_customer',
        ...
        $this->addRelation('SpyCustomerMultiFactorAuth', '\\Orm\\Zed\\MultiFactorAuth\\Persistence\\SpyCustomerMultiFactorAuth', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':fk_customer',
    1 => ':id_customer',
  ),
), null, null, 'SpyCustomerMultiFactorAuths', false);
  ...
  array (
    ...
    public function getBehaviors(): array
    {
        return [
            ...
            'event' => ['spy_customer_anonymized_at' => ['column' => 'anonymized_at'], 'spy_customer_password' => ['column' => 'password']],
