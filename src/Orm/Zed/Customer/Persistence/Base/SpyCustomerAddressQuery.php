 ...
 *
 * @method     \Orm\Zed\Customer\Persistence\SpyCustomerQuery|\Orm\Zed\Country\Persistence\SpyRegionQuery|\Orm\Zed\Country\Persistence\SpyCountryQuery|\Orm\Zed\Customer\Persistence\SpyCustomerQuery|\Orm\Zed\Customer\Persistence\SpyCustomerQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 *
 * @method     ChildSpyCustomerAddress[]|Collection findByIdCustomerAddress(int|array<int> $id_customer_address) Return ChildSpyCustomerAddress objects filtered by the id_customer_address column
 * @psalm-method Collection&\Traversable<ChildSpyCustomerAddress> findByIdCustomerAddress(int|array<int> $id_customer_address) Return ChildSpyCustomerAddress objects filtered by the id_customer_address column
 * @method     ChildSpyCustomerAddress[]|Collection findByFkCountry(int|array<int> $fk_country) Return ChildSpyCustomerAddress objects filtered by the fk_country column
 * @psalm-method Collection&\Traversable<ChildSpyCustomerAddress> findByFkCountry(int|array<int> $fk_country) Return ChildSpyCustomerAddress objects filtered by the fk_country column
 * @method     ChildSpyCustomerAddress[]|Collection findByFkCustomer(int|array<int> $fk_customer) Return ChildSpyCustomerAddress objects filtered by the fk_customer column
 * @psalm-method Collection&\Traversable<ChildSpyCustomerAddress> findByFkCustomer(int|array<int> $fk_customer) Return ChildSpyCustomerAddress objects filtered by the fk_customer column
 * @method     ChildSpyCustomerAddress[]|Collection findByFkRegion(int|array<int> $fk_region) Return ChildSpyCustomerAddress objects filtered by the fk_region column
 * @psalm-method Collection&\Traversable<ChildSpyCustomerAddress> findByFkRegion(int|array<int> $fk_region) Return ChildSpyCustomerAddress objects filtered by the fk_region column
 * @method     ChildSpyCustomerAddress[]|Collection findByAddress1(string|array<string> $address1) Return ChildSpyCustomerAddress objects filtered by the address1 column
 * @psalm-method Collection&\Traversable<ChildSpyCustomerAddress> findByAddress1(string|array<string> $address1) Return ChildSpyCustomerAddress objects filtered by the address1 column
 * @method     ChildSpyCustomerAddress[]|Collection findByAddress2(string|array<string> $address2) Return ChildSpyCustomerAddress objects filtered by the address2 column
 * @psalm-method Collection&\Traversable<ChildSpyCustomerAddress> findByAddress2(string|array<string> $address2) Return ChildSpyCustomerAddress objects filtered by the address2 column
 * @method     ChildSpyCustomerAddress[]|Collection findByAddress3(string|array<string> $address3) Return ChildSpyCustomerAddress objects filtered by the address3 column
 * @psalm-method Collection&\Traversable<ChildSpyCustomerAddress> findByAddress3(string|array<string> $address3) Return ChildSpyCustomerAddress objects filtered by the address3 column
 * @method     ChildSpyCustomerAddress[]|Collection findByAnonymizedAt(string|array<string> $anonymized_at) Return ChildSpyCustomerAddress objects filtered by the anonymized_at column
 * @psalm-method Collection&\Traversable<ChildSpyCustomerAddress> findByAnonymizedAt(string|array<string> $anonymized_at) Return ChildSpyCustomerAddress objects filtered by the anonymized_at column
 * @method     ChildSpyCustomerAddress[]|Collection findByCity(string|array<string> $city) Return ChildSpyCustomerAddress objects filtered by the city column
 * @psalm-method Collection&\Traversable<ChildSpyCustomerAddress> findByCity(string|array<string> $city) Return ChildSpyCustomerAddress objects filtered by the city column
 * @method     ChildSpyCustomerAddress[]|Collection findByComment(string|array<string> $comment) Return ChildSpyCustomerAddress objects filtered by the comment column
 * @psalm-method Collection&\Traversable<ChildSpyCustomerAddress> findByComment(string|array<string> $comment) Return ChildSpyCustomerAddress objects filtered by the comment column
 * @method     ChildSpyCustomerAddress[]|Collection findByCompany(string|array<string> $company) Return ChildSpyCustomerAddress objects filtered by the company column
 * @psalm-method Collection&\Traversable<ChildSpyCustomerAddress> findByCompany(string|array<string> $company) Return ChildSpyCustomerAddress objects filtered by the company column
 * @method     ChildSpyCustomerAddress[]|Collection findByDeletedAt(string|array<string> $deleted_at) Return ChildSpyCustomerAddress objects filtered by the deleted_at column
 * @psalm-method Collection&\Traversable<ChildSpyCustomerAddress> findByDeletedAt(string|array<string> $deleted_at) Return ChildSpyCustomerAddress objects filtered by the deleted_at column
 * @method     ChildSpyCustomerAddress[]|Collection findByFirstName(string|array<string> $first_name) Return ChildSpyCustomerAddress objects filtered by the first_name column
 * @psalm-method Collection&\Traversable<ChildSpyCustomerAddress> findByFirstName(string|array<string> $first_name) Return ChildSpyCustomerAddress objects filtered by the first_name column
 * @method     ChildSpyCustomerAddress[]|Collection findByLastName(string|array<string> $last_name) Return ChildSpyCustomerAddress objects filtered by the last_name column
 * @psalm-method Collection&\Traversable<ChildSpyCustomerAddress> findByLastName(string|array<string> $last_name) Return ChildSpyCustomerAddress objects filtered by the last_name column
 * @method     ChildSpyCustomerAddress[]|Collection findByPhone(string|array<string> $phone) Return ChildSpyCustomerAddress objects filtered by the phone column
 * @psalm-method Collection&\Traversable<ChildSpyCustomerAddress> findByPhone(string|array<string> $phone) Return ChildSpyCustomerAddress objects filtered by the phone column
 * @method     ChildSpyCustomerAddress[]|Collection findBySalutation(int|array<int> $salutation) Return ChildSpyCustomerAddress objects filtered by the salutation column
 * @psalm-method Collection&\Traversable<ChildSpyCustomerAddress> findBySalutation(int|array<int> $salutation) Return ChildSpyCustomerAddress objects filtered by the salutation column
 * @method     ChildSpyCustomerAddress[]|Collection findByUuid(string|array<string> $uuid) Return ChildSpyCustomerAddress objects filtered by the uuid column
 * @psalm-method Collection&\Traversable<ChildSpyCustomerAddress> findByUuid(string|array<string> $uuid) Return ChildSpyCustomerAddress objects filtered by the uuid column
 * @method     ChildSpyCustomerAddress[]|Collection findByZipCode(string|array<string> $zip_code) Return ChildSpyCustomerAddress objects filtered by the zip_code column
 * @psalm-method Collection&\Traversable<ChildSpyCustomerAddress> findByZipCode(string|array<string> $zip_code) Return ChildSpyCustomerAddress objects filtered by the zip_code column
 * @method     ChildSpyCustomerAddress[]|Collection findByCreatedAt(string|array<string> $created_at) Return ChildSpyCustomerAddress objects filtered by the created_at column
 * @psalm-method Collection&\Traversable<ChildSpyCustomerAddress> findByCreatedAt(string|array<string> $created_at) Return ChildSpyCustomerAddress objects filtered by the created_at column
 * @method     ChildSpyCustomerAddress[]|Collection findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyCustomerAddress objects filtered by the updated_at column
 * @psalm-method Collection&\Traversable<ChildSpyCustomerAddress> findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyCustomerAddress objects filtered by the updated_at column
 *
...
abstract class SpyCustomerAddressQuery extends ModelCriteria
{
    ...
    {
        /** @var $q \Orm\Zed\Customer\Persistence\SpyCustomerQuery */
        $q = $this->useExistsQuery('CustomerBillingAddress', $modelAlias, $queryClass, $typeOfExists);
        return $q;
    }
    ...
    {
        /** @var $q \Orm\Zed\Customer\Persistence\SpyCustomerQuery */
        $q = $this->useExistsQuery('CustomerBillingAddress', $modelAlias, $queryClass, 'NOT EXISTS');
        return $q;
    }

    /**
     * Use the CustomerBillingAddress relation to the SpyCustomer table for an IN query.
     *
     * @see \Propel\Runtime\ActiveQuery\ModelCriteria::useInQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     ...
     * @return \Orm\Zed\Customer\Persistence\SpyCustomerQuery The inner query object of the IN statement
     */
    public function useInCustomerBillingAddressQuery($modelAlias = null, $queryClass = null, $typeOfIn = 'IN')
    {
        /** @var $q \Orm\Zed\Customer\Persistence\SpyCustomerQuery */
        $q = $this->useInQuery('CustomerBillingAddress', $modelAlias, $queryClass, $typeOfIn);
        return $q;
    }

    /**
     * Use the CustomerBillingAddress relation to the SpyCustomer table for a NOT IN query.
     *
     * @see useCustomerBillingAddressInQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     * @param string|null $queryClass Allows to use a custom query class for the NOT IN query, like ExtendedBookQuery::class
     *
     * @return \Orm\Zed\Customer\Persistence\SpyCustomerQuery The inner query object of the NOT IN statement
     */
    public function useNotInCustomerBillingAddressQuery($modelAlias = null, $queryClass = null)
    {
        /** @var $q \Orm\Zed\Customer\Persistence\SpyCustomerQuery */
        $q = $this->useInQuery('CustomerBillingAddress', $modelAlias, $queryClass, 'NOT IN');
        return $q;
    }
    ...
    {
        /** @var $q \Orm\Zed\Customer\Persistence\SpyCustomerQuery */
        $q = $this->useExistsQuery('CustomerShippingAddress', $modelAlias, $queryClass, $typeOfExists);
        return $q;
    }
    ...
    {
        /** @var $q \Orm\Zed\Customer\Persistence\SpyCustomerQuery */
        $q = $this->useExistsQuery('CustomerShippingAddress', $modelAlias, $queryClass, 'NOT EXISTS');
        return $q;
    }

    /**
     * Use the CustomerShippingAddress relation to the SpyCustomer table for an IN query.
     *
     * @see \Propel\Runtime\ActiveQuery\ModelCriteria::useInQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     ...
     * @return \Orm\Zed\Customer\Persistence\SpyCustomerQuery The inner query object of the IN statement
     */
    public function useInCustomerShippingAddressQuery($modelAlias = null, $queryClass = null, $typeOfIn = 'IN')
    {
        /** @var $q \Orm\Zed\Customer\Persistence\SpyCustomerQuery */
        $q = $this->useInQuery('CustomerShippingAddress', $modelAlias, $queryClass, $typeOfIn);
        return $q;
    }

    /**
     * Use the CustomerShippingAddress relation to the SpyCustomer table for a NOT IN query.
     *
     * @see useCustomerShippingAddressInQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     * @param string|null $queryClass Allows to use a custom query class for the NOT IN query, like ExtendedBookQuery::class
     *
     * @return \Orm\Zed\Customer\Persistence\SpyCustomerQuery The inner query object of the NOT IN statement
     */
    public function useNotInCustomerShippingAddressQuery($modelAlias = null, $queryClass = null)
    {
        /** @var $q \Orm\Zed\Customer\Persistence\SpyCustomerQuery */
        $q = $this->useInQuery('CustomerShippingAddress', $modelAlias, $queryClass, 'NOT IN');
        return $q;
    }
