 ...
 *
 * @method     ChildSpyShipmentMethodStore[]|Collection find(?ConnectionInterface $con = null) Return ChildSpyShipmentMethodStore objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpyShipmentMethodStore> find(?ConnectionInterface $con = null) Return ChildSpyShipmentMethodStore objects based on current ModelCriteria
 *
 * @method     ChildSpyShipmentMethodStore[]|Collection findByIdShipmentMethodStore(int|array<int> $id_shipment_method_store) Return ChildSpyShipmentMethodStore objects filtered by the id_shipment_method_store column
 * @psalm-method Collection&\Traversable<ChildSpyShipmentMethodStore> findByIdShipmentMethodStore(int|array<int> $id_shipment_method_store) Return ChildSpyShipmentMethodStore objects filtered by the id_shipment_method_store column
 * @method     ChildSpyShipmentMethodStore[]|Collection findByFkShipmentMethod(int|array<int> $fk_shipment_method) Return ChildSpyShipmentMethodStore objects filtered by the fk_shipment_method column
 * @psalm-method Collection&\Traversable<ChildSpyShipmentMethodStore> findByFkShipmentMethod(int|array<int> $fk_shipment_method) Return ChildSpyShipmentMethodStore objects filtered by the fk_shipment_method column
 * @method     ChildSpyShipmentMethodStore[]|Collection findByFkStore(int|array<int> $fk_store) Return ChildSpyShipmentMethodStore objects filtered by the fk_store column
 * @psalm-method Collection&\Traversable<ChildSpyShipmentMethodStore> findByFkStore(int|array<int> $fk_store) Return ChildSpyShipmentMethodStore objects filtered by the fk_store column
 *
...
abstract class SpyShipmentMethodStoreQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SpyShipmentMethodStoreTableMap::COL_ID_SHIPMENT_METHOD_STORE, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SpyShipmentMethodStoreTableMap::COL_ID_SHIPMENT_METHOD_STORE, $keys, Criteria::IN);
