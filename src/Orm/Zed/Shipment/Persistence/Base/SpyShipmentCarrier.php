...
abstract class SpyShipmentCarrier implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Orm\\Zed\\Shipment\\Persistence\\Map\\SpyShipmentCarrierTableMap';
    ...
    {
        $this->_initialValues[SpyShipmentCarrierTableMap::COL_IS_ACTIVE] = $this->is_active;
     ...
     */
    protected function doAddShipmentMethods(ChildSpyShipmentMethod $shipmentMethods): void
    {
    ...
    {
        if ($this->isNew()) {
            $this->_eventName = 'Entity.spy_shipment_carrier.create';
        } else {
            $this->_eventName = 'Entity.spy_shipment_carrier.update';
        }
    ...
    protected function addSaveEventToMemory()
    {
        ...
        if ($this->_eventName !== 'Entity.spy_shipment_carrier.create') {
            if (!$this->_isModified) {
                return;
            }
    ...
    protected function addDeleteEventToMemory()
    {
        ...
        $data = [
            'name' => 'spy_shipment_carrier',
            'id' => !is_array($this->getPrimaryKey()) ? $this->getPrimaryKey() : null,
            'event' => 'Entity.spy_shipment_carrier.delete',
            'foreignKeys' => $this->getForeignKeys(),
            'additionalValues' => $this->getAdditionalValues(),
        ];
    ...
    {
        $eventColumns = [
                'spy_shipment_carrier.is_active' => [
                    'column' => 'is_active',
                ],
        ];
        ...
        foreach ($this->_modifiedColumns as $modifiedColumn) {
            if (isset($eventColumns[$modifiedColumn])) {
                ...
                $field = str_replace('spy_shipment_carrier.', '', $modifiedColumn);
                $after = $this->$field;
    ...
    protected function getAdditionalValues(): array
    {
        ...
        foreach ($this->getAdditionalValueColumnNames() as $additionalValueColumnName) {
            $field = str_replace('spy_shipment_carrier.', '', $additionalValueColumnName);
    ...
    {
        $columnType = SpyShipmentCarrierTableMap::getTableMap()->getColumn($column)->getType();
