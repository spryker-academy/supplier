...
class SpyCompanyUnitAddressLabelTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'src.Orm.Zed.CompanyUnitAddressLabel.Persistence.Map.SpyCompanyUnitAddressLabelTableMap';
     ...
     */
    public const TABLE_NAME = 'spy_company_unit_address_label';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'SpyCompanyUnitAddressLabel';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\Orm\\Zed\\CompanyUnitAddressLabel\\Persistence\\SpyCompanyUnitAddressLabel';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'src.Orm.Zed.CompanyUnitAddressLabel.Persistence.SpyCompanyUnitAddressLabel';
     ...
     */
    public const COL_ID_COMPANY_UNIT_ADDRESS_LABEL = 'spy_company_unit_address_label.id_company_unit_address_label';

    /**
     * the column name for the name field
     */
    public const COL_NAME = 'spy_company_unit_address_label.name';

    /**
     * the column name for the created_at field
     */
    public const COL_CREATED_AT = 'spy_company_unit_address_label.created_at';

    /**
     * the column name for the updated_at field
     */
    public const COL_UPDATED_AT = 'spy_company_unit_address_label.updated_at';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdCompanyUnitAddressLabel', 'Name', 'CreatedAt', 'UpdatedAt', ],
        self::TYPE_CAMELNAME     => ['idCompanyUnitAddressLabel', 'name', 'createdAt', 'updatedAt', ],
        self::TYPE_COLNAME       => [SpyCompanyUnitAddressLabelTableMap::COL_ID_COMPANY_UNIT_ADDRESS_LABEL, SpyCompanyUnitAddressLabelTableMap::COL_NAME, SpyCompanyUnitAddressLabelTableMap::COL_CREATED_AT, SpyCompanyUnitAddressLabelTableMap::COL_UPDATED_AT, ],
        self::TYPE_FIELDNAME     => ['id_company_unit_address_label', 'name', 'created_at', 'updated_at', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdCompanyUnitAddressLabel' => 0, 'Name' => 1, 'CreatedAt' => 2, 'UpdatedAt' => 3, ],
        self::TYPE_CAMELNAME     => ['idCompanyUnitAddressLabel' => 0, 'name' => 1, 'createdAt' => 2, 'updatedAt' => 3, ],
        self::TYPE_COLNAME       => [SpyCompanyUnitAddressLabelTableMap::COL_ID_COMPANY_UNIT_ADDRESS_LABEL => 0, SpyCompanyUnitAddressLabelTableMap::COL_NAME => 1, SpyCompanyUnitAddressLabelTableMap::COL_CREATED_AT => 2, SpyCompanyUnitAddressLabelTableMap::COL_UPDATED_AT => 3, ],
        self::TYPE_FIELDNAME     => ['id_company_unit_address_label' => 0, 'name' => 1, 'created_at' => 2, 'updated_at' => 3, ],
        self::TYPE_NUM           => [0, 1, 2, 3, ]
    ];
