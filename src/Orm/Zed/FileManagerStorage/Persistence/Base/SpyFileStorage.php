...
abstract class SpyFileStorage implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Orm\\Zed\\FileManagerStorage\\Persistence\\Map\\SpyFileStorageTableMap';
    ...
    protected function sendToBuffer(array $message): void
    {
        ...
        $synchronizationMessageTransfer->setResource('file');
