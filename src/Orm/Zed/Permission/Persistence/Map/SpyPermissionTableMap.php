...
class SpyPermissionTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'src.Orm.Zed.Permission.Persistence.Map.SpyPermissionTableMap';
     ...
     */
    public const TABLE_NAME = 'spy_permission';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'SpyPermission';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\Orm\\Zed\\Permission\\Persistence\\SpyPermission';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'src.Orm.Zed.Permission.Persistence.SpyPermission';
     ...
     */
    public const COL_ID_PERMISSION = 'spy_permission.id_permission';

    /**
     * the column name for the key field
     */
    public const COL_KEY = 'spy_permission.key';

    /**
     * the column name for the configuration_signature field
     */
    public const COL_CONFIGURATION_SIGNATURE = 'spy_permission.configuration_signature';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdPermission', 'Key', 'ConfigurationSignature', ],
        self::TYPE_CAMELNAME     => ['idPermission', 'key', 'configurationSignature', ],
        self::TYPE_COLNAME       => [SpyPermissionTableMap::COL_ID_PERMISSION, SpyPermissionTableMap::COL_KEY, SpyPermissionTableMap::COL_CONFIGURATION_SIGNATURE, ],
        self::TYPE_FIELDNAME     => ['id_permission', 'key', 'configuration_signature', ],
        self::TYPE_NUM           => [0, 1, 2, ]
    ];
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdPermission' => 0, 'Key' => 1, 'ConfigurationSignature' => 2, ],
        self::TYPE_CAMELNAME     => ['idPermission' => 0, 'key' => 1, 'configurationSignature' => 2, ],
        self::TYPE_COLNAME       => [SpyPermissionTableMap::COL_ID_PERMISSION => 0, SpyPermissionTableMap::COL_KEY => 1, SpyPermissionTableMap::COL_CONFIGURATION_SIGNATURE => 2, ],
        self::TYPE_FIELDNAME     => ['id_permission' => 0, 'key' => 1, 'configuration_signature' => 2, ],
        self::TYPE_NUM           => [0, 1, 2, ]
    ];
