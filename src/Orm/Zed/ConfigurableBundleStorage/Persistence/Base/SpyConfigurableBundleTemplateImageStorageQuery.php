 ...
 *
 * @method     ChildSpyConfigurableBundleTemplateImageStorage[]|Collection find(?ConnectionInterface $con = null) Return ChildSpyConfigurableBundleTemplateImageStorage objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpyConfigurableBundleTemplateImageStorage> find(?ConnectionInterface $con = null) Return ChildSpyConfigurableBundleTemplateImageStorage objects based on current ModelCriteria
 *
 * @method     ChildSpyConfigurableBundleTemplateImageStorage[]|Collection findByIdConfigurableBundleTemplateImageStorage(string|array<string> $id_configurable_bundle_template_image_storage) Return ChildSpyConfigurableBundleTemplateImageStorage objects filtered by the id_configurable_bundle_template_image_storage column
 * @psalm-method Collection&\Traversable<ChildSpyConfigurableBundleTemplateImageStorage> findByIdConfigurableBundleTemplateImageStorage(string|array<string> $id_configurable_bundle_template_image_storage) Return ChildSpyConfigurableBundleTemplateImageStorage objects filtered by the id_configurable_bundle_template_image_storage column
 * @method     ChildSpyConfigurableBundleTemplateImageStorage[]|Collection findByFkConfigurableBundleTemplate(int|array<int> $fk_configurable_bundle_template) Return ChildSpyConfigurableBundleTemplateImageStorage objects filtered by the fk_configurable_bundle_template column
 * @psalm-method Collection&\Traversable<ChildSpyConfigurableBundleTemplateImageStorage> findByFkConfigurableBundleTemplate(int|array<int> $fk_configurable_bundle_template) Return ChildSpyConfigurableBundleTemplateImageStorage objects filtered by the fk_configurable_bundle_template column
 * @method     ChildSpyConfigurableBundleTemplateImageStorage[]|Collection findByData(string|array<string> $data) Return ChildSpyConfigurableBundleTemplateImageStorage objects filtered by the data column
 * @psalm-method Collection&\Traversable<ChildSpyConfigurableBundleTemplateImageStorage> findByData(string|array<string> $data) Return ChildSpyConfigurableBundleTemplateImageStorage objects filtered by the data column
 * @method     ChildSpyConfigurableBundleTemplateImageStorage[]|Collection findByKey(string|array<string> $key) Return ChildSpyConfigurableBundleTemplateImageStorage objects filtered by the key column
 * @psalm-method Collection&\Traversable<ChildSpyConfigurableBundleTemplateImageStorage> findByKey(string|array<string> $key) Return ChildSpyConfigurableBundleTemplateImageStorage objects filtered by the key column
 * @method     ChildSpyConfigurableBundleTemplateImageStorage[]|Collection findByLocale(string|array<string> $locale) Return ChildSpyConfigurableBundleTemplateImageStorage objects filtered by the locale column
 * @psalm-method Collection&\Traversable<ChildSpyConfigurableBundleTemplateImageStorage> findByLocale(string|array<string> $locale) Return ChildSpyConfigurableBundleTemplateImageStorage objects filtered by the locale column
 * @method     ChildSpyConfigurableBundleTemplateImageStorage[]|Collection findByAliasKeys(string|array<string> $alias_keys) Return ChildSpyConfigurableBundleTemplateImageStorage objects filtered by the alias_keys column
 * @psalm-method Collection&\Traversable<ChildSpyConfigurableBundleTemplateImageStorage> findByAliasKeys(string|array<string> $alias_keys) Return ChildSpyConfigurableBundleTemplateImageStorage objects filtered by the alias_keys column
 * @method     ChildSpyConfigurableBundleTemplateImageStorage[]|Collection findByCreatedAt(string|array<string> $created_at) Return ChildSpyConfigurableBundleTemplateImageStorage objects filtered by the created_at column
 * @psalm-method Collection&\Traversable<ChildSpyConfigurableBundleTemplateImageStorage> findByCreatedAt(string|array<string> $created_at) Return ChildSpyConfigurableBundleTemplateImageStorage objects filtered by the created_at column
 * @method     ChildSpyConfigurableBundleTemplateImageStorage[]|Collection findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyConfigurableBundleTemplateImageStorage objects filtered by the updated_at column
 * @psalm-method Collection&\Traversable<ChildSpyConfigurableBundleTemplateImageStorage> findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyConfigurableBundleTemplateImageStorage objects filtered by the updated_at column
 *
...
abstract class SpyConfigurableBundleTemplateImageStorageQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SpyConfigurableBundleTemplateImageStorageTableMap::COL_ID_CONFIGURABLE_BUNDLE_TEMPLATE_IMAGE_STORAGE, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SpyConfigurableBundleTemplateImageStorageTableMap::COL_ID_CONFIGURABLE_BUNDLE_TEMPLATE_IMAGE_STORAGE, $keys, Criteria::IN);
    ...
    {
        $this->addUsingAlias(SpyConfigurableBundleTemplateImageStorageTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addDescendingOrderByColumn(SpyConfigurableBundleTemplateImageStorageTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addAscendingOrderByColumn(SpyConfigurableBundleTemplateImageStorageTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addDescendingOrderByColumn(SpyConfigurableBundleTemplateImageStorageTableMap::COL_CREATED_AT);
    ...
    {
        $this->addUsingAlias(SpyConfigurableBundleTemplateImageStorageTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addAscendingOrderByColumn(SpyConfigurableBundleTemplateImageStorageTableMap::COL_CREATED_AT);
