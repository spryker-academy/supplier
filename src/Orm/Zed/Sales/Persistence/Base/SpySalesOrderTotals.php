...
abstract class SpySalesOrderTotals implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Orm\\Zed\\Sales\\Persistence\\Map\\SpySalesOrderTotalsTableMap';
    ...
    public function setMerchantCommissionRefundedTotal($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->merchant_commission_refunded_total !== $v) {
            ...
            $this->modifiedColumns[SpySalesOrderTotalsTableMap::COL_MERCHANT_COMMISSION_REFUNDED_TOTAL] = true;
        }
    ...
    public function setMerchantCommissionTotal($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->merchant_commission_total !== $v) {
            ...
            $this->modifiedColumns[SpySalesOrderTotalsTableMap::COL_MERCHANT_COMMISSION_TOTAL] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : SpySalesOrderTotalsTableMap::translateFieldName('MerchantCommissionRefundedTotal', TableMap::TYPE_PHPNAME, $indexType)];
            $this->merchant_commission_refunded_total = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : SpySalesOrderTotalsTableMap::translateFieldName('MerchantCommissionTotal', TableMap::TYPE_PHPNAME, $indexType)];
            $this->merchant_commission_total = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : SpySalesOrderTotalsTableMap::translateFieldName('OrderExpenseTotal', TableMap::TYPE_PHPNAME, $indexType)];
            $this->order_expense_total = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : SpySalesOrderTotalsTableMap::translateFieldName('RefundTotal', TableMap::TYPE_PHPNAME, $indexType)];
            $this->refund_total = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : SpySalesOrderTotalsTableMap::translateFieldName('Subtotal', TableMap::TYPE_PHPNAME, $indexType)];
            $this->subtotal = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : SpySalesOrderTotalsTableMap::translateFieldName('TaxTotal', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tax_total = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : SpySalesOrderTotalsTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : SpySalesOrderTotalsTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 13; // 13 = SpySalesOrderTotalsTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(SpySalesOrderTotalsTableMap::COL_MERCHANT_COMMISSION_REFUNDED_TOTAL)) {
            $modifiedColumns[':p' . $index++]  = 'merchant_commission_refunded_total';
        }
        if ($this->isColumnModified(SpySalesOrderTotalsTableMap::COL_MERCHANT_COMMISSION_TOTAL)) {
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(SpySalesOrderTotalsTableMap::COL_MERCHANT_COMMISSION_REFUNDED_TOTAL)) {
            $criteria->add(SpySalesOrderTotalsTableMap::COL_MERCHANT_COMMISSION_REFUNDED_TOTAL, $this->merchant_commission_refunded_total);
        }
        if ($this->isColumnModified(SpySalesOrderTotalsTableMap::COL_MERCHANT_COMMISSION_TOTAL)) {
            $criteria->add(SpySalesOrderTotalsTableMap::COL_MERCHANT_COMMISSION_TOTAL, $this->merchant_commission_total);
        }
        if ($this->isColumnModified(SpySalesOrderTotalsTableMap::COL_ORDER_EXPENSE_TOTAL)) {
