 ...
 *
 * @method     ChildSpySalesOrderComment[]|Collection find(?ConnectionInterface $con = null) Return ChildSpySalesOrderComment objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpySalesOrderComment> find(?ConnectionInterface $con = null) Return ChildSpySalesOrderComment objects based on current ModelCriteria
 *
 * @method     ChildSpySalesOrderComment[]|Collection findByIdSalesOrderComment(int|array<int> $id_sales_order_comment) Return ChildSpySalesOrderComment objects filtered by the id_sales_order_comment column
 * @psalm-method Collection&\Traversable<ChildSpySalesOrderComment> findByIdSalesOrderComment(int|array<int> $id_sales_order_comment) Return ChildSpySalesOrderComment objects filtered by the id_sales_order_comment column
 * @method     ChildSpySalesOrderComment[]|Collection findByFkSalesOrder(int|array<int> $fk_sales_order) Return ChildSpySalesOrderComment objects filtered by the fk_sales_order column
 * @psalm-method Collection&\Traversable<ChildSpySalesOrderComment> findByFkSalesOrder(int|array<int> $fk_sales_order) Return ChildSpySalesOrderComment objects filtered by the fk_sales_order column
 * @method     ChildSpySalesOrderComment[]|Collection findByMessage(string|array<string> $message) Return ChildSpySalesOrderComment objects filtered by the message column
 * @psalm-method Collection&\Traversable<ChildSpySalesOrderComment> findByMessage(string|array<string> $message) Return ChildSpySalesOrderComment objects filtered by the message column
 * @method     ChildSpySalesOrderComment[]|Collection findByUsername(string|array<string> $username) Return ChildSpySalesOrderComment objects filtered by the username column
 * @psalm-method Collection&\Traversable<ChildSpySalesOrderComment> findByUsername(string|array<string> $username) Return ChildSpySalesOrderComment objects filtered by the username column
 * @method     ChildSpySalesOrderComment[]|Collection findByCreatedAt(string|array<string> $created_at) Return ChildSpySalesOrderComment objects filtered by the created_at column
 * @psalm-method Collection&\Traversable<ChildSpySalesOrderComment> findByCreatedAt(string|array<string> $created_at) Return ChildSpySalesOrderComment objects filtered by the created_at column
 * @method     ChildSpySalesOrderComment[]|Collection findByUpdatedAt(string|array<string> $updated_at) Return ChildSpySalesOrderComment objects filtered by the updated_at column
 * @psalm-method Collection&\Traversable<ChildSpySalesOrderComment> findByUpdatedAt(string|array<string> $updated_at) Return ChildSpySalesOrderComment objects filtered by the updated_at column
 *
...
abstract class SpySalesOrderCommentQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SpySalesOrderCommentTableMap::COL_ID_SALES_ORDER_COMMENT, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SpySalesOrderCommentTableMap::COL_ID_SALES_ORDER_COMMENT, $keys, Criteria::IN);
    ...
    {
        $this->addUsingAlias(SpySalesOrderCommentTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addDescendingOrderByColumn(SpySalesOrderCommentTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addAscendingOrderByColumn(SpySalesOrderCommentTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addDescendingOrderByColumn(SpySalesOrderCommentTableMap::COL_CREATED_AT);
    ...
    {
        $this->addUsingAlias(SpySalesOrderCommentTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addAscendingOrderByColumn(SpySalesOrderCommentTableMap::COL_CREATED_AT);
