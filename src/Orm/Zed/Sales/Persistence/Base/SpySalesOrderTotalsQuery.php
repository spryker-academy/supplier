 ...
 * @method     ChildSpySalesOrderTotalsQuery orderByMerchantCommissionRefundedTotal($order = Criteria::ASC) Order by the merchant_commission_refunded_total column
 * @method     ChildSpySalesOrderTotalsQuery orderByMerchantCommissionTotal($order = Criteria::ASC) Order by the merchant_commission_total column
 ...
 * @method     ChildSpySalesOrderTotalsQuery groupByMerchantCommissionRefundedTotal() Group by the merchant_commission_refunded_total column
 * @method     ChildSpySalesOrderTotalsQuery groupByMerchantCommissionTotal() Group by the merchant_commission_total column
 ...
 * @method     ChildSpySalesOrderTotals|null findOneByMerchantCommissionRefundedTotal(int $merchant_commission_refunded_total) Return the first ChildSpySalesOrderTotals filtered by the merchant_commission_refunded_total column
 * @method     ChildSpySalesOrderTotals|null findOneByMerchantCommissionTotal(int $merchant_commission_total) Return the first ChildSpySalesOrderTotals filtered by the merchant_commission_total column
 ...
 * @method     ChildSpySalesOrderTotals requireOneByMerchantCommissionRefundedTotal(int $merchant_commission_refunded_total) Return the first ChildSpySalesOrderTotals filtered by the merchant_commission_refunded_total column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildSpySalesOrderTotals requireOneByMerchantCommissionTotal(int $merchant_commission_total) Return the first ChildSpySalesOrderTotals filtered by the merchant_commission_total column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 *
 * @method     ChildSpySalesOrderTotals[]|Collection find(?ConnectionInterface $con = null) Return ChildSpySalesOrderTotals objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpySalesOrderTotals> find(?ConnectionInterface $con = null) Return ChildSpySalesOrderTotals objects based on current ModelCriteria
 *
 * @method     ChildSpySalesOrderTotals[]|Collection findByIdSalesOrderTotals(int|array<int> $id_sales_order_totals) Return ChildSpySalesOrderTotals objects filtered by the id_sales_order_totals column
 * @psalm-method Collection&\Traversable<ChildSpySalesOrderTotals> findByIdSalesOrderTotals(int|array<int> $id_sales_order_totals) Return ChildSpySalesOrderTotals objects filtered by the id_sales_order_totals column
 * @method     ChildSpySalesOrderTotals[]|Collection findByFkSalesOrder(int|array<int> $fk_sales_order) Return ChildSpySalesOrderTotals objects filtered by the fk_sales_order column
 * @psalm-method Collection&\Traversable<ChildSpySalesOrderTotals> findByFkSalesOrder(int|array<int> $fk_sales_order) Return ChildSpySalesOrderTotals objects filtered by the fk_sales_order column
 * @method     ChildSpySalesOrderTotals[]|Collection findByCanceledTotal(int|array<int> $canceled_total) Return ChildSpySalesOrderTotals objects filtered by the canceled_total column
 * @psalm-method Collection&\Traversable<ChildSpySalesOrderTotals> findByCanceledTotal(int|array<int> $canceled_total) Return ChildSpySalesOrderTotals objects filtered by the canceled_total column
 * @method     ChildSpySalesOrderTotals[]|Collection findByDiscountTotal(int|array<int> $discount_total) Return ChildSpySalesOrderTotals objects filtered by the discount_total column
 * @psalm-method Collection&\Traversable<ChildSpySalesOrderTotals> findByDiscountTotal(int|array<int> $discount_total) Return ChildSpySalesOrderTotals objects filtered by the discount_total column
 * @method     ChildSpySalesOrderTotals[]|Collection findByGrandTotal(int|array<int> $grand_total) Return ChildSpySalesOrderTotals objects filtered by the grand_total column
 * @psalm-method Collection&\Traversable<ChildSpySalesOrderTotals> findByGrandTotal(int|array<int> $grand_total) Return ChildSpySalesOrderTotals objects filtered by the grand_total column
 * @method     ChildSpySalesOrderTotals[]|Collection findByMerchantCommissionRefundedTotal(int|array<int> $merchant_commission_refunded_total) Return ChildSpySalesOrderTotals objects filtered by the merchant_commission_refunded_total column
 * @psalm-method Collection&\Traversable<ChildSpySalesOrderTotals> findByMerchantCommissionRefundedTotal(int|array<int> $merchant_commission_refunded_total) Return ChildSpySalesOrderTotals objects filtered by the merchant_commission_refunded_total column
 * @method     ChildSpySalesOrderTotals[]|Collection findByMerchantCommissionTotal(int|array<int> $merchant_commission_total) Return ChildSpySalesOrderTotals objects filtered by the merchant_commission_total column
 * @psalm-method Collection&\Traversable<ChildSpySalesOrderTotals> findByMerchantCommissionTotal(int|array<int> $merchant_commission_total) Return ChildSpySalesOrderTotals objects filtered by the merchant_commission_total column
 * @method     ChildSpySalesOrderTotals[]|Collection findByOrderExpenseTotal(int|array<int> $order_expense_total) Return ChildSpySalesOrderTotals objects filtered by the order_expense_total column
 * @psalm-method Collection&\Traversable<ChildSpySalesOrderTotals> findByOrderExpenseTotal(int|array<int> $order_expense_total) Return ChildSpySalesOrderTotals objects filtered by the order_expense_total column
 * @method     ChildSpySalesOrderTotals[]|Collection findByRefundTotal(int|array<int> $refund_total) Return ChildSpySalesOrderTotals objects filtered by the refund_total column
 * @psalm-method Collection&\Traversable<ChildSpySalesOrderTotals> findByRefundTotal(int|array<int> $refund_total) Return ChildSpySalesOrderTotals objects filtered by the refund_total column
 * @method     ChildSpySalesOrderTotals[]|Collection findBySubtotal(int|array<int> $subtotal) Return ChildSpySalesOrderTotals objects filtered by the subtotal column
 * @psalm-method Collection&\Traversable<ChildSpySalesOrderTotals> findBySubtotal(int|array<int> $subtotal) Return ChildSpySalesOrderTotals objects filtered by the subtotal column
 * @method     ChildSpySalesOrderTotals[]|Collection findByTaxTotal(int|array<int> $tax_total) Return ChildSpySalesOrderTotals objects filtered by the tax_total column
 * @psalm-method Collection&\Traversable<ChildSpySalesOrderTotals> findByTaxTotal(int|array<int> $tax_total) Return ChildSpySalesOrderTotals objects filtered by the tax_total column
 * @method     ChildSpySalesOrderTotals[]|Collection findByCreatedAt(string|array<string> $created_at) Return ChildSpySalesOrderTotals objects filtered by the created_at column
 * @psalm-method Collection&\Traversable<ChildSpySalesOrderTotals> findByCreatedAt(string|array<string> $created_at) Return ChildSpySalesOrderTotals objects filtered by the created_at column
 * @method     ChildSpySalesOrderTotals[]|Collection findByUpdatedAt(string|array<string> $updated_at) Return ChildSpySalesOrderTotals objects filtered by the updated_at column
 * @psalm-method Collection&\Traversable<ChildSpySalesOrderTotals> findByUpdatedAt(string|array<string> $updated_at) Return ChildSpySalesOrderTotals objects filtered by the updated_at column
 *
...
abstract class SpySalesOrderTotalsQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id_sales_order_totals, fk_sales_order, canceled_total, discount_total, grand_total, merchant_commission_refunded_total, merchant_commission_total, order_expense_total, refund_total, subtotal, tax_total, created_at, updated_at FROM spy_sales_order_totals WHERE id_sales_order_totals = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SpySalesOrderTotalsTableMap::COL_ID_SALES_ORDER_TOTALS, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SpySalesOrderTotalsTableMap::COL_ID_SALES_ORDER_TOTALS, $keys, Criteria::IN);
    ...
    public function filterByMerchantCommissionRefundedTotal($merchantCommissionRefundedTotal = null, $comparison = Criteria::EQUAL)
    {
        ...
        if (is_array($merchantCommissionRefundedTotal)) {
            ...
            if (isset($merchantCommissionRefundedTotal['min'])) {
                ...
                $this->addUsingAlias(SpySalesOrderTotalsTableMap::COL_MERCHANT_COMMISSION_REFUNDED_TOTAL, $merchantCommissionRefundedTotal['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($merchantCommissionRefundedTotal['max'])) {
                ...
                $this->addUsingAlias(SpySalesOrderTotalsTableMap::COL_MERCHANT_COMMISSION_REFUNDED_TOTAL, $merchantCommissionRefundedTotal['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        $query = $this->addUsingAlias(SpySalesOrderTotalsTableMap::COL_MERCHANT_COMMISSION_REFUNDED_TOTAL, $merchantCommissionRefundedTotal, $comparison);
    ...
    public function filterByMerchantCommissionTotal($merchantCommissionTotal = null, $comparison = Criteria::EQUAL)
    {
        ...
        if (is_array($merchantCommissionTotal)) {
            ...
            if (isset($merchantCommissionTotal['min'])) {
                ...
                $this->addUsingAlias(SpySalesOrderTotalsTableMap::COL_MERCHANT_COMMISSION_TOTAL, $merchantCommissionTotal['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($merchantCommissionTotal['max'])) {
                ...
                $this->addUsingAlias(SpySalesOrderTotalsTableMap::COL_MERCHANT_COMMISSION_TOTAL, $merchantCommissionTotal['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        $query = $this->addUsingAlias(SpySalesOrderTotalsTableMap::COL_MERCHANT_COMMISSION_TOTAL, $merchantCommissionTotal, $comparison);
    ...
    {
        $this->addUsingAlias(SpySalesOrderTotalsTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addDescendingOrderByColumn(SpySalesOrderTotalsTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addAscendingOrderByColumn(SpySalesOrderTotalsTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addDescendingOrderByColumn(SpySalesOrderTotalsTableMap::COL_CREATED_AT);
    ...
    {
        $this->addUsingAlias(SpySalesOrderTotalsTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addAscendingOrderByColumn(SpySalesOrderTotalsTableMap::COL_CREATED_AT);
