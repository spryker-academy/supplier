...
class SpyGlossaryStorageTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'src.Orm.Zed.GlossaryStorage.Persistence.Map.SpyGlossaryStorageTableMap';
     ...
     */
    public const CLASS_DEFAULT = 'src.Orm.Zed.GlossaryStorage.Persistence.SpyGlossaryStorage';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdGlossaryStorage', 'FkGlossaryKey', 'Data', 'GlossaryKey', 'Key', 'Locale', 'AliasKeys', 'CreatedAt', 'UpdatedAt', ],
        self::TYPE_CAMELNAME     => ['idGlossaryStorage', 'fkGlossaryKey', 'data', 'glossaryKey', 'key', 'locale', 'aliasKeys', 'createdAt', 'updatedAt', ],
        self::TYPE_COLNAME       => [SpyGlossaryStorageTableMap::COL_ID_GLOSSARY_STORAGE, SpyGlossaryStorageTableMap::COL_FK_GLOSSARY_KEY, SpyGlossaryStorageTableMap::COL_DATA, SpyGlossaryStorageTableMap::COL_GLOSSARY_KEY, SpyGlossaryStorageTableMap::COL_KEY, SpyGlossaryStorageTableMap::COL_LOCALE, SpyGlossaryStorageTableMap::COL_ALIAS_KEYS, SpyGlossaryStorageTableMap::COL_CREATED_AT, SpyGlossaryStorageTableMap::COL_UPDATED_AT, ],
        self::TYPE_FIELDNAME     => ['id_glossary_storage', 'fk_glossary_key', 'data', 'glossary_key', 'key', 'locale', 'alias_keys', 'created_at', 'updated_at', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdGlossaryStorage' => 0, 'FkGlossaryKey' => 1, 'Data' => 2, 'GlossaryKey' => 3, 'Key' => 4, 'Locale' => 5, 'AliasKeys' => 6, 'CreatedAt' => 7, 'UpdatedAt' => 8, ],
        self::TYPE_CAMELNAME     => ['idGlossaryStorage' => 0, 'fkGlossaryKey' => 1, 'data' => 2, 'glossaryKey' => 3, 'key' => 4, 'locale' => 5, 'aliasKeys' => 6, 'createdAt' => 7, 'updatedAt' => 8, ],
        ...
        self::TYPE_FIELDNAME     => ['id_glossary_storage' => 0, 'fk_glossary_key' => 1, 'data' => 2, 'glossary_key' => 3, 'key' => 4, 'locale' => 5, 'alias_keys' => 6, 'created_at' => 7, 'updated_at' => 8, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, 5, 6, 7, 8, ]
    ];
