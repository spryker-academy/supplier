 ...
 *
 * @method     ChildSpyAvailabilityAbstract[]|Collection find(?ConnectionInterface $con = null) Return ChildSpyAvailabilityAbstract objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpyAvailabilityAbstract> find(?ConnectionInterface $con = null) Return ChildSpyAvailabilityAbstract objects based on current ModelCriteria
 *
 * @method     ChildSpyAvailabilityAbstract[]|Collection findByIdAvailabilityAbstract(int|array<int> $id_availability_abstract) Return ChildSpyAvailabilityAbstract objects filtered by the id_availability_abstract column
 * @psalm-method Collection&\Traversable<ChildSpyAvailabilityAbstract> findByIdAvailabilityAbstract(int|array<int> $id_availability_abstract) Return ChildSpyAvailabilityAbstract objects filtered by the id_availability_abstract column
 * @method     ChildSpyAvailabilityAbstract[]|Collection findByFkStore(int|array<int> $fk_store) Return ChildSpyAvailabilityAbstract objects filtered by the fk_store column
 * @psalm-method Collection&\Traversable<ChildSpyAvailabilityAbstract> findByFkStore(int|array<int> $fk_store) Return ChildSpyAvailabilityAbstract objects filtered by the fk_store column
 * @method     ChildSpyAvailabilityAbstract[]|Collection findByAbstractSku(string|array<string> $abstract_sku) Return ChildSpyAvailabilityAbstract objects filtered by the abstract_sku column
 * @psalm-method Collection&\Traversable<ChildSpyAvailabilityAbstract> findByAbstractSku(string|array<string> $abstract_sku) Return ChildSpyAvailabilityAbstract objects filtered by the abstract_sku column
 * @method     ChildSpyAvailabilityAbstract[]|Collection findByQuantity(string|array<string> $quantity) Return ChildSpyAvailabilityAbstract objects filtered by the quantity column
 * @psalm-method Collection&\Traversable<ChildSpyAvailabilityAbstract> findByQuantity(string|array<string> $quantity) Return ChildSpyAvailabilityAbstract objects filtered by the quantity column
 *
...
abstract class SpyAvailabilityAbstractQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SpyAvailabilityAbstractTableMap::COL_ID_AVAILABILITY_ABSTRACT, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SpyAvailabilityAbstractTableMap::COL_ID_AVAILABILITY_ABSTRACT, $keys, Criteria::IN);
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterBySpyAvailability($spyAvailability, ?string $comparison = null)
    {
     ...
     * @return $this The current query, for fluid interface
     */
    public function joinSpyAvailability(?string $relationAlias = null, ?string $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    public function useSpyAvailabilityExistsQuery($modelAlias = null, $queryClass = null, $typeOfExists = 'EXISTS')
    {
        ...
        $q = $this->useExistsQuery('SpyAvailability', $modelAlias, $queryClass, $typeOfExists);
        return $q;
    }
    ...
    {
        /** @var $q \Orm\Zed\Availability\Persistence\SpyAvailabilityQuery */
        $q = $this->useExistsQuery('SpyAvailability', $modelAlias, $queryClass, 'NOT EXISTS');
        return $q;
    }

    /**
     * Use the relation to SpyAvailability table for an IN query.
     *
     * @see \Propel\Runtime\ActiveQuery\ModelCriteria::useInQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     ...
     */
    public function useInSpyAvailabilityQuery($modelAlias = null, $queryClass = null, $typeOfIn = 'IN')
    {
        /** @var $q \Orm\Zed\Availability\Persistence\SpyAvailabilityQuery */
        $q = $this->useInQuery('SpyAvailability', $modelAlias, $queryClass, $typeOfIn);
        return $q;
    }

    /**
     * Use the relation to SpyAvailability table for a NOT IN query.
     *
     * @see useSpyAvailabilityInQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     * @param string|null $queryClass Allows to use a custom query class for the NOT IN query, like ExtendedBookQuery::class
     *
     ...
     */
    public function useNotInSpyAvailabilityQuery($modelAlias = null, $queryClass = null)
    {
        /** @var $q \Orm\Zed\Availability\Persistence\SpyAvailabilityQuery */
        $q = $this->useInQuery('SpyAvailability', $modelAlias, $queryClass, 'NOT IN');
        return $q;
    }
