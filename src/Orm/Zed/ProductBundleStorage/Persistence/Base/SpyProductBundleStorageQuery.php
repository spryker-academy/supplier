 ...
 *
 * @method     ChildSpyProductBundleStorage[]|Collection find(?ConnectionInterface $con = null) Return ChildSpyProductBundleStorage objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpyProductBundleStorage> find(?ConnectionInterface $con = null) Return ChildSpyProductBundleStorage objects based on current ModelCriteria
 *
 * @method     ChildSpyProductBundleStorage[]|Collection findByIdProductBundleStorage(int|array<int> $id_product_bundle_storage) Return ChildSpyProductBundleStorage objects filtered by the id_product_bundle_storage column
 * @psalm-method Collection&\Traversable<ChildSpyProductBundleStorage> findByIdProductBundleStorage(int|array<int> $id_product_bundle_storage) Return ChildSpyProductBundleStorage objects filtered by the id_product_bundle_storage column
 * @method     ChildSpyProductBundleStorage[]|Collection findByFkProduct(int|array<int> $fk_product) Return ChildSpyProductBundleStorage objects filtered by the fk_product column
 * @psalm-method Collection&\Traversable<ChildSpyProductBundleStorage> findByFkProduct(int|array<int> $fk_product) Return ChildSpyProductBundleStorage objects filtered by the fk_product column
 * @method     ChildSpyProductBundleStorage[]|Collection findByData(string|array<string> $data) Return ChildSpyProductBundleStorage objects filtered by the data column
 * @psalm-method Collection&\Traversable<ChildSpyProductBundleStorage> findByData(string|array<string> $data) Return ChildSpyProductBundleStorage objects filtered by the data column
 * @method     ChildSpyProductBundleStorage[]|Collection findByKey(string|array<string> $key) Return ChildSpyProductBundleStorage objects filtered by the key column
 * @psalm-method Collection&\Traversable<ChildSpyProductBundleStorage> findByKey(string|array<string> $key) Return ChildSpyProductBundleStorage objects filtered by the key column
 * @method     ChildSpyProductBundleStorage[]|Collection findByAliasKeys(string|array<string> $alias_keys) Return ChildSpyProductBundleStorage objects filtered by the alias_keys column
 * @psalm-method Collection&\Traversable<ChildSpyProductBundleStorage> findByAliasKeys(string|array<string> $alias_keys) Return ChildSpyProductBundleStorage objects filtered by the alias_keys column
 * @method     ChildSpyProductBundleStorage[]|Collection findByCreatedAt(string|array<string> $created_at) Return ChildSpyProductBundleStorage objects filtered by the created_at column
 * @psalm-method Collection&\Traversable<ChildSpyProductBundleStorage> findByCreatedAt(string|array<string> $created_at) Return ChildSpyProductBundleStorage objects filtered by the created_at column
 * @method     ChildSpyProductBundleStorage[]|Collection findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyProductBundleStorage objects filtered by the updated_at column
 * @psalm-method Collection&\Traversable<ChildSpyProductBundleStorage> findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyProductBundleStorage objects filtered by the updated_at column
 *
...
abstract class SpyProductBundleStorageQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SpyProductBundleStorageTableMap::COL_ID_PRODUCT_BUNDLE_STORAGE, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SpyProductBundleStorageTableMap::COL_ID_PRODUCT_BUNDLE_STORAGE, $keys, Criteria::IN);
    ...
    {
        $this->addUsingAlias(SpyProductBundleStorageTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addDescendingOrderByColumn(SpyProductBundleStorageTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addAscendingOrderByColumn(SpyProductBundleStorageTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addDescendingOrderByColumn(SpyProductBundleStorageTableMap::COL_CREATED_AT);
    ...
    {
        $this->addUsingAlias(SpyProductBundleStorageTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addAscendingOrderByColumn(SpyProductBundleStorageTableMap::COL_CREATED_AT);
