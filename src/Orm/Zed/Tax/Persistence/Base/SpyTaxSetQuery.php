 ...
 *
 * @method     ChildSpyTaxSet[]|Collection find(?ConnectionInterface $con = null) Return ChildSpyTaxSet objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpyTaxSet> find(?ConnectionInterface $con = null) Return ChildSpyTaxSet objects based on current ModelCriteria
 *
 * @method     ChildSpyTaxSet[]|Collection findByIdTaxSet(int|array<int> $id_tax_set) Return ChildSpyTaxSet objects filtered by the id_tax_set column
 * @psalm-method Collection&\Traversable<ChildSpyTaxSet> findByIdTaxSet(int|array<int> $id_tax_set) Return ChildSpyTaxSet objects filtered by the id_tax_set column
 * @method     ChildSpyTaxSet[]|Collection findByName(string|array<string> $name) Return ChildSpyTaxSet objects filtered by the name column
 * @psalm-method Collection&\Traversable<ChildSpyTaxSet> findByName(string|array<string> $name) Return ChildSpyTaxSet objects filtered by the name column
 * @method     ChildSpyTaxSet[]|Collection findByUuid(string|array<string> $uuid) Return ChildSpyTaxSet objects filtered by the uuid column
 * @psalm-method Collection&\Traversable<ChildSpyTaxSet> findByUuid(string|array<string> $uuid) Return ChildSpyTaxSet objects filtered by the uuid column
 * @method     ChildSpyTaxSet[]|Collection findByCreatedAt(string|array<string> $created_at) Return ChildSpyTaxSet objects filtered by the created_at column
 * @psalm-method Collection&\Traversable<ChildSpyTaxSet> findByCreatedAt(string|array<string> $created_at) Return ChildSpyTaxSet objects filtered by the created_at column
 * @method     ChildSpyTaxSet[]|Collection findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyTaxSet objects filtered by the updated_at column
 * @psalm-method Collection&\Traversable<ChildSpyTaxSet> findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyTaxSet objects filtered by the updated_at column
 *
...
abstract class SpyTaxSetQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SpyTaxSetTableMap::COL_ID_TAX_SET, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SpyTaxSetTableMap::COL_ID_TAX_SET, $keys, Criteria::IN);
     ...
     * @return $this The current query, for fluid interface
     */
    public function joinSpyProductOptionGroup(?string $relationAlias = null, ?string $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterBySpySalesOrderThresholdTaxSet($spySalesOrderThresholdTaxSet, ?string $comparison = null)
    {
     ...
     * @return $this The current query, for fluid interface
     */
    public function joinSpySalesOrderThresholdTaxSet(?string $relationAlias = null, ?string $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        /** @var $q \Orm\Zed\SalesOrderThreshold\Persistence\SpySalesOrderThresholdTaxSetQuery */
        $q = $this->useExistsQuery('SpySalesOrderThresholdTaxSet', $modelAlias, $queryClass, $typeOfExists);
        return $q;
    }
    ...
    {
        /** @var $q \Orm\Zed\SalesOrderThreshold\Persistence\SpySalesOrderThresholdTaxSetQuery */
        $q = $this->useExistsQuery('SpySalesOrderThresholdTaxSet', $modelAlias, $queryClass, 'NOT EXISTS');
        return $q;
    }

    /**
     * Use the relation to SpySalesOrderThresholdTaxSet table for an IN query.
     *
     * @see \Propel\Runtime\ActiveQuery\ModelCriteria::useInQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     ...
     * @param string $typeOfIn Criteria::IN or Criteria::NOT_IN
     *
     * @return \Orm\Zed\SalesOrderThreshold\Persistence\SpySalesOrderThresholdTaxSetQuery The inner query object of the IN statement
     */
    public function useInSpySalesOrderThresholdTaxSetQuery($modelAlias = null, $queryClass = null, $typeOfIn = 'IN')
    {
        /** @var $q \Orm\Zed\SalesOrderThreshold\Persistence\SpySalesOrderThresholdTaxSetQuery */
        $q = $this->useInQuery('SpySalesOrderThresholdTaxSet', $modelAlias, $queryClass, $typeOfIn);
        return $q;
    }

    /**
     * Use the relation to SpySalesOrderThresholdTaxSet table for a NOT IN query.
     *
     * @see useSpySalesOrderThresholdTaxSetInQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     * @param string|null $queryClass Allows to use a custom query class for the NOT IN query, like ExtendedBookQuery::class
     *
     * @return \Orm\Zed\SalesOrderThreshold\Persistence\SpySalesOrderThresholdTaxSetQuery The inner query object of the NOT IN statement
     */
    public function useNotInSpySalesOrderThresholdTaxSetQuery($modelAlias = null, $queryClass = null)
    {
        /** @var $q \Orm\Zed\SalesOrderThreshold\Persistence\SpySalesOrderThresholdTaxSetQuery */
        $q = $this->useInQuery('SpySalesOrderThresholdTaxSet', $modelAlias, $queryClass, 'NOT IN');
        return $q;
    }
     ...
     * @return $this The current query, for fluid interface
     */
    public function joinShipmentMethods(?string $relationAlias = null, ?string $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
    ...
    {
        $this->addUsingAlias(SpyTaxSetTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addDescendingOrderByColumn(SpyTaxSetTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addAscendingOrderByColumn(SpyTaxSetTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addDescendingOrderByColumn(SpyTaxSetTableMap::COL_CREATED_AT);
    ...
    {
        $this->addUsingAlias(SpyTaxSetTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addAscendingOrderByColumn(SpyTaxSetTableMap::COL_CREATED_AT);
