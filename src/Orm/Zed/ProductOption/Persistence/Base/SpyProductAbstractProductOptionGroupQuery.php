 ...
 *
 * @method     ChildSpyProductAbstractProductOptionGroup[]|Collection find(?ConnectionInterface $con = null) Return ChildSpyProductAbstractProductOptionGroup objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpyProductAbstractProductOptionGroup> find(?ConnectionInterface $con = null) Return ChildSpyProductAbstractProductOptionGroup objects based on current ModelCriteria
 *
 * @method     ChildSpyProductAbstractProductOptionGroup[]|Collection findByFkProductAbstract(int|array<int> $fk_product_abstract) Return ChildSpyProductAbstractProductOptionGroup objects filtered by the fk_product_abstract column
 * @psalm-method Collection&\Traversable<ChildSpyProductAbstractProductOptionGroup> findByFkProductAbstract(int|array<int> $fk_product_abstract) Return ChildSpyProductAbstractProductOptionGroup objects filtered by the fk_product_abstract column
 * @method     ChildSpyProductAbstractProductOptionGroup[]|Collection findByFkProductOptionGroup(int|array<int> $fk_product_option_group) Return ChildSpyProductAbstractProductOptionGroup objects filtered by the fk_product_option_group column
 * @psalm-method Collection&\Traversable<ChildSpyProductAbstractProductOptionGroup> findByFkProductOptionGroup(int|array<int> $fk_product_option_group) Return ChildSpyProductAbstractProductOptionGroup objects filtered by the fk_product_option_group column
 *
