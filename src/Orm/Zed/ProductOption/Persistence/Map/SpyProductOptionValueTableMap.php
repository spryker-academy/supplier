...
class SpyProductOptionValueTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'src.Orm.Zed.ProductOption.Persistence.Map.SpyProductOptionValueTableMap';
     ...
     */
    public const TABLE_NAME = 'spy_product_option_value';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'SpyProductOptionValue';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\Orm\\Zed\\ProductOption\\Persistence\\SpyProductOptionValue';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'src.Orm.Zed.ProductOption.Persistence.SpyProductOptionValue';
     ...
     */
    public const COL_ID_PRODUCT_OPTION_VALUE = 'spy_product_option_value.id_product_option_value';

    /**
     * the column name for the fk_product_option_group field
     */
    public const COL_FK_PRODUCT_OPTION_GROUP = 'spy_product_option_value.fk_product_option_group';

    /**
     * the column name for the price field
     */
    public const COL_PRICE = 'spy_product_option_value.price';

    /**
     * the column name for the sku field
     */
    public const COL_SKU = 'spy_product_option_value.sku';

    /**
     * the column name for the value field
     */
    public const COL_VALUE = 'spy_product_option_value.value';

    /**
     * the column name for the created_at field
     */
    public const COL_CREATED_AT = 'spy_product_option_value.created_at';

    /**
     * the column name for the updated_at field
     */
    public const COL_UPDATED_AT = 'spy_product_option_value.updated_at';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdProductOptionValue', 'FkProductOptionGroup', 'Price', 'Sku', 'Value', 'CreatedAt', 'UpdatedAt', ],
        self::TYPE_CAMELNAME     => ['idProductOptionValue', 'fkProductOptionGroup', 'price', 'sku', 'value', 'createdAt', 'updatedAt', ],
        self::TYPE_COLNAME       => [SpyProductOptionValueTableMap::COL_ID_PRODUCT_OPTION_VALUE, SpyProductOptionValueTableMap::COL_FK_PRODUCT_OPTION_GROUP, SpyProductOptionValueTableMap::COL_PRICE, SpyProductOptionValueTableMap::COL_SKU, SpyProductOptionValueTableMap::COL_VALUE, SpyProductOptionValueTableMap::COL_CREATED_AT, SpyProductOptionValueTableMap::COL_UPDATED_AT, ],
        self::TYPE_FIELDNAME     => ['id_product_option_value', 'fk_product_option_group', 'price', 'sku', 'value', 'created_at', 'updated_at', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdProductOptionValue' => 0, 'FkProductOptionGroup' => 1, 'Price' => 2, 'Sku' => 3, 'Value' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ],
        self::TYPE_CAMELNAME     => ['idProductOptionValue' => 0, 'fkProductOptionGroup' => 1, 'price' => 2, 'sku' => 3, 'value' => 4, 'createdAt' => 5, 'updatedAt' => 6, ],
        self::TYPE_COLNAME       => [SpyProductOptionValueTableMap::COL_ID_PRODUCT_OPTION_VALUE => 0, SpyProductOptionValueTableMap::COL_FK_PRODUCT_OPTION_GROUP => 1, SpyProductOptionValueTableMap::COL_PRICE => 2, SpyProductOptionValueTableMap::COL_SKU => 3, SpyProductOptionValueTableMap::COL_VALUE => 4, SpyProductOptionValueTableMap::COL_CREATED_AT => 5, SpyProductOptionValueTableMap::COL_UPDATED_AT => 6, ],
        self::TYPE_FIELDNAME     => ['id_product_option_value' => 0, 'fk_product_option_group' => 1, 'price' => 2, 'sku' => 3, 'value' => 4, 'created_at' => 5, 'updated_at' => 6, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, 5, 6, ]
    ];
