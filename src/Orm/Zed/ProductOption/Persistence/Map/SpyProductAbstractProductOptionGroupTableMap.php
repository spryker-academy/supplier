...
class SpyProductAbstractProductOptionGroupTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'src.Orm.Zed.ProductOption.Persistence.Map.SpyProductAbstractProductOptionGroupTableMap';
     ...
     */
    public const TABLE_NAME = 'spy_product_abstract_product_option_group';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'SpyProductAbstractProductOptionGroup';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\Orm\\Zed\\ProductOption\\Persistence\\SpyProductAbstractProductOptionGroup';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'src.Orm.Zed.ProductOption.Persistence.SpyProductAbstractProductOptionGroup';
     ...
     */
    public const COL_FK_PRODUCT_ABSTRACT = 'spy_product_abstract_product_option_group.fk_product_abstract';

    /**
     * the column name for the fk_product_option_group field
     */
    public const COL_FK_PRODUCT_OPTION_GROUP = 'spy_product_abstract_product_option_group.fk_product_option_group';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['FkProductAbstract', 'FkProductOptionGroup', ],
        self::TYPE_CAMELNAME     => ['fkProductAbstract', 'fkProductOptionGroup', ],
        self::TYPE_COLNAME       => [SpyProductAbstractProductOptionGroupTableMap::COL_FK_PRODUCT_ABSTRACT, SpyProductAbstractProductOptionGroupTableMap::COL_FK_PRODUCT_OPTION_GROUP, ],
        self::TYPE_FIELDNAME     => ['fk_product_abstract', 'fk_product_option_group', ],
        self::TYPE_NUM           => [0, 1, ]
    ];
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['FkProductAbstract' => 0, 'FkProductOptionGroup' => 1, ],
        self::TYPE_CAMELNAME     => ['fkProductAbstract' => 0, 'fkProductOptionGroup' => 1, ],
        self::TYPE_COLNAME       => [SpyProductAbstractProductOptionGroupTableMap::COL_FK_PRODUCT_ABSTRACT => 0, SpyProductAbstractProductOptionGroupTableMap::COL_FK_PRODUCT_OPTION_GROUP => 1, ],
        self::TYPE_FIELDNAME     => ['fk_product_abstract' => 0, 'fk_product_option_group' => 1, ],
        self::TYPE_NUM           => [0, 1, ]
    ];
  ...
  array (
     ...
     * @return void
     */
    public static function addInstanceToPool(SpyProductAbstractProductOptionGroup $obj, ?string $key = null): void
    {
