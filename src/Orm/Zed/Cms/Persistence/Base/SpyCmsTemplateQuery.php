 ...
 *
 * @method     ChildSpyCmsTemplate[]|Collection find(?ConnectionInterface $con = null) Return ChildSpyCmsTemplate objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpyCmsTemplate> find(?ConnectionInterface $con = null) Return ChildSpyCmsTemplate objects based on current ModelCriteria
 *
 * @method     ChildSpyCmsTemplate[]|Collection findByIdCmsTemplate(int|array<int> $id_cms_template) Return ChildSpyCmsTemplate objects filtered by the id_cms_template column
 * @psalm-method Collection&\Traversable<ChildSpyCmsTemplate> findByIdCmsTemplate(int|array<int> $id_cms_template) Return ChildSpyCmsTemplate objects filtered by the id_cms_template column
 * @method     ChildSpyCmsTemplate[]|Collection findByTemplateName(string|array<string> $template_name) Return ChildSpyCmsTemplate objects filtered by the template_name column
 * @psalm-method Collection&\Traversable<ChildSpyCmsTemplate> findByTemplateName(string|array<string> $template_name) Return ChildSpyCmsTemplate objects filtered by the template_name column
 * @method     ChildSpyCmsTemplate[]|Collection findByTemplatePath(string|array<string> $template_path) Return ChildSpyCmsTemplate objects filtered by the template_path column
 * @psalm-method Collection&\Traversable<ChildSpyCmsTemplate> findByTemplatePath(string|array<string> $template_path) Return ChildSpyCmsTemplate objects filtered by the template_path column
 *
...
abstract class SpyCmsTemplateQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SpyCmsTemplateTableMap::COL_ID_CMS_TEMPLATE, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SpyCmsTemplateTableMap::COL_ID_CMS_TEMPLATE, $keys, Criteria::IN);
