 ...
 *
 * @method     ChildSpyCmsPage[]|Collection find(?ConnectionInterface $con = null) Return ChildSpyCmsPage objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpyCmsPage> find(?ConnectionInterface $con = null) Return ChildSpyCmsPage objects based on current ModelCriteria
 *
 * @method     ChildSpyCmsPage[]|Collection findByIdCmsPage(int|array<int> $id_cms_page) Return ChildSpyCmsPage objects filtered by the id_cms_page column
 * @psalm-method Collection&\Traversable<ChildSpyCmsPage> findByIdCmsPage(int|array<int> $id_cms_page) Return ChildSpyCmsPage objects filtered by the id_cms_page column
 * @method     ChildSpyCmsPage[]|Collection findByFkTemplate(int|array<int> $fk_template) Return ChildSpyCmsPage objects filtered by the fk_template column
 * @psalm-method Collection&\Traversable<ChildSpyCmsPage> findByFkTemplate(int|array<int> $fk_template) Return ChildSpyCmsPage objects filtered by the fk_template column
 * @method     ChildSpyCmsPage[]|Collection findByIsActive(boolean|array<boolean> $is_active) Return ChildSpyCmsPage objects filtered by the is_active column
 * @psalm-method Collection&\Traversable<ChildSpyCmsPage> findByIsActive(boolean|array<boolean> $is_active) Return ChildSpyCmsPage objects filtered by the is_active column
 * @method     ChildSpyCmsPage[]|Collection findByIsSearchable(boolean|array<boolean> $is_searchable) Return ChildSpyCmsPage objects filtered by the is_searchable column
 * @psalm-method Collection&\Traversable<ChildSpyCmsPage> findByIsSearchable(boolean|array<boolean> $is_searchable) Return ChildSpyCmsPage objects filtered by the is_searchable column
 * @method     ChildSpyCmsPage[]|Collection findByPageKey(string|array<string> $page_key) Return ChildSpyCmsPage objects filtered by the page_key column
 * @psalm-method Collection&\Traversable<ChildSpyCmsPage> findByPageKey(string|array<string> $page_key) Return ChildSpyCmsPage objects filtered by the page_key column
 * @method     ChildSpyCmsPage[]|Collection findByUuid(string|array<string> $uuid) Return ChildSpyCmsPage objects filtered by the uuid column
 * @psalm-method Collection&\Traversable<ChildSpyCmsPage> findByUuid(string|array<string> $uuid) Return ChildSpyCmsPage objects filtered by the uuid column
 * @method     ChildSpyCmsPage[]|Collection findByValidFrom(string|array<string> $valid_from) Return ChildSpyCmsPage objects filtered by the valid_from column
 * @psalm-method Collection&\Traversable<ChildSpyCmsPage> findByValidFrom(string|array<string> $valid_from) Return ChildSpyCmsPage objects filtered by the valid_from column
 * @method     ChildSpyCmsPage[]|Collection findByValidTo(string|array<string> $valid_to) Return ChildSpyCmsPage objects filtered by the valid_to column
 * @psalm-method Collection&\Traversable<ChildSpyCmsPage> findByValidTo(string|array<string> $valid_to) Return ChildSpyCmsPage objects filtered by the valid_to column
 *
...
abstract class SpyCmsPageQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SpyCmsPageTableMap::COL_ID_CMS_PAGE, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SpyCmsPageTableMap::COL_ID_CMS_PAGE, $keys, Criteria::IN);
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterByCmsTemplate($spyCmsTemplate, ?string $comparison = null)
    {
     ...
     * @return $this The current query, for fluid interface
     */
    public function joinCmsTemplate(?string $relationAlias = null, ?string $joinType = Criteria::INNER_JOIN)
    {
    ...
    {
        /** @var $q \Orm\Zed\Cms\Persistence\SpyCmsTemplateQuery */
        $q = $this->useExistsQuery('CmsTemplate', $modelAlias, $queryClass, $typeOfExists);
        return $q;
    }
    ...
    {
        /** @var $q \Orm\Zed\Cms\Persistence\SpyCmsTemplateQuery */
        $q = $this->useExistsQuery('CmsTemplate', $modelAlias, $queryClass, 'NOT EXISTS');
        return $q;
    }

    /**
     * Use the CmsTemplate relation to the SpyCmsTemplate table for an IN query.
     *
     ...
     *
     * @return \Orm\Zed\Cms\Persistence\SpyCmsTemplateQuery The inner query object of the IN statement
     */
    public function useInCmsTemplateQuery($modelAlias = null, $queryClass = null, $typeOfIn = 'IN')
    {
        /** @var $q \Orm\Zed\Cms\Persistence\SpyCmsTemplateQuery */
        $q = $this->useInQuery('CmsTemplate', $modelAlias, $queryClass, $typeOfIn);
        return $q;
    }

    /**
     * Use the CmsTemplate relation to the SpyCmsTemplate table for a NOT IN query.
     *
     * @see useCmsTemplateInQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     * @param string|null $queryClass Allows to use a custom query class for the NOT IN query, like ExtendedBookQuery::class
     *
     * @return \Orm\Zed\Cms\Persistence\SpyCmsTemplateQuery The inner query object of the NOT IN statement
     */
    public function useNotInCmsTemplateQuery($modelAlias = null, $queryClass = null)
    {
        /** @var $q \Orm\Zed\Cms\Persistence\SpyCmsTemplateQuery */
        $q = $this->useInQuery('CmsTemplate', $modelAlias, $queryClass, 'NOT IN');
        return $q;
    }
     ...
     * @return $this The current query, for fluid interface
     */
    public function joinSpyCmsVersion(?string $relationAlias = null, ?string $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
