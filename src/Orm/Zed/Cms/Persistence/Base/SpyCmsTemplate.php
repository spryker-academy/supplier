...
abstract class SpyCmsTemplate implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Orm\\Zed\\Cms\\Persistence\\Map\\SpyCmsTemplateTableMap';
     ...
     * @return void
     */
    public function resetPartialSpyCmsPages($v = true): void
    {
     ...
     * @return void
     */
    public function initSpyCmsPages(bool $overrideExisting = true): void
    {
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function countSpyCmsPages(?Criteria $criteria = null, bool $distinct = false, ?ConnectionInterface $con = null): int
    {
        $partial = $this->collSpyCmsPagesPartial && !$this->isNew();
        if (null === $this->collSpyCmsPages || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpyCmsPage(ChildSpyCmsPage $spyCmsPage): void
    {
