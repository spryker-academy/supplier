...
abstract class SpyOmsOrderProcess implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Orm\\Zed\\Oms\\Persistence\\Map\\SpyOmsOrderProcessTableMap';
     ...
     */
    protected function doAddTransitionLog(ChildSpyOmsTransitionLog $transitionLog): void
    {
     ...
     */
    protected function doAddItem(SpySalesOrderItem $item): void
    {
        $this->collItems[]= $item;
