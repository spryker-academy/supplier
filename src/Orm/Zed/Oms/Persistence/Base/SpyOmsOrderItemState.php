...
abstract class SpyOmsOrderItemState implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Orm\\Zed\\Oms\\Persistence\\Map\\SpyOmsOrderItemStateTableMap';
     ...
     */
    protected function doAddStateHistory(ChildSpyOmsOrderItemStateHistory $stateHistory): void
    {
     ...
     */
    protected function doAddEventTimeout(ChildSpyOmsEventTimeout $eventTimeout): void
    {
     ...
     */
    protected function doAddOrder(SpySalesOrderItem $order): void
    {
