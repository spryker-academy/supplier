 ...
 *
 * @method     ChildSpyOmsOrderItemStateHistory[]|Collection find(?ConnectionInterface $con = null) Return ChildSpyOmsOrderItemStateHistory objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpyOmsOrderItemStateHistory> find(?ConnectionInterface $con = null) Return ChildSpyOmsOrderItemStateHistory objects based on current ModelCriteria
 *
 * @method     ChildSpyOmsOrderItemStateHistory[]|Collection findByIdOmsOrderItemStateHistory(int|array<int> $id_oms_order_item_state_history) Return ChildSpyOmsOrderItemStateHistory objects filtered by the id_oms_order_item_state_history column
 * @psalm-method Collection&\Traversable<ChildSpyOmsOrderItemStateHistory> findByIdOmsOrderItemStateHistory(int|array<int> $id_oms_order_item_state_history) Return ChildSpyOmsOrderItemStateHistory objects filtered by the id_oms_order_item_state_history column
 * @method     ChildSpyOmsOrderItemStateHistory[]|Collection findByFkOmsOrderItemState(int|array<int> $fk_oms_order_item_state) Return ChildSpyOmsOrderItemStateHistory objects filtered by the fk_oms_order_item_state column
 * @psalm-method Collection&\Traversable<ChildSpyOmsOrderItemStateHistory> findByFkOmsOrderItemState(int|array<int> $fk_oms_order_item_state) Return ChildSpyOmsOrderItemStateHistory objects filtered by the fk_oms_order_item_state column
 * @method     ChildSpyOmsOrderItemStateHistory[]|Collection findByFkSalesOrderItem(int|array<int> $fk_sales_order_item) Return ChildSpyOmsOrderItemStateHistory objects filtered by the fk_sales_order_item column
 * @psalm-method Collection&\Traversable<ChildSpyOmsOrderItemStateHistory> findByFkSalesOrderItem(int|array<int> $fk_sales_order_item) Return ChildSpyOmsOrderItemStateHistory objects filtered by the fk_sales_order_item column
 * @method     ChildSpyOmsOrderItemStateHistory[]|Collection findByCreatedAt(string|array<string> $created_at) Return ChildSpyOmsOrderItemStateHistory objects filtered by the created_at column
 * @psalm-method Collection&\Traversable<ChildSpyOmsOrderItemStateHistory> findByCreatedAt(string|array<string> $created_at) Return ChildSpyOmsOrderItemStateHistory objects filtered by the created_at column
 *
...
abstract class SpyOmsOrderItemStateHistoryQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SpyOmsOrderItemStateHistoryTableMap::COL_ID_OMS_ORDER_ITEM_STATE_HISTORY, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SpyOmsOrderItemStateHistoryTableMap::COL_ID_OMS_ORDER_ITEM_STATE_HISTORY, $keys, Criteria::IN);
    ...
    {
        $this->addDescendingOrderByColumn(SpyOmsOrderItemStateHistoryTableMap::COL_CREATED_AT);
    ...
    {
        $this->addUsingAlias(SpyOmsOrderItemStateHistoryTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addAscendingOrderByColumn(SpyOmsOrderItemStateHistoryTableMap::COL_CREATED_AT);
