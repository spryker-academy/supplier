...
class SpyOmsOrderProcessTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'src.Orm.Zed.Oms.Persistence.Map.SpyOmsOrderProcessTableMap';
     ...
     */
    public const TABLE_NAME = 'spy_oms_order_process';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'SpyOmsOrderProcess';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\Orm\\Zed\\Oms\\Persistence\\SpyOmsOrderProcess';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'src.Orm.Zed.Oms.Persistence.SpyOmsOrderProcess';
     ...
     */
    public const COL_ID_OMS_ORDER_PROCESS = 'spy_oms_order_process.id_oms_order_process';

    /**
     * the column name for the name field
     */
    public const COL_NAME = 'spy_oms_order_process.name';

    /**
     * the column name for the created_at field
     */
    public const COL_CREATED_AT = 'spy_oms_order_process.created_at';

    /**
     * the column name for the updated_at field
     */
    public const COL_UPDATED_AT = 'spy_oms_order_process.updated_at';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdOmsOrderProcess', 'Name', 'CreatedAt', 'UpdatedAt', ],
        self::TYPE_CAMELNAME     => ['idOmsOrderProcess', 'name', 'createdAt', 'updatedAt', ],
        self::TYPE_COLNAME       => [SpyOmsOrderProcessTableMap::COL_ID_OMS_ORDER_PROCESS, SpyOmsOrderProcessTableMap::COL_NAME, SpyOmsOrderProcessTableMap::COL_CREATED_AT, SpyOmsOrderProcessTableMap::COL_UPDATED_AT, ],
        self::TYPE_FIELDNAME     => ['id_oms_order_process', 'name', 'created_at', 'updated_at', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdOmsOrderProcess' => 0, 'Name' => 1, 'CreatedAt' => 2, 'UpdatedAt' => 3, ],
        self::TYPE_CAMELNAME     => ['idOmsOrderProcess' => 0, 'name' => 1, 'createdAt' => 2, 'updatedAt' => 3, ],
        self::TYPE_COLNAME       => [SpyOmsOrderProcessTableMap::COL_ID_OMS_ORDER_PROCESS => 0, SpyOmsOrderProcessTableMap::COL_NAME => 1, SpyOmsOrderProcessTableMap::COL_CREATED_AT => 2, SpyOmsOrderProcessTableMap::COL_UPDATED_AT => 3, ],
        self::TYPE_FIELDNAME     => ['id_oms_order_process' => 0, 'name' => 1, 'created_at' => 2, 'updated_at' => 3, ],
        self::TYPE_NUM           => [0, 1, 2, 3, ]
    ];
