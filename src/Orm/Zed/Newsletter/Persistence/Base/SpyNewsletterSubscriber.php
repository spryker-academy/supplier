...
abstract class SpyNewsletterSubscriber implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Orm\\Zed\\Newsletter\\Persistence\\Map\\SpyNewsletterSubscriberTableMap';
     ...
     * A flag indicating if a newsletter subscription is confirmed.
     ...
     * A unique key for a newsletter subscriber, used for confirmation and unsubscription.
     * @var        string|null
     */
     ...
     * @return void
     */
    public function resetPartialSpyNewsletterSubscriptions($v = true): void
    {
     ...
     * @return void
     */
    public function initSpyNewsletterSubscriptions(bool $overrideExisting = true): void
    {
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function countSpyNewsletterSubscriptions(?Criteria $criteria = null, bool $distinct = false, ?ConnectionInterface $con = null): int
    {
        $partial = $this->collSpyNewsletterSubscriptionsPartial && !$this->isNew();
        if (null === $this->collSpyNewsletterSubscriptions || null !== $criteria || $partial) {
     ...
     */
    protected function doAddSpyNewsletterSubscription(ChildSpyNewsletterSubscription $spyNewsletterSubscription): void
    {
     ...
     * @return bool
     */
    public function isSpyNewsletterTypesLoaded(): bool
    {
     ...
     */
    public function countSpyNewsletterTypes(?Criteria $criteria = null, $distinct = false, ?ConnectionInterface $con = null): int
    {
        $partial = $this->collSpyNewsletterTypesPartial && !$this->isNew();
        if (null === $this->collSpyNewsletterTypes || null !== $criteria || $partial) {
