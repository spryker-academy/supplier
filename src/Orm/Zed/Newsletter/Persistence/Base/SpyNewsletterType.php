...
abstract class SpyNewsletterType implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Orm\\Zed\\Newsletter\\Persistence\\Map\\SpyNewsletterTypeTableMap';
     ...
     * @return bool
     */
    public function isSpyNewsletterSubscribersLoaded(): bool
    {
     ...
     */
    public function countSpyNewsletterSubscribers(?Criteria $criteria = null, $distinct = false, ?ConnectionInterface $con = null): int
    {
        $partial = $this->collSpyNewsletterSubscribersPartial && !$this->isNew();
        if (null === $this->collSpyNewsletterSubscribers || null !== $criteria || $partial) {
