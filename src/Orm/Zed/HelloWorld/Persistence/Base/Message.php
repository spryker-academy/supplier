...
abstract class Message implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Orm\\Zed\\HelloWorld\\Persistence\\Map\\MessageTableMap';
    ...
    /**
     * Initializes internal state of Orm\Zed\HelloWorld\Persistence\Base\Message object.
     */
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Orm\\Zed\\HelloWorld\\Persistence\\Message'), 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of \Orm\Zed\HelloWorld\Persistence\Message (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Orm\Zed\HelloWorld\Persistence\Message Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
