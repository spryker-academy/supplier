...
use \Exception;
use \PDO;
use Orm\Zed\HelloWorld\Persistence\Message as ChildMessage;
use Orm\Zed\HelloWorld\Persistence\MessageQuery as ChildMessageQuery;
use Orm\Zed\HelloWorld\Persistence\Map\MessageTableMap;
...
abstract class MessageQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Orm\Zed\HelloWorld\Persistence\Base\MessageQuery object.
     *
     * @param string $dbName The database name
     * @param string $modelName The phpName of a model, e.g. 'Book'
     * @param string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'zed', $modelName = '\\Orm\\Zed\\HelloWorld\\Persistence\\Message', $modelAlias = null)
    {
