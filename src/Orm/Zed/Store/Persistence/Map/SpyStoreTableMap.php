...
class SpyStoreTableMap extends TableMap
{
     ...
     */
    public const COL_FK_CURRENCY = 'spy_store.fk_currency';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdStore', 'FkCurrency', 'FkLocale', 'Name', ],
        self::TYPE_CAMELNAME     => ['idStore', 'fkCurrency', 'fkLocale', 'name', ],
        self::TYPE_COLNAME       => [SpyStoreTableMap::COL_ID_STORE, SpyStoreTableMap::COL_FK_CURRENCY, SpyStoreTableMap::COL_FK_LOCALE, SpyStoreTableMap::COL_NAME, ],
        self::TYPE_FIELDNAME     => ['id_store', 'fk_currency', 'fk_locale', 'name', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdStore' => 0, 'FkCurrency' => 1, 'FkLocale' => 2, 'Name' => 3, ],
        self::TYPE_CAMELNAME     => ['idStore' => 0, 'fkCurrency' => 1, 'fkLocale' => 2, 'name' => 3, ],
        self::TYPE_COLNAME       => [SpyStoreTableMap::COL_ID_STORE => 0, SpyStoreTableMap::COL_FK_CURRENCY => 1, SpyStoreTableMap::COL_FK_LOCALE => 2, SpyStoreTableMap::COL_NAME => 3, ],
        self::TYPE_FIELDNAME     => ['id_store' => 0, 'fk_currency' => 1, 'fk_locale' => 2, 'name' => 3, ],
        self::TYPE_NUM           => [0, 1, 2, 3, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        ...
        'SpyStore.FkCurrency' => 'FK_CURRENCY',
        'fkCurrency' => 'FK_CURRENCY',
        'spyStore.fkCurrency' => 'FK_CURRENCY',
        'SpyStoreTableMap::COL_FK_CURRENCY' => 'FK_CURRENCY',
    ...
    public function initialize(): void
    {
        ...
        $this->addForeignKey('fk_currency', 'FkCurrency', 'INTEGER', 'spy_currency', 'id_currency', false, null, null);
    ...
    {
        $this->addRelation('DefaultCurrency', '\\Orm\\Zed\\Currency\\Persistence\\SpyCurrency', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':fk_currency',
    1 => ':id_currency',
  ...
  array (
    ...
    1 => ':id_store',
        ...
        $this->addRelation('CountryStore', '\\Orm\\Zed\\Country\\Persistence\\SpyCountryStore', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':fk_store',
    1 => ':id_store',
  ),
), null, null, 'CountryStores', false);
        $this->addRelation('CurrencyStore', '\\Orm\\Zed\\Currency\\Persistence\\SpyCurrencyStore', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':fk_store',
    1 => ':id_store',
  ),
), null, null, 'CurrencyStores', false);
  ...
  array (
    ...
    1 => ':id_store',
        ...
        $this->addRelation('MerchantCommission', '\\Orm\\Zed\\MerchantCommission\\Persistence\\SpyMerchantCommissionStore', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':fk_store',
    1 => ':id_store',
        ...
        $this->addRelation('SpyMerchantRegistrationRequest', '\\Orm\\Zed\\MerchantRegistrationRequest\\Persistence\\SpyMerchantRegistrationRequest', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':fk_store',
    1 => ':id_store',
  ),
), null, null, 'SpyMerchantRegistrationRequests', false);
  ...
  array (
    ...
    1 => ':id_store',
        ...
        $this->addRelation('OmsProductOfferReservation', '\\Orm\\Zed\\OmsProductOfferReservation\\Persistence\\SpyOmsProductOfferReservation', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':fk_store',
    1 => ':id_store',
  ),
), null, null, 'OmsProductOfferReservations', false);
  ...
  array (
    ...
    1 => ':id_store',
        ...
        $this->addRelation('SpyStoreContext', '\\Orm\\Zed\\StoreContext\\Persistence\\SpyStoreContext', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':fk_store',
    1 => ':id_store',
  ),
), null, null, 'SpyStoreContexts', false);
  ...
  array (
    ...
    1 => ':id_store',
        ...
        $this->addRelation('SpyProductOffer', '\\Orm\\Zed\\ProductOffer\\Persistence\\SpyProductOffer', RelationMap::MANY_TO_MANY, array(), null, null, 'SpyProductOffers');
    }
    ...
    public static function addSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SpyStoreTableMap::COL_FK_CURRENCY);
    ...
    public static function removeSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn(SpyStoreTableMap::COL_FK_CURRENCY);
