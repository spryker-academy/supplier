...
abstract class SpyProductImage implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Orm\\Zed\\ProductImage\\Persistence\\Map\\SpyProductImageTableMap';
    ...
    /**
     * The value for the alt_text_large field.
     *
     * @var        string|null
     */
    protected $alt_text_large;

    /**
     * The value for the alt_text_small field.
     *
     * @var        string|null
     */
    protected $alt_text_small;

    /**
     * The value for the external_url_large field.
     * The URL for a large version of an image.
     * @var        string|null
     */
     ...
     * The URL for a small version of an image.
     * @var        string|null
     */
    ...
    /**
     * Get the [alt_text_large] column value.
     *
     * @return string|null
     */
    public function getAltTextLarge()
    {
        return $this->alt_text_large;
    }

    /**
     * Get the [alt_text_small] column value.
     *
     * @return string|null
     */
    public function getAltTextSmall()
    {
        return $this->alt_text_small;
    }
    ...
    /**
     * Set the value of [alt_text_large] column.
     *
     * @param string|null $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setAltTextLarge($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->alt_text_large !== $v) {
            $this->alt_text_large = $v;
            $this->modifiedColumns[SpyProductImageTableMap::COL_ALT_TEXT_LARGE] = true;
        }
    ...
    /**
     * Set the value of [alt_text_small] column.
     *
     * @param string|null $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setAltTextSmall($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->alt_text_small !== $v) {
            $this->alt_text_small = $v;
            $this->modifiedColumns[SpyProductImageTableMap::COL_ALT_TEXT_SMALL] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SpyProductImageTableMap::translateFieldName('AltTextLarge', TableMap::TYPE_PHPNAME, $indexType)];
            $this->alt_text_large = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SpyProductImageTableMap::translateFieldName('AltTextSmall', TableMap::TYPE_PHPNAME, $indexType)];
            $this->alt_text_small = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SpyProductImageTableMap::translateFieldName('ExternalUrlLarge', TableMap::TYPE_PHPNAME, $indexType)];
            $this->external_url_large = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SpyProductImageTableMap::translateFieldName('ExternalUrlSmall', TableMap::TYPE_PHPNAME, $indexType)];
            $this->external_url_small = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : SpyProductImageTableMap::translateFieldName('ProductImageKey', TableMap::TYPE_PHPNAME, $indexType)];
            $this->product_image_key = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : SpyProductImageTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : SpyProductImageTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 8; // 8 = SpyProductImageTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(SpyProductImageTableMap::COL_ALT_TEXT_LARGE)) {
            $modifiedColumns[':p' . $index++]  = 'alt_text_large';
        }
        if ($this->isColumnModified(SpyProductImageTableMap::COL_ALT_TEXT_SMALL)) {
            $modifiedColumns[':p' . $index++]  = 'alt_text_small';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id_product_image':
                        ...
                        break;
                    case 'alt_text_large':
                        $stmt->bindValue($identifier, $this->alt_text_large, PDO::PARAM_STR);

                        break;
                    case 'alt_text_small':
                        $stmt->bindValue($identifier, $this->alt_text_small, PDO::PARAM_STR);
    ...
    public function getByPosition(int $pos)
    {
        switch ($pos) {
            ...
            case 1:
                return $this->getAltTextLarge();

            case 2:
                return $this->getAltTextSmall();
    ...
    public function toArray(string $keyType = TableMap::TYPE_FIELDNAME, bool $includeLazyLoadColumns = true, array $alreadyDumpedObjects = [], bool $includeForeignObjects = false): array
    {
        ...
        $result = [
            ...
            $keys[1] => $this->getAltTextLarge(),
            $keys[2] => $this->getAltTextSmall(),
            $keys[3] => $this->getExternalUrlLarge(),
            $keys[4] => $this->getExternalUrlSmall(),
            $keys[5] => $this->getProductImageKey(),
    ...
    public function setByPosition(int $pos, $value)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                $this->setAltTextLarge($value);
                break;
            case 2:
                $this->setAltTextSmall($value);
                break;
            case 3:
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setAltTextLarge($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setAltTextSmall($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setExternalUrlLarge($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setExternalUrlSmall($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setProductImageKey($arr[$keys[5]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(SpyProductImageTableMap::COL_ALT_TEXT_LARGE)) {
            $criteria->add(SpyProductImageTableMap::COL_ALT_TEXT_LARGE, $this->alt_text_large);
        }
        if ($this->isColumnModified(SpyProductImageTableMap::COL_ALT_TEXT_SMALL)) {
            $criteria->add(SpyProductImageTableMap::COL_ALT_TEXT_SMALL, $this->alt_text_small);
        }
        if ($this->isColumnModified(SpyProductImageTableMap::COL_EXTERNAL_URL_LARGE)) {
    ...
    {
        $copyObj->setAltTextLarge($this->getAltTextLarge());
        $copyObj->setAltTextSmall($this->getAltTextSmall());
    ...
    public function clear()
    {
        ...
        $this->alt_text_large = null;
        $this->alt_text_small = null;
