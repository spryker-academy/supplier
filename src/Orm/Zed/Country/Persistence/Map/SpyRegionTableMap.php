...
class SpyRegionTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'src.Orm.Zed.Country.Persistence.Map.SpyRegionTableMap';
     ...
     */
    public const TABLE_PHP_NAME = 'SpyRegion';
     ...
     */
    public const CLASS_DEFAULT = 'src.Orm.Zed.Country.Persistence.SpyRegion';
     ...
     */
    public const COL_UUID = 'spy_region.uuid';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdRegion', 'FkCountry', 'Iso2Code', 'Name', 'Uuid', ],
        self::TYPE_CAMELNAME     => ['idRegion', 'fkCountry', 'iso2Code', 'name', 'uuid', ],
        self::TYPE_COLNAME       => [SpyRegionTableMap::COL_ID_REGION, SpyRegionTableMap::COL_FK_COUNTRY, SpyRegionTableMap::COL_ISO2_CODE, SpyRegionTableMap::COL_NAME, SpyRegionTableMap::COL_UUID, ],
        self::TYPE_FIELDNAME     => ['id_region', 'fk_country', 'iso2_code', 'name', 'uuid', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdRegion' => 0, 'FkCountry' => 1, 'Iso2Code' => 2, 'Name' => 3, 'Uuid' => 4, ],
        self::TYPE_CAMELNAME     => ['idRegion' => 0, 'fkCountry' => 1, 'iso2Code' => 2, 'name' => 3, 'uuid' => 4, ],
        self::TYPE_COLNAME       => [SpyRegionTableMap::COL_ID_REGION => 0, SpyRegionTableMap::COL_FK_COUNTRY => 1, SpyRegionTableMap::COL_ISO2_CODE => 2, SpyRegionTableMap::COL_NAME => 3, SpyRegionTableMap::COL_UUID => 4, ],
        self::TYPE_FIELDNAME     => ['id_region' => 0, 'fk_country' => 1, 'iso2_code' => 2, 'name' => 3, 'uuid' => 4, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        ...
        'uuid' => 'UUID',
        'spyRegion.uuid' => 'UUID',
        'SpyRegionTableMap::COL_UUID' => 'UUID',
        'COL_UUID' => 'UUID',
        'spy_region.uuid' => 'UUID',
    ];
  ...
  array (
    ...
    {
        return [
            'uuid' => ['key_prefix' => NULL, 'key_columns' => 'id_region'],
    ...
    public static function addSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SpyRegionTableMap::COL_UUID);
        } else {
    ...
    public static function removeSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn(SpyRegionTableMap::COL_UUID);
        } else {
