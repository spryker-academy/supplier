...
abstract class SpyRegion implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Orm\\Zed\\Country\\Persistence\\Map\\SpyRegionTableMap';
    ...
    public function setUuid($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->uuid !== $v) {
            $this->uuid = $v;
            $this->modifiedColumns[SpyRegionTableMap::COL_UUID] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SpyRegionTableMap::translateFieldName('Uuid', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 5; // 5 = SpyRegionTableMap::NUM_HYDRATE_COLUMNS.
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->servicePointAddressesScheduledForDeletion !== null) {
                if (!$this->servicePointAddressesScheduledForDeletion->isEmpty()) {
                    foreach ($this->servicePointAddressesScheduledForDeletion as $servicePointAddress) {
                        // need to save related object because we set the relation to null
                        $servicePointAddress->save($con);
                    }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(SpyRegionTableMap::COL_UUID)) {
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(SpyRegionTableMap::COL_UUID)) {
            $criteria->add(SpyRegionTableMap::COL_UUID, $this->uuid);
        }
    ...
    public function setServicePointAddresses(Collection $servicePointAddresses, ?ConnectionInterface $con = null)
    {
        ...
        foreach ($servicePointAddressesToDelete as $servicePointAddressRemoved) {
            $servicePointAddressRemoved->setRegion(null);
        }
    ...
    protected function doAddServicePointAddress(SpyServicePointAddress $servicePointAddress): void
    {
        ...
        $servicePointAddress->setRegion($this);
    }
    ...
    public function removeServicePointAddress(SpyServicePointAddress $servicePointAddress)
    {
        if ($this->getServicePointAddresses()->contains($servicePointAddress)) {
            ...
            $this->servicePointAddressesScheduledForDeletion[]= $servicePointAddress;
            $servicePointAddress->setRegion(null);
        }
    ...
    protected function setGeneratedUuid()
    {
        ...
        $name = 'spy_region' . '.' . $this->getIdRegion();
