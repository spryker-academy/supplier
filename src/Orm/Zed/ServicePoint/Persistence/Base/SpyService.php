...
/**
 * Base class that represents a row from the 'spy_service' table.
 *
 *
 *
 * @package    propel.generator.src.Orm.Zed.ServicePoint.Persistence.Base
 */
abstract class SpyService implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\Orm\\Zed\\ServicePoint\\Persistence\\Map\\SpyServiceTableMap';
    ...
    /**
     * @var        ChildSpyServiceType
     */
    protected $aServiceType;
    ...
    /**
     * Initializes internal state of Orm\Zed\ServicePoint\Persistence\Base\SpyService object.
     */
    ...
    /**
     * Compares this with another <code>SpyService</code> instance.  If
     * <code>obj</code> is an instance of <code>SpyService</code>, delegates to
     * <code>equals(SpyService)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setIdService($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->id_service !== $v) {
            $this->id_service = $v;
            $this->modifiedColumns[SpyServiceTableMap::COL_ID_SERVICE] = true;
        }
    ...
    public function setFkServicePoint($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->fk_service_point !== $v) {
            ...
            $this->modifiedColumns[SpyServiceTableMap::COL_FK_SERVICE_POINT] = true;
        }
    ...
    public function setFkServiceType($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->fk_service_type !== $v) {
            ...
            $this->modifiedColumns[SpyServiceTableMap::COL_FK_SERVICE_TYPE] = true;
        }

        if ($this->aServiceType !== null && $this->aServiceType->getIdServiceType() !== $v) {
            $this->aServiceType = null;
        }
    ...
    public function setIsActive($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->is_active !== $v) {
            $this->is_active = $v;
            $this->modifiedColumns[SpyServiceTableMap::COL_IS_ACTIVE] = true;
        }
    ...
    public function setKey($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->key !== $v) {
            $this->key = $v;
            $this->modifiedColumns[SpyServiceTableMap::COL_KEY] = true;
        }
    ...
    public function setUuid($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->uuid !== $v) {
            $this->uuid = $v;
            $this->modifiedColumns[SpyServiceTableMap::COL_UUID] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[SpyServiceTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[SpyServiceTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SpyServiceTableMap::translateFieldName('IdService', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_service = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SpyServiceTableMap::translateFieldName('FkServicePoint', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fk_service_point = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SpyServiceTableMap::translateFieldName('FkServiceType', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fk_service_type = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SpyServiceTableMap::translateFieldName('IsActive', TableMap::TYPE_PHPNAME, $indexType)];
            $this->is_active = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SpyServiceTableMap::translateFieldName('Key', TableMap::TYPE_PHPNAME, $indexType)];
            $this->key = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : SpyServiceTableMap::translateFieldName('Uuid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uuid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : SpyServiceTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : SpyServiceTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 8; // 8 = SpyServiceTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Orm\\Zed\\ServicePoint\\Persistence\\SpyService'), 0, $e);
        }
    }
    ...
    public function ensureConsistency(): void
    {
        ...
        if ($this->aServiceType !== null && $this->fk_service_type !== $this->aServiceType->getIdServiceType()) {
            $this->aServiceType = null;
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        if ($con === null) {
            $con = Propel::getServiceContainer()->getReadConnection(SpyServiceTableMap::DATABASE_NAME);
        }

        // We don't need to alter the object instance pool; we're just modifying this instance
        // already in the pool.

        $dataFetcher = ChildSpyServiceQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws \Propel\Runtime\Exception\PropelException
     * @see SpyService::setDeleted()
     * @see SpyService::isDeleted()
     */
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildSpyServiceQuery::create()
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(SpyServiceTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt($highPrecision);
                }
                if (!$this->isColumnModified(SpyServiceTableMap::COL_UPDATED_AT)) {
                ...
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(SpyServiceTableMap::COL_UPDATED_AT)) {
            ...
            if ($ret) {
                ...
                SpyServiceTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doSave(ConnectionInterface $con): int
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aServiceType !== null) {
                if ($this->aServiceType->isModified() || $this->aServiceType->isNew()) {
                    $affectedRows += $this->aServiceType->save($con);
                }
                $this->setServiceType($this->aServiceType);
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(SpyServiceTableMap::COL_ID_SERVICE)) {
            $modifiedColumns[':p' . $index++]  = '`id_service`';
        }
        if ($this->isColumnModified(SpyServiceTableMap::COL_FK_SERVICE_POINT)) {
            $modifiedColumns[':p' . $index++]  = '`fk_service_point`';
        }
        if ($this->isColumnModified(SpyServiceTableMap::COL_FK_SERVICE_TYPE)) {
            $modifiedColumns[':p' . $index++]  = '`fk_service_type`';
        }
        if ($this->isColumnModified(SpyServiceTableMap::COL_IS_ACTIVE)) {
            $modifiedColumns[':p' . $index++]  = '`is_active`';
        }
        if ($this->isColumnModified(SpyServiceTableMap::COL_KEY)) {
            $modifiedColumns[':p' . $index++]  = '`key`';
        }
        if ($this->isColumnModified(SpyServiceTableMap::COL_UUID)) {
        ...
        $sql = sprintf(
            'INSERT INTO `spy_service` (%s) VALUES (%s)',
        ...
        try {
            $pk = $con->lastInsertId('spy_service_pk_seq');
        } catch (Exception $e) {
    ...
    {
        $pos = SpyServiceTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['SpyService'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['SpyService'][$this->hashCode()] = true;
        $keys = SpyServiceTableMap::getFieldNames($keyType);
        $result = [
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aServiceType) {
                ...
                $result[$key] = $this->aServiceType->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(SpyServiceTableMap::COL_ID_SERVICE)) {
            $criteria->add(SpyServiceTableMap::COL_ID_SERVICE, $this->id_service);
        }
        if ($this->isColumnModified(SpyServiceTableMap::COL_FK_SERVICE_POINT)) {
            $criteria->add(SpyServiceTableMap::COL_FK_SERVICE_POINT, $this->fk_service_point);
        }
        if ($this->isColumnModified(SpyServiceTableMap::COL_FK_SERVICE_TYPE)) {
            $criteria->add(SpyServiceTableMap::COL_FK_SERVICE_TYPE, $this->fk_service_type);
        }
        if ($this->isColumnModified(SpyServiceTableMap::COL_IS_ACTIVE)) {
            $criteria->add(SpyServiceTableMap::COL_IS_ACTIVE, $this->is_active);
        }
        if ($this->isColumnModified(SpyServiceTableMap::COL_KEY)) {
            $criteria->add(SpyServiceTableMap::COL_KEY, $this->key);
        }
        if ($this->isColumnModified(SpyServiceTableMap::COL_UUID)) {
            $criteria->add(SpyServiceTableMap::COL_UUID, $this->uuid);
        }
        if ($this->isColumnModified(SpyServiceTableMap::COL_CREATED_AT)) {
            $criteria->add(SpyServiceTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(SpyServiceTableMap::COL_UPDATED_AT)) {
            $criteria->add(SpyServiceTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    {
        $criteria = ChildSpyServiceQuery::create();
        $criteria->add(SpyServiceTableMap::COL_ID_SERVICE, $this->id_service);
     ...
     * objects.
     *
     * @param object $copyObj An object of \Orm\Zed\ServicePoint\Persistence\SpyService (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Orm\Zed\ServicePoint\Persistence\SpyService Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    public function getServicePoint(?ConnectionInterface $con = null)
    {
        if ($this->aServicePoint === null && ($this->fk_service_point != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aServicePoint->addServices($this);
             */
        }
    ...
    /**
     * Declares an association between this object and a ChildSpyServiceType object.
     *
     * @param ChildSpyServiceType $v
     * @return $this The current object (for fluent API support)
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function setServiceType(ChildSpyServiceType $v = null)
    {
        if ($v === null) {
        ...
        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildSpyServiceType object, it will not be re-added.
        if ($v !== null) {
            $v->addService($this);
        }
    ...
    /**
     * Get the associated ChildSpyServiceType object
     *
     * @param ConnectionInterface $con Optional Connection object.
     * @return ChildSpyServiceType The associated ChildSpyServiceType object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function getServiceType(?ConnectionInterface $con = null)
    {
        if ($this->aServiceType === null && ($this->fk_service_type != 0)) {
            $this->aServiceType = ChildSpyServiceTypeQuery::create()->findPk($this->fk_service_type, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aServiceType->addServices($this);
             */
        }
     ...
     * If this ChildSpyService is new, it will return
    ...
    public function setProductOfferServices(Collection $productOfferServices, ?ConnectionInterface $con = null)
    {
        ...
        foreach ($productOfferServicesToDelete as $productOfferServiceRemoved) {
            $productOfferServiceRemoved->setService(null);
        }
    ...
    protected function doAddProductOfferService(SpyProductOfferService $productOfferService): void
    {
        ...
        $productOfferService->setService($this);
    }
    ...
    public function removeProductOfferService(SpyProductOfferService $productOfferService)
    {
        if ($this->getProductOfferServices()->contains($productOfferService)) {
            ...
            $productOfferService->setService(null);
        }
     ...
     * Otherwise if this SpyService is new, it will return
     * an empty collection; or if this SpyService has previously
     * been saved, it will retrieve related ProductOfferServices from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in SpyService.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param ConnectionInterface $con optional connection object
     ...
     * @phpstan-return ObjectCollection&\Traversable<SpyProductOfferService}> List of SpyProductOfferService objects
     */
    public function getProductOfferServicesJoinProductOffer(?Criteria $criteria = null, ?ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = SpyProductOfferServiceQuery::create(null, $criteria);
    ...
    {
        if (null !== $this->aServicePoint) {
            $this->aServicePoint->removeService($this);
        }
        if (null !== $this->aServiceType) {
            $this->aServiceType->removeService($this);
        }
    ...
    {
        return (string) $this->exportTo(SpyServiceTableMap::DEFAULT_STRING_FORMAT);
    }
    ...
    protected function setGeneratedUuid()
    {
        ...
        $name = 'spy_service' . '.' . $this->getIdService();
    ...
    {
        if ($this->isNew()) {
            $this->_eventName = 'Entity.spy_service.create';
        } else {
            $this->_eventName = 'Entity.spy_service.update';
        }
    ...
    protected function addSaveEventToMemory()
    {
        ...
        if ($this->_eventName !== 'Entity.spy_service.create') {
            if (!$this->_isModified) {
                return;
            }
    ...
    protected function addDeleteEventToMemory()
    {
        ...
        $data = [
            'name' => 'spy_service',
            'id' => !is_array($this->getPrimaryKey()) ? $this->getPrimaryKey() : null,
            'event' => 'Entity.spy_service.delete',
            'foreignKeys' => $this->getForeignKeys(),
            'additionalValues' => $this->getAdditionalValues(),
        ];
    ...
    protected function getOriginalValues(): array
    {
        ...
        foreach ($this->_modifiedColumns as $modifiedColumn) {
            ...
            $field = str_replace('spy_service.', '', $modifiedColumn);
            $after = $this->$field;
    ...
    protected function getAdditionalValues(): array
    {
        ...
        foreach ($this->getAdditionalValueColumnNames() as $additionalValueColumnName) {
            $field = str_replace('spy_service.', '', $additionalValueColumnName);
    ...
    {
        $columnType = SpyServiceTableMap::getTableMap()->getColumn($column)->getType();
