...
/**
 * Base class that represents a row from the 'spy_service_type' table.
 *
 *
 *
 * @package    propel.generator.src.Orm.Zed.ServicePoint.Persistence.Base
 */
abstract class SpyServiceType implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\Orm\\Zed\\ServicePoint\\Persistence\\Map\\SpyServiceTypeTableMap';
    ...
    /**
     * The value for the id_service_type field.
     *
     * @var        int
     */
    ...
    /**
     * Initializes internal state of Orm\Zed\ServicePoint\Persistence\Base\SpyServiceType object.
     */
    ...
    /**
     * Compares this with another <code>SpyServiceType</code> instance.  If
     * <code>obj</code> is an instance of <code>SpyServiceType</code>, delegates to
     * <code>equals(SpyServiceType)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    /**
     * Get the [id_service_type] column value.
     *
     * @return int
     */
    ...
    /**
     * Set the value of [id_service_type] column.
     *
     * @param int $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setIdServiceType($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->id_service_type !== $v) {
            $this->id_service_type = $v;
            $this->modifiedColumns[SpyServiceTypeTableMap::COL_ID_SERVICE_TYPE] = true;
        }
    ...
    public function setKey($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->key !== $v) {
            $this->key = $v;
            $this->modifiedColumns[SpyServiceTypeTableMap::COL_KEY] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[SpyServiceTypeTableMap::COL_NAME] = true;
        }
    ...
    public function setUuid($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->uuid !== $v) {
            $this->uuid = $v;
            $this->modifiedColumns[SpyServiceTypeTableMap::COL_UUID] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[SpyServiceTypeTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[SpyServiceTypeTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SpyServiceTypeTableMap::translateFieldName('IdServiceType', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_service_type = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SpyServiceTypeTableMap::translateFieldName('Key', TableMap::TYPE_PHPNAME, $indexType)];
            $this->key = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SpyServiceTypeTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SpyServiceTypeTableMap::translateFieldName('Uuid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uuid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SpyServiceTypeTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : SpyServiceTypeTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 6; // 6 = SpyServiceTypeTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Orm\\Zed\\ServicePoint\\Persistence\\SpyServiceType'), 0, $e);
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        if ($con === null) {
            $con = Propel::getServiceContainer()->getReadConnection(SpyServiceTypeTableMap::DATABASE_NAME);
        }

        // We don't need to alter the object instance pool; we're just modifying this instance
        // already in the pool.

        $dataFetcher = ChildSpyServiceTypeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws \Propel\Runtime\Exception\PropelException
     * @see SpyServiceType::setDeleted()
     * @see SpyServiceType::isDeleted()
     */
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildSpyServiceTypeQuery::create()
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(SpyServiceTypeTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt($highPrecision);
                }
                if (!$this->isColumnModified(SpyServiceTypeTableMap::COL_UPDATED_AT)) {
                ...
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(SpyServiceTypeTableMap::COL_UPDATED_AT)) {
            ...
            if ($ret) {
                ...
                SpyServiceTypeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(SpyServiceTypeTableMap::COL_ID_SERVICE_TYPE)) {
            $modifiedColumns[':p' . $index++]  = '`id_service_type`';
        }
        if ($this->isColumnModified(SpyServiceTypeTableMap::COL_KEY)) {
            $modifiedColumns[':p' . $index++]  = '`key`';
        }
        if ($this->isColumnModified(SpyServiceTypeTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(SpyServiceTypeTableMap::COL_UUID)) {
        ...
        $sql = sprintf(
            'INSERT INTO `spy_service_type` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id_service_type`':
                        $stmt->bindValue($identifier, $this->id_service_type, PDO::PARAM_INT);
        ...
        try {
            $pk = $con->lastInsertId('spy_service_type_pk_seq');
        } catch (Exception $e) {
            throw new PropelException('Unable to get autoincrement id.', 0, $e);
        }
        $this->setIdServiceType($pk);
    ...
    {
        $pos = SpyServiceTypeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['SpyServiceType'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['SpyServiceType'][$this->hashCode()] = true;
        $keys = SpyServiceTypeTableMap::getFieldNames($keyType);
        $result = [
            $keys[0] => $this->getIdServiceType(),
            $keys[1] => $this->getKey(),
            $keys[2] => $this->getName(),
            $keys[3] => $this->getUuid(),
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setIdServiceType($arr[$keys[0]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(SpyServiceTypeTableMap::COL_ID_SERVICE_TYPE)) {
            $criteria->add(SpyServiceTypeTableMap::COL_ID_SERVICE_TYPE, $this->id_service_type);
        }
        if ($this->isColumnModified(SpyServiceTypeTableMap::COL_KEY)) {
            $criteria->add(SpyServiceTypeTableMap::COL_KEY, $this->key);
        }
        if ($this->isColumnModified(SpyServiceTypeTableMap::COL_NAME)) {
            $criteria->add(SpyServiceTypeTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(SpyServiceTypeTableMap::COL_UUID)) {
            $criteria->add(SpyServiceTypeTableMap::COL_UUID, $this->uuid);
        }
        if ($this->isColumnModified(SpyServiceTypeTableMap::COL_CREATED_AT)) {
            $criteria->add(SpyServiceTypeTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(SpyServiceTypeTableMap::COL_UPDATED_AT)) {
            $criteria->add(SpyServiceTypeTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    {
        $criteria = ChildSpyServiceTypeQuery::create();
        $criteria->add(SpyServiceTypeTableMap::COL_ID_SERVICE_TYPE, $this->id_service_type);
    ...
    {
        $validPk = null !== $this->getIdServiceType();
    ...
    /**
     * Generic method to set the primary key (id_service_type column).
     *
    ...
    {
        return null === $this->getIdServiceType();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of \Orm\Zed\ServicePoint\Persistence\SpyServiceType (or compatible) type.
    ...
    public function copyInto(object $copyObj, bool $deepCopy = false, bool $makeNew = true): void
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdServiceType(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Orm\Zed\ServicePoint\Persistence\SpyServiceType Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
     ...
     * If this ChildSpyServiceType is new, it will return
    ...
    public function setServices(Collection $services, ?ConnectionInterface $con = null)
    {
        ...
        foreach ($servicesToDelete as $serviceRemoved) {
            $serviceRemoved->setServiceType(null);
        }
     ...
     * Otherwise if this SpyServiceType is new, it will return
     * an empty collection; or if this SpyServiceType has previously
     * been saved, it will retrieve related Services from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in SpyServiceType.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param ConnectionInterface $con optional connection object
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildSpyService}> List of ChildSpyService objects
     */
    public function getServicesJoinServicePoint(?Criteria $criteria = null, ?ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildSpyServiceQuery::create(null, $criteria);
    ...
    public function setSpyShipmentTypeServiceTypes(Collection $spyShipmentTypeServiceTypes, ?ConnectionInterface $con = null)
    {
        ...
        foreach ($spyShipmentTypeServiceTypesToDelete as $spyShipmentTypeServiceTypeRemoved) {
            $spyShipmentTypeServiceTypeRemoved->setSpyServiceType(null);
        }
    ...
    protected function doAddSpyShipmentTypeServiceType(SpyShipmentTypeServiceType $spyShipmentTypeServiceType): void
    {
        ...
        $spyShipmentTypeServiceType->setSpyServiceType($this);
    }
    ...
    public function removeSpyShipmentTypeServiceType(SpyShipmentTypeServiceType $spyShipmentTypeServiceType)
    {
        if ($this->getSpyShipmentTypeServiceTypes()->contains($spyShipmentTypeServiceType)) {
            ...
            $spyShipmentTypeServiceType->setSpyServiceType(null);
        }
     ...
     * @phpstan-return ObjectCollection&\Traversable<SpyShipmentTypeServiceType}> List of SpyShipmentTypeServiceType objects
     */
    public function getSpyShipmentTypeServiceTypesJoinSpyShipmentType(?Criteria $criteria = null, ?ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = SpyShipmentTypeServiceTypeQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(SpyServiceTypeTableMap::DEFAULT_STRING_FORMAT);
    }
    ...
    protected function setGeneratedUuid()
    {
        ...
        $name = 'spy_service_type' . '.' . $this->getIdServiceType();
    ...
    {
        if ($this->isNew()) {
            $this->_eventName = 'Entity.spy_service_type.create';
        } else {
            $this->_eventName = 'Entity.spy_service_type.update';
        }
    ...
    protected function addSaveEventToMemory()
    {
        ...
        if ($this->_eventName !== 'Entity.spy_service_type.create') {
            if (!$this->_isModified) {
                return;
            }
    ...
    protected function addDeleteEventToMemory()
    {
        ...
        $data = [
            'name' => 'spy_service_type',
            'id' => !is_array($this->getPrimaryKey()) ? $this->getPrimaryKey() : null,
            'event' => 'Entity.spy_service_type.delete',
            'foreignKeys' => $this->getForeignKeys(),
            'additionalValues' => $this->getAdditionalValues(),
        ];
    ...
    protected function getOriginalValues(): array
    {
        ...
        foreach ($this->_modifiedColumns as $modifiedColumn) {
            ...
            $field = str_replace('spy_service_type.', '', $modifiedColumn);
            $after = $this->$field;
    ...
    protected function getAdditionalValues(): array
    {
        ...
        foreach ($this->getAdditionalValueColumnNames() as $additionalValueColumnName) {
            $field = str_replace('spy_service_type.', '', $additionalValueColumnName);
    ...
    {
        $columnType = SpyServiceTypeTableMap::getTableMap()->getColumn($column)->getType();
