 ...
 *
 * @method     ChildSpyShoppingListItemNote[]|Collection find(?ConnectionInterface $con = null) Return ChildSpyShoppingListItemNote objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpyShoppingListItemNote> find(?ConnectionInterface $con = null) Return ChildSpyShoppingListItemNote objects based on current ModelCriteria
 *
 * @method     ChildSpyShoppingListItemNote[]|Collection findByIdShoppingListItemNote(int|array<int> $id_shopping_list_item_note) Return ChildSpyShoppingListItemNote objects filtered by the id_shopping_list_item_note column
 * @psalm-method Collection&\Traversable<ChildSpyShoppingListItemNote> findByIdShoppingListItemNote(int|array<int> $id_shopping_list_item_note) Return ChildSpyShoppingListItemNote objects filtered by the id_shopping_list_item_note column
 * @method     ChildSpyShoppingListItemNote[]|Collection findByFkShoppingListItem(int|array<int> $fk_shopping_list_item) Return ChildSpyShoppingListItemNote objects filtered by the fk_shopping_list_item column
 * @psalm-method Collection&\Traversable<ChildSpyShoppingListItemNote> findByFkShoppingListItem(int|array<int> $fk_shopping_list_item) Return ChildSpyShoppingListItemNote objects filtered by the fk_shopping_list_item column
 * @method     ChildSpyShoppingListItemNote[]|Collection findByNote(string|array<string> $note) Return ChildSpyShoppingListItemNote objects filtered by the note column
 * @psalm-method Collection&\Traversable<ChildSpyShoppingListItemNote> findByNote(string|array<string> $note) Return ChildSpyShoppingListItemNote objects filtered by the note column
 * @method     ChildSpyShoppingListItemNote[]|Collection findByCreatedAt(string|array<string> $created_at) Return ChildSpyShoppingListItemNote objects filtered by the created_at column
 * @psalm-method Collection&\Traversable<ChildSpyShoppingListItemNote> findByCreatedAt(string|array<string> $created_at) Return ChildSpyShoppingListItemNote objects filtered by the created_at column
 * @method     ChildSpyShoppingListItemNote[]|Collection findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyShoppingListItemNote objects filtered by the updated_at column
 * @psalm-method Collection&\Traversable<ChildSpyShoppingListItemNote> findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyShoppingListItemNote objects filtered by the updated_at column
 *
...
abstract class SpyShoppingListItemNoteQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SpyShoppingListItemNoteTableMap::COL_ID_SHOPPING_LIST_ITEM_NOTE, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SpyShoppingListItemNoteTableMap::COL_ID_SHOPPING_LIST_ITEM_NOTE, $keys, Criteria::IN);
    ...
    {
        $this->addUsingAlias(SpyShoppingListItemNoteTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addDescendingOrderByColumn(SpyShoppingListItemNoteTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addAscendingOrderByColumn(SpyShoppingListItemNoteTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addDescendingOrderByColumn(SpyShoppingListItemNoteTableMap::COL_CREATED_AT);
    ...
    {
        $this->addUsingAlias(SpyShoppingListItemNoteTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addAscendingOrderByColumn(SpyShoppingListItemNoteTableMap::COL_CREATED_AT);
