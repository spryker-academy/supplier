...
abstract class Message implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Orm\\Zed\\Message\\Persistence\\Map\\MessageTableMap';
    ...
    /**
     * Initializes internal state of Orm\Zed\Message\Persistence\Base\Message object.
     */
    ...
    public function setIdMessage($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->id_message !== $v) {
            $this->id_message = $v;
            $this->modifiedColumns[MessageTableMap::COL_ID_MESSAGE] = true;
        }
    ...
    public function setMessage($v)
    {
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->message !== $v) {
            $this->message = $v;
            $this->modifiedColumns[MessageTableMap::COL_MESSAGE] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[MessageTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[MessageTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : MessageTableMap::translateFieldName('IdMessage', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : MessageTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : MessageTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Orm\\Zed\\Message\\Persistence\\Message'), 0, $e);
        }
    }
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(MessageTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt($highPrecision);
                }
                if (!$this->isColumnModified(MessageTableMap::COL_UPDATED_AT)) {
                ...
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(MessageTableMap::COL_UPDATED_AT)) {
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(MessageTableMap::COL_ID_MESSAGE)) {
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(MessageTableMap::COL_ID_MESSAGE)) {
            $criteria->add(MessageTableMap::COL_ID_MESSAGE, $this->id_message);
        }
        if ($this->isColumnModified(MessageTableMap::COL_MESSAGE)) {
            $criteria->add(MessageTableMap::COL_MESSAGE, $this->message);
        }
        if ($this->isColumnModified(MessageTableMap::COL_CREATED_AT)) {
            $criteria->add(MessageTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(MessageTableMap::COL_UPDATED_AT)) {
            $criteria->add(MessageTableMap::COL_UPDATED_AT, $this->updated_at);
        }
     ...
     * objects.
     *
     * @param object $copyObj An object of \Orm\Zed\Message\Persistence\Message (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Orm\Zed\Message\Persistence\Message Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
