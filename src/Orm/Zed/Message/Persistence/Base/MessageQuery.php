...
namespace Orm\Zed\Message\Persistence\Base;

use \Exception;
use \PDO;
use Orm\Zed\Message\Persistence\Message as ChildMessage;
use Orm\Zed\Message\Persistence\MessageQuery as ChildMessageQuery;
use Orm\Zed\Message\Persistence\Map\MessageTableMap;
 ...
 *
 * @method     ChildMessageQuery orderByIdMessage($order = Criteria::ASC) Order by the id_message column
 ...
 *
 * @method     ChildMessageQuery groupByIdMessage() Group by the id_message column
 ...
 *
 * @method     ChildMessage|null findOneByIdMessage(int $id_message) Return the first ChildMessage filtered by the id_message column
 * @method     ChildMessage|null findOneByMessage(string $message) Return the first ChildMessage filtered by the message column
 ...
 * @method     ChildMessage|null findOneByUpdatedAt(string $updated_at) Return the first ChildMessage filtered by the updated_at column
 *
 ...
 *
 * @method     ChildMessage requireOneByIdMessage(int $id_message) Return the first ChildMessage filtered by the id_message column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildMessage requireOneByUpdatedAt(string $updated_at) Return the first ChildMessage filtered by the updated_at column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 *
 * @method     ChildMessage[]|Collection findByIdMessage(int|array<int> $id_message) Return ChildMessage objects filtered by the id_message column
 * @psalm-method Collection&\Traversable<ChildMessage> findByIdMessage(int|array<int> $id_message) Return ChildMessage objects filtered by the id_message column
 * @method     ChildMessage[]|Collection findByMessage(string|array<string> $message) Return ChildMessage objects filtered by the message column
 * @psalm-method Collection&\Traversable<ChildMessage> findByMessage(string|array<string> $message) Return ChildMessage objects filtered by the message column
 ...
 * @method     ChildMessage[]|Collection findByUpdatedAt(string|array<string> $updated_at) Return ChildMessage objects filtered by the updated_at column
 * @psalm-method Collection&\Traversable<ChildMessage> findByUpdatedAt(string|array<string> $updated_at) Return ChildMessage objects filtered by the updated_at column
 *
...
abstract class MessageQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Orm\Zed\Message\Persistence\Base\MessageQuery object.
     *
     * @param string $dbName The database name
     * @param string $modelName The phpName of a model, e.g. 'Book'
     * @param string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'zed', $modelName = '\\Orm\\Zed\\Message\\Persistence\\Message', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id_message, message, created_at, updated_at FROM pyz_message WHERE id_message = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(MessageTableMap::COL_ID_MESSAGE, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(MessageTableMap::COL_ID_MESSAGE, $keys, Criteria::IN);
    ...
    public function filterByIdMessage($idMessage = null, $comparison = Criteria::EQUAL)
    {
        ...
        if (is_array($idMessage)) {
            ...
            if (isset($idMessage['min'])) {
                ...
                $this->addUsingAlias(MessageTableMap::COL_ID_MESSAGE, $idMessage['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($idMessage['max'])) {
                ...
                $this->addUsingAlias(MessageTableMap::COL_ID_MESSAGE, $idMessage['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        $query = $this->addUsingAlias(MessageTableMap::COL_ID_MESSAGE, $idMessage, $comparison);
    ...
    public function filterByMessage($message = null, $comparison = Criteria::EQUAL)
    {
        ...
        $query = $this->addUsingAlias(MessageTableMap::COL_MESSAGE, $message, $comparison);
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = Criteria::EQUAL)
    {
        ...
        $query = $this->addUsingAlias(MessageTableMap::COL_CREATED_AT, $createdAt, $comparison);
    ...
    public function filterByUpdatedAt($updatedAt = null, $comparison = Criteria::EQUAL)
    {
        ...
        if (is_array($updatedAt)) {
            ...
            if (isset($updatedAt['min'])) {
                ...
                $this->addUsingAlias(MessageTableMap::COL_UPDATED_AT, $updatedAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($updatedAt['max'])) {
                ...
                $this->addUsingAlias(MessageTableMap::COL_UPDATED_AT, $updatedAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        $query = $this->addUsingAlias(MessageTableMap::COL_UPDATED_AT, $updatedAt, $comparison);
    ...
    {
        if ($message) {
            $this->addUsingAlias(MessageTableMap::COL_ID_MESSAGE, $message->getIdMessage(), Criteria::NOT_EQUAL);
        }
    ...
    {
        $this->addUsingAlias(MessageTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addDescendingOrderByColumn(MessageTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addAscendingOrderByColumn(MessageTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addDescendingOrderByColumn(MessageTableMap::COL_CREATED_AT);
    ...
    {
        $this->addUsingAlias(MessageTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addAscendingOrderByColumn(MessageTableMap::COL_CREATED_AT);
