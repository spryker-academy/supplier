 ...
 *
 * @method     ChildSpyVaultDeposit[]|Collection find(?ConnectionInterface $con = null) Return ChildSpyVaultDeposit objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpyVaultDeposit> find(?ConnectionInterface $con = null) Return ChildSpyVaultDeposit objects based on current ModelCriteria
 *
 * @method     ChildSpyVaultDeposit[]|Collection findByIdVaultDeposit(int|array<int> $id_vault_deposit) Return ChildSpyVaultDeposit objects filtered by the id_vault_deposit column
 * @psalm-method Collection&\Traversable<ChildSpyVaultDeposit> findByIdVaultDeposit(int|array<int> $id_vault_deposit) Return ChildSpyVaultDeposit objects filtered by the id_vault_deposit column
 * @method     ChildSpyVaultDeposit[]|Collection findByDataType(string|array<string> $data_type) Return ChildSpyVaultDeposit objects filtered by the data_type column
 * @psalm-method Collection&\Traversable<ChildSpyVaultDeposit> findByDataType(string|array<string> $data_type) Return ChildSpyVaultDeposit objects filtered by the data_type column
 * @method     ChildSpyVaultDeposit[]|Collection findByDataKey(string|array<string> $data_key) Return ChildSpyVaultDeposit objects filtered by the data_key column
 * @psalm-method Collection&\Traversable<ChildSpyVaultDeposit> findByDataKey(string|array<string> $data_key) Return ChildSpyVaultDeposit objects filtered by the data_key column
 * @method     ChildSpyVaultDeposit[]|Collection findByInitialVector(string|array<string> $initial_vector) Return ChildSpyVaultDeposit objects filtered by the initial_vector column
 * @psalm-method Collection&\Traversable<ChildSpyVaultDeposit> findByInitialVector(string|array<string> $initial_vector) Return ChildSpyVaultDeposit objects filtered by the initial_vector column
 * @method     ChildSpyVaultDeposit[]|Collection findByCipherText(string|array<string> $cipher_text) Return ChildSpyVaultDeposit objects filtered by the cipher_text column
 * @psalm-method Collection&\Traversable<ChildSpyVaultDeposit> findByCipherText(string|array<string> $cipher_text) Return ChildSpyVaultDeposit objects filtered by the cipher_text column
 * @method     ChildSpyVaultDeposit[]|Collection findByCreatedAt(string|array<string> $created_at) Return ChildSpyVaultDeposit objects filtered by the created_at column
 * @psalm-method Collection&\Traversable<ChildSpyVaultDeposit> findByCreatedAt(string|array<string> $created_at) Return ChildSpyVaultDeposit objects filtered by the created_at column
 * @method     ChildSpyVaultDeposit[]|Collection findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyVaultDeposit objects filtered by the updated_at column
 * @psalm-method Collection&\Traversable<ChildSpyVaultDeposit> findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyVaultDeposit objects filtered by the updated_at column
 *
...
abstract class SpyVaultDepositQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SpyVaultDepositTableMap::COL_ID_VAULT_DEPOSIT, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SpyVaultDepositTableMap::COL_ID_VAULT_DEPOSIT, $keys, Criteria::IN);
    ...
    {
        $this->addUsingAlias(SpyVaultDepositTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addDescendingOrderByColumn(SpyVaultDepositTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addAscendingOrderByColumn(SpyVaultDepositTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addDescendingOrderByColumn(SpyVaultDepositTableMap::COL_CREATED_AT);
    ...
    {
        $this->addUsingAlias(SpyVaultDepositTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addAscendingOrderByColumn(SpyVaultDepositTableMap::COL_CREATED_AT);
