...
class SpyProductSearchAttributeArchiveTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'src.Orm.Zed.ProductSearch.Persistence.Map.SpyProductSearchAttributeArchiveTableMap';
     ...
     */
    public const TABLE_NAME = 'spy_product_search_attribute_archive';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'SpyProductSearchAttributeArchive';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\Orm\\Zed\\ProductSearch\\Persistence\\SpyProductSearchAttributeArchive';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'src.Orm.Zed.ProductSearch.Persistence.SpyProductSearchAttributeArchive';
     ...
     */
    public const COL_ID_PRODUCT_SEARCH_ATTRIBUTE = 'spy_product_search_attribute_archive.id_product_search_attribute';

    /**
     * the column name for the fk_product_attribute_key field
     */
    public const COL_FK_PRODUCT_ATTRIBUTE_KEY = 'spy_product_search_attribute_archive.fk_product_attribute_key';

    /**
     * the column name for the filter_type field
     */
    public const COL_FILTER_TYPE = 'spy_product_search_attribute_archive.filter_type';

    /**
     * the column name for the position field
     */
    public const COL_POSITION = 'spy_product_search_attribute_archive.position';

    /**
     * the column name for the synced field
     */
    public const COL_SYNCED = 'spy_product_search_attribute_archive.synced';

    /**
     * the column name for the archived_at field
     */
    public const COL_ARCHIVED_AT = 'spy_product_search_attribute_archive.archived_at';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['IdProductSearchAttribute', 'FkProductAttributeKey', 'FilterType', 'Position', 'Synced', 'ArchivedAt', ],
        self::TYPE_CAMELNAME     => ['idProductSearchAttribute', 'fkProductAttributeKey', 'filterType', 'position', 'synced', 'archivedAt', ],
        self::TYPE_COLNAME       => [SpyProductSearchAttributeArchiveTableMap::COL_ID_PRODUCT_SEARCH_ATTRIBUTE, SpyProductSearchAttributeArchiveTableMap::COL_FK_PRODUCT_ATTRIBUTE_KEY, SpyProductSearchAttributeArchiveTableMap::COL_FILTER_TYPE, SpyProductSearchAttributeArchiveTableMap::COL_POSITION, SpyProductSearchAttributeArchiveTableMap::COL_SYNCED, SpyProductSearchAttributeArchiveTableMap::COL_ARCHIVED_AT, ],
        self::TYPE_FIELDNAME     => ['id_product_search_attribute', 'fk_product_attribute_key', 'filter_type', 'position', 'synced', 'archived_at', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['IdProductSearchAttribute' => 0, 'FkProductAttributeKey' => 1, 'FilterType' => 2, 'Position' => 3, 'Synced' => 4, 'ArchivedAt' => 5, ],
        self::TYPE_CAMELNAME     => ['idProductSearchAttribute' => 0, 'fkProductAttributeKey' => 1, 'filterType' => 2, 'position' => 3, 'synced' => 4, 'archivedAt' => 5, ],
        self::TYPE_COLNAME       => [SpyProductSearchAttributeArchiveTableMap::COL_ID_PRODUCT_SEARCH_ATTRIBUTE => 0, SpyProductSearchAttributeArchiveTableMap::COL_FK_PRODUCT_ATTRIBUTE_KEY => 1, SpyProductSearchAttributeArchiveTableMap::COL_FILTER_TYPE => 2, SpyProductSearchAttributeArchiveTableMap::COL_POSITION => 3, SpyProductSearchAttributeArchiveTableMap::COL_SYNCED => 4, SpyProductSearchAttributeArchiveTableMap::COL_ARCHIVED_AT => 5, ],
        self::TYPE_FIELDNAME     => ['id_product_search_attribute' => 0, 'fk_product_attribute_key' => 1, 'filter_type' => 2, 'position' => 3, 'synced' => 4, 'archived_at' => 5, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, 5, ]
    ];
