 ...
 *
 * @method     ChildSpyProductManagementAttributeValue[]|Collection find(?ConnectionInterface $con = null) Return ChildSpyProductManagementAttributeValue objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpyProductManagementAttributeValue> find(?ConnectionInterface $con = null) Return ChildSpyProductManagementAttributeValue objects based on current ModelCriteria
 *
 * @method     ChildSpyProductManagementAttributeValue[]|Collection findByIdProductManagementAttributeValue(int|array<int> $id_product_management_attribute_value) Return ChildSpyProductManagementAttributeValue objects filtered by the id_product_management_attribute_value column
 * @psalm-method Collection&\Traversable<ChildSpyProductManagementAttributeValue> findByIdProductManagementAttributeValue(int|array<int> $id_product_management_attribute_value) Return ChildSpyProductManagementAttributeValue objects filtered by the id_product_management_attribute_value column
 * @method     ChildSpyProductManagementAttributeValue[]|Collection findByFkProductManagementAttribute(int|array<int> $fk_product_management_attribute) Return ChildSpyProductManagementAttributeValue objects filtered by the fk_product_management_attribute column
 * @psalm-method Collection&\Traversable<ChildSpyProductManagementAttributeValue> findByFkProductManagementAttribute(int|array<int> $fk_product_management_attribute) Return ChildSpyProductManagementAttributeValue objects filtered by the fk_product_management_attribute column
 * @method     ChildSpyProductManagementAttributeValue[]|Collection findByValue(string|array<string> $value) Return ChildSpyProductManagementAttributeValue objects filtered by the value column
 * @psalm-method Collection&\Traversable<ChildSpyProductManagementAttributeValue> findByValue(string|array<string> $value) Return ChildSpyProductManagementAttributeValue objects filtered by the value column
 *
...
abstract class SpyProductManagementAttributeValueQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SpyProductManagementAttributeValueTableMap::COL_ID_PRODUCT_MANAGEMENT_ATTRIBUTE_VALUE, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SpyProductManagementAttributeValueTableMap::COL_ID_PRODUCT_MANAGEMENT_ATTRIBUTE_VALUE, $keys, Criteria::IN);
