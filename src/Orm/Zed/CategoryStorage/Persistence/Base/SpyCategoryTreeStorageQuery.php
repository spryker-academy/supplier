 ...
 *
 * @method     ChildSpyCategoryTreeStorage[]|Collection find(?ConnectionInterface $con = null) Return ChildSpyCategoryTreeStorage objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpyCategoryTreeStorage> find(?ConnectionInterface $con = null) Return ChildSpyCategoryTreeStorage objects based on current ModelCriteria
 *
 * @method     ChildSpyCategoryTreeStorage[]|Collection findByIdCategoryTreeStorage(string|array<string> $id_category_tree_storage) Return ChildSpyCategoryTreeStorage objects filtered by the id_category_tree_storage column
 * @psalm-method Collection&\Traversable<ChildSpyCategoryTreeStorage> findByIdCategoryTreeStorage(string|array<string> $id_category_tree_storage) Return ChildSpyCategoryTreeStorage objects filtered by the id_category_tree_storage column
 * @method     ChildSpyCategoryTreeStorage[]|Collection findByData(string|array<string> $data) Return ChildSpyCategoryTreeStorage objects filtered by the data column
 * @psalm-method Collection&\Traversable<ChildSpyCategoryTreeStorage> findByData(string|array<string> $data) Return ChildSpyCategoryTreeStorage objects filtered by the data column
 * @method     ChildSpyCategoryTreeStorage[]|Collection findByStore(string|array<string> $store) Return ChildSpyCategoryTreeStorage objects filtered by the store column
 * @psalm-method Collection&\Traversable<ChildSpyCategoryTreeStorage> findByStore(string|array<string> $store) Return ChildSpyCategoryTreeStorage objects filtered by the store column
 * @method     ChildSpyCategoryTreeStorage[]|Collection findByLocale(string|array<string> $locale) Return ChildSpyCategoryTreeStorage objects filtered by the locale column
 * @psalm-method Collection&\Traversable<ChildSpyCategoryTreeStorage> findByLocale(string|array<string> $locale) Return ChildSpyCategoryTreeStorage objects filtered by the locale column
 * @method     ChildSpyCategoryTreeStorage[]|Collection findByAliasKeys(string|array<string> $alias_keys) Return ChildSpyCategoryTreeStorage objects filtered by the alias_keys column
 * @psalm-method Collection&\Traversable<ChildSpyCategoryTreeStorage> findByAliasKeys(string|array<string> $alias_keys) Return ChildSpyCategoryTreeStorage objects filtered by the alias_keys column
 * @method     ChildSpyCategoryTreeStorage[]|Collection findByKey(string|array<string> $key) Return ChildSpyCategoryTreeStorage objects filtered by the key column
 * @psalm-method Collection&\Traversable<ChildSpyCategoryTreeStorage> findByKey(string|array<string> $key) Return ChildSpyCategoryTreeStorage objects filtered by the key column
 * @method     ChildSpyCategoryTreeStorage[]|Collection findByCreatedAt(string|array<string> $created_at) Return ChildSpyCategoryTreeStorage objects filtered by the created_at column
 * @psalm-method Collection&\Traversable<ChildSpyCategoryTreeStorage> findByCreatedAt(string|array<string> $created_at) Return ChildSpyCategoryTreeStorage objects filtered by the created_at column
 * @method     ChildSpyCategoryTreeStorage[]|Collection findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyCategoryTreeStorage objects filtered by the updated_at column
 * @psalm-method Collection&\Traversable<ChildSpyCategoryTreeStorage> findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyCategoryTreeStorage objects filtered by the updated_at column
 *
...
abstract class SpyCategoryTreeStorageQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SpyCategoryTreeStorageTableMap::COL_ID_CATEGORY_TREE_STORAGE, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SpyCategoryTreeStorageTableMap::COL_ID_CATEGORY_TREE_STORAGE, $keys, Criteria::IN);
    ...
    {
        $this->addUsingAlias(SpyCategoryTreeStorageTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addDescendingOrderByColumn(SpyCategoryTreeStorageTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addAscendingOrderByColumn(SpyCategoryTreeStorageTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addDescendingOrderByColumn(SpyCategoryTreeStorageTableMap::COL_CREATED_AT);
    ...
    {
        $this->addUsingAlias(SpyCategoryTreeStorageTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addAscendingOrderByColumn(SpyCategoryTreeStorageTableMap::COL_CREATED_AT);
