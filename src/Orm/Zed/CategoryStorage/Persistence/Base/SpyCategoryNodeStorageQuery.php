 ...
 *
 * @method     ChildSpyCategoryNodeStorage[]|Collection find(?ConnectionInterface $con = null) Return ChildSpyCategoryNodeStorage objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildSpyCategoryNodeStorage> find(?ConnectionInterface $con = null) Return ChildSpyCategoryNodeStorage objects based on current ModelCriteria
 *
 * @method     ChildSpyCategoryNodeStorage[]|Collection findByIdCategoryNodeStorage(string|array<string> $id_category_node_storage) Return ChildSpyCategoryNodeStorage objects filtered by the id_category_node_storage column
 * @psalm-method Collection&\Traversable<ChildSpyCategoryNodeStorage> findByIdCategoryNodeStorage(string|array<string> $id_category_node_storage) Return ChildSpyCategoryNodeStorage objects filtered by the id_category_node_storage column
 * @method     ChildSpyCategoryNodeStorage[]|Collection findByFkCategoryNode(int|array<int> $fk_category_node) Return ChildSpyCategoryNodeStorage objects filtered by the fk_category_node column
 * @psalm-method Collection&\Traversable<ChildSpyCategoryNodeStorage> findByFkCategoryNode(int|array<int> $fk_category_node) Return ChildSpyCategoryNodeStorage objects filtered by the fk_category_node column
 * @method     ChildSpyCategoryNodeStorage[]|Collection findByData(string|array<string> $data) Return ChildSpyCategoryNodeStorage objects filtered by the data column
 * @psalm-method Collection&\Traversable<ChildSpyCategoryNodeStorage> findByData(string|array<string> $data) Return ChildSpyCategoryNodeStorage objects filtered by the data column
 * @method     ChildSpyCategoryNodeStorage[]|Collection findByStore(string|array<string> $store) Return ChildSpyCategoryNodeStorage objects filtered by the store column
 * @psalm-method Collection&\Traversable<ChildSpyCategoryNodeStorage> findByStore(string|array<string> $store) Return ChildSpyCategoryNodeStorage objects filtered by the store column
 * @method     ChildSpyCategoryNodeStorage[]|Collection findByLocale(string|array<string> $locale) Return ChildSpyCategoryNodeStorage objects filtered by the locale column
 * @psalm-method Collection&\Traversable<ChildSpyCategoryNodeStorage> findByLocale(string|array<string> $locale) Return ChildSpyCategoryNodeStorage objects filtered by the locale column
 * @method     ChildSpyCategoryNodeStorage[]|Collection findByAliasKeys(string|array<string> $alias_keys) Return ChildSpyCategoryNodeStorage objects filtered by the alias_keys column
 * @psalm-method Collection&\Traversable<ChildSpyCategoryNodeStorage> findByAliasKeys(string|array<string> $alias_keys) Return ChildSpyCategoryNodeStorage objects filtered by the alias_keys column
 * @method     ChildSpyCategoryNodeStorage[]|Collection findByKey(string|array<string> $key) Return ChildSpyCategoryNodeStorage objects filtered by the key column
 * @psalm-method Collection&\Traversable<ChildSpyCategoryNodeStorage> findByKey(string|array<string> $key) Return ChildSpyCategoryNodeStorage objects filtered by the key column
 * @method     ChildSpyCategoryNodeStorage[]|Collection findByCreatedAt(string|array<string> $created_at) Return ChildSpyCategoryNodeStorage objects filtered by the created_at column
 * @psalm-method Collection&\Traversable<ChildSpyCategoryNodeStorage> findByCreatedAt(string|array<string> $created_at) Return ChildSpyCategoryNodeStorage objects filtered by the created_at column
 * @method     ChildSpyCategoryNodeStorage[]|Collection findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyCategoryNodeStorage objects filtered by the updated_at column
 * @psalm-method Collection&\Traversable<ChildSpyCategoryNodeStorage> findByUpdatedAt(string|array<string> $updated_at) Return ChildSpyCategoryNodeStorage objects filtered by the updated_at column
 *
...
abstract class SpyCategoryNodeStorageQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(SpyCategoryNodeStorageTableMap::COL_ID_CATEGORY_NODE_STORAGE, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(SpyCategoryNodeStorageTableMap::COL_ID_CATEGORY_NODE_STORAGE, $keys, Criteria::IN);
    ...
    {
        $this->addUsingAlias(SpyCategoryNodeStorageTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addDescendingOrderByColumn(SpyCategoryNodeStorageTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addAscendingOrderByColumn(SpyCategoryNodeStorageTableMap::COL_UPDATED_AT);
    ...
    {
        $this->addDescendingOrderByColumn(SpyCategoryNodeStorageTableMap::COL_CREATED_AT);
    ...
    {
        $this->addUsingAlias(SpyCategoryNodeStorageTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    ...
    {
        $this->addAscendingOrderByColumn(SpyCategoryNodeStorageTableMap::COL_CREATED_AT);
